...
const ChatRequest = models_1.Models.ChatRequest;
const SentenceRecognitionResponse = models_1.Models.SentenceRecognitionResponse;
const SimultaneousInterpretingResponse = models_1.Models.SimultaneousInterpretingResponse;
const TextToVoiceResponse = models_1.Models.TextToVoiceResponse;
const SimultaneousInterpretingRequest = models_1.Models.SimultaneousInterpretingRequest;
...
const ChatResponse = models_1.Models.ChatResponse;
/**
 * aai client
 * @class
 */
class Client extends abstract_client_1.AbstractClient {
    ...
    SimultaneousInterpreting(req, cb) {
        const resp = new SimultaneousInterpretingResponse();
...
//# sourceMappingURL=aai_client.js.map