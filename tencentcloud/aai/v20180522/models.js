 ...
 * @class
 */
class ChatRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 聊天输入文本
 ...
 * @class
 */
class SimultaneousInterpretingResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音识别的结果
 ...
 * @class
 */
class TextToVoiceResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class SimultaneousInterpretingRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 腾讯云项目 ID，可填 0，总长度不超过 1024 字节。
 ...
 * @class
 */
class TextToVoiceRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ChatResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 聊天输出文本
