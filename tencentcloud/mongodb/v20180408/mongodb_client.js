...
const UpgradeDBInstanceHourRequest = models_1.Models.UpgradeDBInstanceHourRequest;
...
const SetPasswordResponse = models_1.Models.SetPasswordResponse;
const SpecificationInfo = models_1.Models.SpecificationInfo;
const MongoDBInstanceDetail = models_1.Models.MongoDBInstanceDetail;
...
const SetPasswordRequest = models_1.Models.SetPasswordRequest;
...
const SetAutoRenewResponse = models_1.Models.SetAutoRenewResponse;
const MongoDBInstance = models_1.Models.MongoDBInstance;
...
const SetAutoRenewRequest = models_1.Models.SetAutoRenewRequest;
...
const UpgradeDBInstanceHourResponse = models_1.Models.UpgradeDBInstanceHourResponse;
...
const MongodbShardInfo = models_1.Models.MongodbShardInfo;
...
class Client extends abstract_client_1.AbstractClient {
     ...
     */
    SetAutoRenew(req, cb) {
        const resp = new SetAutoRenewResponse();
     ...
     */
    SetPassword(req, cb) {
        const resp = new SetPasswordResponse();
    ...
    UpgradeDBInstanceHour(req, cb) {
        const resp = new UpgradeDBInstanceHourResponse();
