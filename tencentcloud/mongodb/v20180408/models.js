 ...
 * @class
 */
class UpgradeDBInstanceHourRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 实例ID，格式如：cmgo-p8vnipr5
 ...
 * @class
 */
class SetPasswordResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 返回的异步任务ID
 ...
 * @class
 */
class MongoDBInstanceDetail extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 实例ID
 ...
 * @class
 */
class SetPasswordRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class SetAutoRenewResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class MongoDBInstance extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 实例ID
 ...
 * @class
 */
class SetAutoRenewRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 实例ID列表，格式如：cmgo-p8vnipr5。与云数据库控制台页面中显示的实例ID相同
 ...
 * @class
 */
class UpgradeDBInstanceHourResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 订单ID
 ...
 * @class
 */
class MongodbShardInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 分片已使用容量
