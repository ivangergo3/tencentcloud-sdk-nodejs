...
class Client extends abstract_client_1.AbstractClient {
    ...
    DescribeImageQuota(req, cb) {
        const resp = new models_1.DescribeImageQuotaResponse();
...
* 本接口为异步接口，关闭实例请求发送成功后会返回一个RequestId，此时操作并未立即完成。实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表关闭实例操作成功。
    ...
    StopInstances(req, cb) {
        const resp = new models_1.StopInstancesResponse();
...
* 如果参数为空，返回当前用户一定数量（Limit所指定的数量，默认为20）的实例状态。
    ...
    DescribeInstancesStatus(req, cb) {
        const resp = new models_1.DescribeInstancesStatusResponse();
...
* 只支持分享到对方账户相同地域。
    ...
    ModifyImageSharePermission(req, cb) {
        const resp = new models_1.ModifyImageSharePermissionResponse();
    ...
    DescribeImageSharePermission(req, cb) {
        const resp = new models_1.DescribeImageSharePermissionResponse();
...
* 关机不收费的实例、`BC1`和`BS1`机型族的实例、设置定时销毁的实例、竞价实例不支持该操作。
    ...
    InquiryPriceModifyInstancesChargeType(req, cb) {
        const resp = new models_1.InquiryPriceModifyInstancesChargeTypeResponse();
    ...
    ModifyHostsAttribute(req, cb) {
        const resp = new models_1.ModifyHostsAttributeResponse();
...
* 指定偏移(Offset)和限制(Limit)来选择结果中的一部分，默认返回满足条件的前20个镜像信息。
    ...
    DescribeImages(req, cb) {
        const resp = new models_1.DescribeImagesResponse();
...
* 密钥对ID是密钥对的唯一标识，不可修改。
    ...
    ModifyKeyPairAttribute(req, cb) {
        const resp = new models_1.ModifyKeyPairAttributeResponse();
    ...
    DescribeZoneInstanceConfigInfos(req, cb) {
        const resp = new models_1.DescribeZoneInstanceConfigInfosResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    ModifyInstancesAttribute(req, cb) {
        const resp = new models_1.ModifyInstancesAttributeResponse();
    ...
    DescribeRegions(req, cb) {
        const resp = new models_1.DescribeRegionsResponse();
...
* 接口不支持批量调整混合计费方式的带宽。例如不支持同时调整`TRAFFIC_POSTPAID_BY_HOUR`和`BANDWIDTH_PACKAGE`计费方式的带宽。
    ...
    InquiryPriceResetInstancesInternetMaxBandwidth(req, cb) {
        const resp = new models_1.InquiryPriceResetInstancesInternetMaxBandwidthResponse();
...
* 支持批量操作。每次请求批量实例的上限为100。如果批量实例存在不允许操作的实例，操作会以特定错误码返回。
    ...
    DisassociateInstancesKeyPairs(req, cb) {
        const resp = new models_1.DisassociateInstancesKeyPairsResponse();
...
* 腾讯云不会保存用户的私钥，请妥善保管。
    ...
    CreateKeyPair(req, cb) {
        const resp = new models_1.CreateKeyPairResponse();
...
* 不能删除已被实例或镜像引用的密钥对，所以需要独立判断是否所有密钥对都被成功删除。
    ...
    DeleteKeyPairs(req, cb) {
        const resp = new models_1.DeleteKeyPairsResponse();
    ...
    CreateDisasterRecoverGroup(req, cb) {
        const resp = new models_1.CreateDisasterRecoverGroupResponse();
...
* 支持查询实例的最新操作（LatestOperation）以及最新操作状态(LatestOperationState)。
    ...
    DescribeInstances(req, cb) {
        const resp = new models_1.DescribeInstancesResponse();
...
* 如果用户只有私钥，可以通过 `SSL` 工具将私钥转换成公钥后再导入。
    ...
    ImportKeyPair(req, cb) {
        const resp = new models_1.ImportKeyPairResponse();
...
* 单个帐号在每个地域最多支持存在10个自定义镜像。
     ...
     */
    SyncImages(req, cb) {
        const resp = new models_1.SyncImagesResponse();
...
* 接口返回实例的所有带宽配置信息（包含历史的带宽配置信息）。
    ...
    DescribeInstanceInternetBandwidthConfigs(req, cb) {
        const resp = new models_1.DescribeInstanceInternetBandwidthConfigsResponse();
...
* 支持批量操作。每次请求批量实例的上限为100。如果批量实例存在不允许操作的实例，操作会以特定错误码返回。
    ...
    AssociateInstancesKeyPairs(req, cb) {
        const resp = new models_1.AssociateInstancesKeyPairsResponse();
...
* 本接口为异步接口，当创建实例请求下发成功后会返回一个实例`ID`列表和一个`RequestId`，此时创建实例操作并未立即完成。在此期间实例的状态将会处于“PENDING”，实例创建结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728)  接口查询，如果实例状态(InstanceState)由“PENDING”变为“RUNNING”，则代表实例创建成功，“LAUNCH_FAILED”代表实例创建失败。
     ...
     */
    RunInstances(req, cb) {
        const resp = new models_1.RunInstancesResponse();
...
* 当镜像正在被其它账户分享时，不允许删除。
     ...
     */
    DeleteImages(req, cb) {
        const resp = new models_1.DeleteImagesResponse();
...
* 目前不支持[CDH](https://cloud.tencent.com/document/product/416)实例使用该接口扩容数据盘询价。* 仅支持包年包月实例随机器购买的数据盘。* 目前只支持扩容一块数据盘询价。
    ...
    InquiryPriceResizeInstanceDisks(req, cb) {
        const resp = new models_1.InquiryPriceResizeInstanceDisksResponse();
...
* 支持批量操作，每次请求批量实例的上限为100。
    ...
    TerminateInstances(req, cb) {
        const resp = new models_1.TerminateInstancesResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    ModifyInstancesVpcAttribute(req, cb) {
        const resp = new models_1.ModifyInstancesVpcAttributeResponse();
...
* 目前不支持境外地域的实例使用该接口实现`Linux`和`Windows`操作系统切换的重装询价。
    ...
    InquiryPriceResetInstance(req, cb) {
        const resp = new models_1.InquiryPriceResetInstanceResponse();
    ...
    DescribeDisasterRecoverGroupQuota(req, cb) {
        const resp = new models_1.DescribeDisasterRecoverGroupQuotaResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    ResetInstancesPassword(req, cb) {
        const resp = new models_1.ResetInstancesPasswordResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    ModifyInstancesRenewFlag(req, cb) {
        const resp = new models_1.ModifyInstancesRenewFlagResponse();
    ...
    PurchaseReservedInstancesOffering(req, cb) {
        const resp = new models_1.PurchaseReservedInstancesOfferingResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    ResizeInstanceDisks(req, cb) {
        const resp = new models_1.ResizeInstanceDisksResponse();
    ...
    DescribeReservedInstances(req, cb) {
        const resp = new models_1.DescribeReservedInstancesResponse();
    ...
    DescribeZones(req, cb) {
        const resp = new models_1.DescribeZonesResponse();
     ...
     */
    CreateImage(req, cb) {
        const resp = new models_1.CreateImageResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    AssociateSecurityGroups(req, cb) {
        const resp = new models_1.AssociateSecurityGroupsResponse();
...
* 本接口为异步接口，调整实例配置请求发送成功后会返回一个RequestId，此时操作并未立即完成。实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表调整实例配置操作成功。
    ...
    ResetInstancesType(req, cb) {
        const resp = new models_1.ResetInstancesTypeResponse();
...
* 已分享的镜像无法修改属性。
    ...
    ModifyImageAttribute(req, cb) {
        const resp = new models_1.ModifyImageAttributeResponse();
...
* 目前支持调整配置操作限制次数查询。
    ...
    DescribeInstancesOperationLimit(req, cb) {
        const resp = new models_1.DescribeInstancesOperationLimitResponse();
...
* 对于包年包月实例，使用该接口会涉及扣费，请确保账户余额充足。可通过[`DescribeAccountBalance`](https://cloud.tencent.com/document/product/555/20253)接口查询账户余额。
    ...
    InquiryPriceResetInstancesType(req, cb) {
        const resp = new models_1.InquiryPriceResetInstancesTypeResponse();
    ...
    DescribeInstanceFamilyConfigs(req, cb) {
        const resp = new models_1.DescribeInstanceFamilyConfigsResponse();
    ...
    DeleteDisasterRecoverGroups(req, cb) {
        const resp = new models_1.DeleteDisasterRecoverGroupsResponse();
    ...
    DescribeImportImageOs(req, cb) {
        const resp = new models_1.DescribeImportImageOsResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    ModifyInstancesProject(req, cb) {
        const resp = new models_1.ModifyInstancesProjectResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    ResetInstance(req, cb) {
        const resp = new models_1.ResetInstanceResponse();
...
* 只支持查询包年包月实例的续费价格。
    ...
    InquiryPriceRenewInstances(req, cb) {
        const resp = new models_1.InquiryPriceRenewInstancesResponse();
    ...
    InquiryPriceRunInstances(req, cb) {
        const resp = new models_1.InquiryPriceRunInstancesResponse();
     ...
     */
    ImportImage(req, cb) {
        const resp = new models_1.ImportImageResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    RenewInstances(req, cb) {
        const resp = new models_1.RenewInstancesResponse();
    ...
    ModifyDisasterRecoverGroupAttribute(req, cb) {
        const resp = new models_1.ModifyDisasterRecoverGroupAttributeResponse();
...
```
    ...
    DescribeInstanceVncUrl(req, cb) {
        const resp = new models_1.DescribeInstanceVncUrlResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    ModifyInstancesChargeType(req, cb) {
        const resp = new models_1.ModifyInstancesChargeTypeResponse();
...
* 续费时请确保账户余额充足。可通过[`DescribeAccountBalance`](https://cloud.tencent.com/document/product/555/20253)接口查询账户余额。
     ...
     */
    RenewHosts(req, cb) {
        const resp = new models_1.RenewHostsResponse();
    ...
    DescribeDisasterRecoverGroups(req, cb) {
        const resp = new models_1.DescribeDisasterRecoverGroupsResponse();
...
* 本接口为异步接口，启动实例请求发送成功后会返回一个RequestId，此时操作并未立即完成。实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表启动实例操作成功。
    ...
    StartInstances(req, cb) {
        const resp = new models_1.StartInstancesResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    ResetInstancesInternetMaxBandwidth(req, cb) {
        const resp = new models_1.ResetInstancesInternetMaxBandwidthResponse();
...
* 密钥对是通过一种算法生成的一对密钥，在生成的密钥对中，一个向外界公开，称为公钥；另一个用户自己保留，称为私钥。密钥对的公钥内容可以通过这个接口查询，但私钥内容系统不保留。
    ...
    DescribeKeyPairs(req, cb) {
        const resp = new models_1.DescribeKeyPairsResponse();
    ...
    DescribeReservedInstancesOfferings(req, cb) {
        const resp = new models_1.DescribeReservedInstancesOfferingsResponse();
    ...
    DescribeHosts(req, cb) {
        const resp = new models_1.DescribeHostsResponse();
...
* 当HostChargeType为PREPAID时，必须指定HostChargePrepaid参数。
    ...
    AllocateHosts(req, cb) {
        const resp = new models_1.AllocateHostsResponse();
    ...
    DescribeInternetChargeTypeConfigs(req, cb) {
        const resp = new models_1.DescribeInternetChargeTypeConfigsResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    RebootInstances(req, cb) {
        const resp = new models_1.RebootInstancesResponse();
...
* 如果参数为空，返回指定地域的所有实例机型配置。
    ...
    DescribeInstanceTypeConfigs(req, cb) {
        const resp = new models_1.DescribeInstanceTypeConfigsResponse();
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    ...
    DisassociateSecurityGroups(req, cb) {
        const resp = new models_1.DisassociateSecurityGroupsResponse();
