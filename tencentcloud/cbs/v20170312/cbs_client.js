...
const DetachDisksRequest = models_1.Models.DetachDisksRequest;
const DescribeDiskOperationLogsResponse = models_1.Models.DescribeDiskOperationLogsResponse;
const ResizeDiskRequest = models_1.Models.ResizeDiskRequest;
const RenewDiskRequest = models_1.Models.RenewDiskRequest;
const TerminateDisksResponse = models_1.Models.TerminateDisksResponse;
const DescribeSnapshotSharePermissionResponse = models_1.Models.DescribeSnapshotSharePermissionResponse;
const SharePermission = models_1.Models.SharePermission;
const ModifyDiskAttributesResponse = models_1.Models.ModifyDiskAttributesResponse;
const TerminateDisksRequest = models_1.Models.TerminateDisksRequest;
const ModifyDisksChargeTypeResponse = models_1.Models.ModifyDisksChargeTypeResponse;
const DescribeDisksRequest = models_1.Models.DescribeDisksRequest;
const DescribeInstancesDiskNumRequest = models_1.Models.DescribeInstancesDiskNumRequest;
const AutoSnapshotPolicy = models_1.Models.AutoSnapshotPolicy;
const Policy = models_1.Models.Policy;
const ModifySnapshotsSharePermissionResponse = models_1.Models.ModifySnapshotsSharePermissionResponse;
const GetSnapOverviewRequest = models_1.Models.GetSnapOverviewRequest;
const DescribeSnapshotOperationLogsRequest = models_1.Models.DescribeSnapshotOperationLogsRequest;
const ModifySnapshotAttributeRequest = models_1.Models.ModifySnapshotAttributeRequest;
const InquiryPriceRenewDisksRequest = models_1.Models.InquiryPriceRenewDisksRequest;
const DescribeSnapshotSharePermissionRequest = models_1.Models.DescribeSnapshotSharePermissionRequest;
const RenewDiskResponse = models_1.Models.RenewDiskResponse;
const InquiryPriceRenewDisksResponse = models_1.Models.InquiryPriceRenewDisksResponse;
const ModifyDisksRenewFlagRequest = models_1.Models.ModifyDisksRenewFlagRequest;
const ModifyAutoSnapshotPolicyAttributeResponse = models_1.Models.ModifyAutoSnapshotPolicyAttributeResponse;
const ModifyDisksChargeTypeRequest = models_1.Models.ModifyDisksChargeTypeRequest;
const Price = models_1.Models.Price;
const UnbindAutoSnapshotPolicyResponse = models_1.Models.UnbindAutoSnapshotPolicyResponse;
const InquiryPriceCreateDisksResponse = models_1.Models.InquiryPriceCreateDisksResponse;
const DiskConfig = models_1.Models.DiskConfig;
const BindAutoSnapshotPolicyRequest = models_1.Models.BindAutoSnapshotPolicyRequest;
const CreateSnapshotResponse = models_1.Models.CreateSnapshotResponse;
const DeleteSnapshotsRequest = models_1.Models.DeleteSnapshotsRequest;
const DescribeDiskConfigQuotaRequest = models_1.Models.DescribeDiskConfigQuotaRequest;
const DeleteAutoSnapshotPoliciesRequest = models_1.Models.DeleteAutoSnapshotPoliciesRequest;
const DiskChargePrepaid = models_1.Models.DiskChargePrepaid;
const DescribeSnapshotOperationLogsResponse = models_1.Models.DescribeSnapshotOperationLogsResponse;
const ModifyDisksRenewFlagResponse = models_1.Models.ModifyDisksRenewFlagResponse;
const DescribeDiskAssociatedAutoSnapshotPolicyResponse = models_1.Models.DescribeDiskAssociatedAutoSnapshotPolicyResponse;
const GetSnapOverviewResponse = models_1.Models.GetSnapOverviewResponse;
const ApplySnapshotResponse = models_1.Models.ApplySnapshotResponse;
const DeleteAutoSnapshotPoliciesResponse = models_1.Models.DeleteAutoSnapshotPoliciesResponse;
const DescribeDisksResponse = models_1.Models.DescribeDisksResponse;
const ModifySnapshotAttributeResponse = models_1.Models.ModifySnapshotAttributeResponse;
const PrepayPrice = models_1.Models.PrepayPrice;
const DeleteSnapshotsResponse = models_1.Models.DeleteSnapshotsResponse;
const DetachDisksResponse = models_1.Models.DetachDisksResponse;
const Filter = models_1.Models.Filter;
const InquiryPriceCreateDisksRequest = models_1.Models.InquiryPriceCreateDisksRequest;
const DescribeSnapshotsResponse = models_1.Models.DescribeSnapshotsResponse;
const Snapshot = models_1.Models.Snapshot;
const SnapshotOperationLog = models_1.Models.SnapshotOperationLog;
const CreateDisksResponse = models_1.Models.CreateDisksResponse;
const AttachDisksResponse = models_1.Models.AttachDisksResponse;
const CreateAutoSnapshotPolicyResponse = models_1.Models.CreateAutoSnapshotPolicyResponse;
const ModifySnapshotsSharePermissionRequest = models_1.Models.ModifySnapshotsSharePermissionRequest;
const DiskOperationLog = models_1.Models.DiskOperationLog;
const UnbindAutoSnapshotPolicyRequest = models_1.Models.UnbindAutoSnapshotPolicyRequest;
const DescribeDiskOperationLogsRequest = models_1.Models.DescribeDiskOperationLogsRequest;
const BindAutoSnapshotPolicyResponse = models_1.Models.BindAutoSnapshotPolicyResponse;
const CreateDisksRequest = models_1.Models.CreateDisksRequest;
const AttachDisksRequest = models_1.Models.AttachDisksRequest;
const DescribeAutoSnapshotPoliciesResponse = models_1.Models.DescribeAutoSnapshotPoliciesResponse;
const DescribeDiskAssociatedAutoSnapshotPolicyRequest = models_1.Models.DescribeDiskAssociatedAutoSnapshotPolicyRequest;
const DescribeAutoSnapshotPoliciesRequest = models_1.Models.DescribeAutoSnapshotPoliciesRequest;
const Image = models_1.Models.Image;
const DescribeDiskConfigQuotaResponse = models_1.Models.DescribeDiskConfigQuotaResponse;
const ModifyDiskAttributesRequest = models_1.Models.ModifyDiskAttributesRequest;
const CreateSnapshotRequest = models_1.Models.CreateSnapshotRequest;
const AttachDetail = models_1.Models.AttachDetail;
const InquiryPriceResizeDiskResponse = models_1.Models.InquiryPriceResizeDiskResponse;
const DescribeInstancesDiskNumResponse = models_1.Models.DescribeInstancesDiskNumResponse;
const ResizeDiskResponse = models_1.Models.ResizeDiskResponse;
const DescribeSnapshotsRequest = models_1.Models.DescribeSnapshotsRequest;
const Placement = models_1.Models.Placement;
const CreateAutoSnapshotPolicyRequest = models_1.Models.CreateAutoSnapshotPolicyRequest;
const InquiryPriceResizeDiskRequest = models_1.Models.InquiryPriceResizeDiskRequest;
const Disk = models_1.Models.Disk;
const ModifyAutoSnapshotPolicyAttributeRequest = models_1.Models.ModifyAutoSnapshotPolicyAttributeRequest;
const Tag = models_1.Models.Tag;
const ApplySnapshotRequest = models_1.Models.ApplySnapshotRequest;
/**
 * cbs client
 * @class
 */
...
* 支持与挂载实例一起续费的场景，需要在[DiskChargePrepaid](/document/product/362/15669#DiskChargePrepaid)参数中指定CurInstanceDeadline，此时会按对齐到子机续费后的到期时间来续费。
     ...
     */
    RenewDisk(req, cb) {
        const resp = new RenewDiskResponse();
...
* 支持批量操作，当传入多个云服务器实例ID，返回结果会分别列出每个云服务器挂载的云硬盘数量。
    ...
    DescribeInstancesDiskNum(req, cb) {
        const resp = new DescribeInstancesDiskNumResponse();
...
* 只支持预付费模式的云硬盘扩容询价。
    ...
    InquiryPriceResizeDisk(req, cb) {
        const resp = new InquiryPriceResizeDiskResponse();
...
* 如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的定期快照策略表。
    ...
    DescribeAutoSnapshotPolicies(req, cb) {
        const resp = new DescribeAutoSnapshotPoliciesResponse();
...
* 本接口为异步接口，当挂载云盘的请求成功返回时，表示后台已发起挂载云盘的操作，可通过接口[DescribeDisks](/document/product/362/16315)来查询对应云盘的状态，如果云盘的状态由“ATTACHING”变为“ATTACHED”，则为挂载成功。
     ...
     */
    AttachDisks(req, cb) {
        const resp = new AttachDisksResponse();
    ...
    ModifyDisksRenewFlag(req, cb) {
        const resp = new ModifyDisksRenewFlagResponse();
...
* 修改保留天数时必须保证不与是否永久保留属性冲突，否则整个操作失败，以特定的错误码返回。
    ...
    ModifyAutoSnapshotPolicyAttribute(req, cb) {
        const resp = new ModifyAutoSnapshotPolicyAttributeResponse();
...
* 支持查询创建多块云硬盘的价格，此时返回结果为总价格。
    ...
    InquiryPriceCreateDisks(req, cb) {
        const resp = new InquiryPriceCreateDisksResponse();
...
可根据云盘ID过滤。云盘ID形如：disk-a1kmcp13。
    ...
    DescribeDiskOperationLogs(req, cb) {
        const resp = new DescribeDiskOperationLogsResponse();
...
*  支持批量操作。如果多个定期快照策略存在无法删除的，则操作不执行，以特定错误码返回。
    ...
    DeleteAutoSnapshotPolicies(req, cb) {
        const resp = new DeleteAutoSnapshotPoliciesResponse();
...
* 如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的云硬盘列表。
    ...
    DescribeDisks(req, cb) {
        const resp = new DescribeDisksResponse();
...
* 本接口为异步接口，当创建请求下发成功后会返回一个新建的云盘ID列表，此时云盘的创建并未立即完成。可以通过调用[DescribeDisks](/document/product/362/16315)接口根据DiskId查询对应云盘，如果能查到云盘，且状态为'UNATTACHED'或'ATTACHED'，则表示创建成功。
     ...
     */
    CreateDisks(req, cb) {
        const resp = new CreateDisksResponse();
...
* 支持批量操作，如果传入多个云盘ID，则所有云盘修改为同一属性。如果存在不允许操作的云盘，则操作不执行，以特定错误码返回。
    ...
    ModifyDiskAttributes(req, cb) {
        const resp = new ModifyDiskAttributesResponse();
...
* 支持批量操作。如果多个快照存在无法删除的快照，则操作不执行，以返回特定的错误码返回。
    ...
    DeleteSnapshots(req, cb) {
        const resp = new DeleteSnapshotsResponse();
...
* “快照名称”仅为方便用户自己管理之用，腾讯云并不以此名称作为提交工单或是进行快照管理操作的依据。
    ...
    ModifySnapshotAttribute(req, cb) {
        const resp = new ModifySnapshotAttributeResponse();
    ...
    DescribeDiskAssociatedAutoSnapshotPolicy(req, cb) {
        const resp = new DescribeDiskAssociatedAutoSnapshotPolicyResponse();
...
* 当已绑定定期快照策略的云硬盘处于未使用状态（即弹性云盘未挂载或非弹性云盘的主机处于关机状态）将不会创建定期快照。
    ...
    BindAutoSnapshotPolicy(req, cb) {
        const resp = new BindAutoSnapshotPolicyResponse();
...
*  如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的快照列表。
    ...
    DescribeSnapshots(req, cb) {
        const resp = new DescribeSnapshotsResponse();
    ...
    DescribeSnapshotSharePermission(req, cb) {
        const resp = new DescribeSnapshotSharePermissionResponse();
...
* 每个地域可创建的快照有数量和容量的限制，具体请见腾讯云控制台快照页面提示，如果快照超配额，定期快照创建会失败。
    ...
    CreateAutoSnapshotPolicy(req, cb) {
        const resp = new CreateAutoSnapshotPolicyResponse();
...
默认接口请求频率限制：10次/秒。
    ...
    ModifyDisksChargeType(req, cb) {
        const resp = new ModifyDisksChargeTypeResponse();
...
* 支持批量操作，每次请求批量云硬盘的上限为50。如果批量云盘存在不允许操作的，请求会以特定错误码返回。
    ...
    TerminateDisks(req, cb) {
        const resp = new TerminateDisksResponse();
    ...
    DescribeDiskConfigQuota(req, cb) {
        const resp = new DescribeDiskConfigQuotaResponse();
...
* 如果传入的云盘未绑定到当前定期快照策略，接口将自动跳过，仅解绑与当前定期快照策略绑定的云盘。
    ...
    UnbindAutoSnapshotPolicy(req, cb) {
        const resp = new UnbindAutoSnapshotPolicyResponse();
...
* 如果是弹性云盘，则云盘必须处于未挂载状态，云硬盘挂载状态可以通过[DescribeDisks](/document/product/362/16315)接口查询，见Attached字段解释；如果是随实例一起购买的非弹性云盘，则实例必须处于关机状态，实例状态可以通过[DescribeInstancesStatus](/document/product/213/15738)接口查询。
    ...
    ApplySnapshot(req, cb) {
        const resp = new ApplySnapshotResponse();
...
可根据快照ID过滤。快照ID形如：snap-a1kmcp13。
    ...
    DescribeSnapshotOperationLogs(req, cb) {
        const resp = new DescribeSnapshotOperationLogsResponse();
...
* 仅支持分享数据盘快照。
    ...
    ModifySnapshotsSharePermission(req, cb) {
        const resp = new ModifySnapshotsSharePermissionResponse();
...
* 可创建快照数量限制见[产品使用限制](https://cloud.tencent.com/doc/product/362/5145)。
    ...
    CreateSnapshot(req, cb) {
        const resp = new CreateSnapshotResponse();
    ...
    GetSnapOverview(req, cb) {
        const resp = new GetSnapOverviewResponse();
...
* 本接口为异步接口，接口成功返回时，云盘并未立即扩容到指定大小，可通过接口[DescribeDisks](/document/product/362/16315)来查询对应云盘的状态，如果云盘的状态为“EXPANDING”，表示正在扩容中。
     ...
     */
    ResizeDisk(req, cb) {
        const resp = new ResizeDiskResponse();
...
* 本接口为异步接口，当请求成功返回时，云盘并未立即从主机解挂载，可通过接口[DescribeDisks](/document/product/362/16315)来查询对应云盘的状态，如果云盘的状态由“ATTACHED”变为“UNATTACHED”，则为解挂载成功。
     ...
     */
    DetachDisks(req, cb) {
        const resp = new DetachDisksResponse();
...
* 支持为多块云盘指定不同的续费时长，此时返回的价格为多块云盘续费的总价格。
    ...
    InquiryPriceRenewDisks(req, cb) {
        const resp = new InquiryPriceRenewDisksResponse();
        this.request("InquiryPriceRenewDisks", req, resp, cb);
    }
}
exports.Client = Client;
//# sourceMappingURL=cbs_client.js.map