 ...
 * @class
 */
class ImageSegments extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面截帧结果详情
 ...
 * @class
 */
class ImageResultResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 场景
 ...
 * @class
 */
class BucketInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 腾讯云对象存储，存储桶名称
 ...
 * @class
 */
class CreateAudioModerationTaskResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务创建结果
 ...
 * @class
 */
class CreateBizConfigRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 业务ID
 ...
 * @class
 */
class DescribeBizConfigRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 审核业务类类型
 ...
 * @class
 */
class TaskResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 请求时传入的DataId
 ...
 * @class
 */
class CreateAudioModerationTaskRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class CreateBizConfigResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class TaskLabel extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 命中的标签
 ...
 * @class
 */
class ImageResultsResultDetail extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 位置信息
 ...
 * @class
 */
class InputInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 传入的类型可选：URL，COS
 ...
 * @class
 */
class AudioResultDetailLanguageResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语种
 ...
 * @class
 */
class FileOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 存储的Bucket
 ...
 * @class
 */
class AudioResultDetailTextResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 标签
 ...
 * @class
 */
class AudioResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 是否命中
 ...
 * @class
 */
class AudioResultDetailMoanResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 固定为Moan
 ...
 * @class
 */
class DescribeBizConfigResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 业务类型
 ...
 * @class
 */
class MediaModerationConfig extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 音频截帧频率。默认一分钟
 ...
 * @class
 */
class AudioSegments extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 截帧时间。
 ...
 * @class
 */
class ImageResultsResultDetailLocation extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * x坐标
 ...
 * @class
 */
class ImageResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 违规标志
