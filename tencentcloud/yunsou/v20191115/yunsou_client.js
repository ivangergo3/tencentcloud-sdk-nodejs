...
const SearchResultSeg = models_1.Models.SearchResultSeg;
const DataManipulationResult = models_1.Models.DataManipulationResult;
const SearchResultItem = models_1.Models.SearchResultItem;
const DataSearchResponse = models_1.Models.DataSearchResponse;
const DataSearchRequest = models_1.Models.DataSearchRequest;
const DataManipulationResultItem = models_1.Models.DataManipulationResultItem;
...
class Client extends abstract_client_1.AbstractClient {
    constructor(credential, region, profile) {
        super("yunsou.tencentcloudapi.com", "2019-11-15", credential, region, profile);
    }
    /**
     * 上传云搜数据的API接口。
