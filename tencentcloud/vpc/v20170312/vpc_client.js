...
const CreateNetworkAclResponse = models_1.Models.CreateNetworkAclResponse;
const NetworkAcl = models_1.Models.NetworkAcl;
const ModifyAddressTemplateAttributeResponse = models_1.Models.ModifyAddressTemplateAttributeResponse;
const DisassociateDhcpIpWithAddressIpRequest = models_1.Models.DisassociateDhcpIpWithAddressIpRequest;
const SecurityGroupLimitSet = models_1.Models.SecurityGroupLimitSet;
const CreateRoutesRequest = models_1.Models.CreateRoutesRequest;
const DescribeHaVipsResponse = models_1.Models.DescribeHaVipsResponse;
const SecurityGroupAssociationStatistics = models_1.Models.SecurityGroupAssociationStatistics;
const DeleteServiceTemplateResponse = models_1.Models.DeleteServiceTemplateResponse;
const CreateServiceTemplateRequest = models_1.Models.CreateServiceTemplateRequest;
const IKEOptionsSpecification = models_1.Models.IKEOptionsSpecification;
const TransformAddressResponse = models_1.Models.TransformAddressResponse;
const DescribeVpnConnectionsRequest = models_1.Models.DescribeVpnConnectionsRequest;
const CreateAssistantCidrRequest = models_1.Models.CreateAssistantCidrRequest;
const DescribeNetworkInterfacesRequest = models_1.Models.DescribeNetworkInterfacesRequest;
const DescribeVpcLimitsRequest = models_1.Models.DescribeVpcLimitsRequest;
const ReleaseIp6AddressesBandwidthResponse = models_1.Models.ReleaseIp6AddressesBandwidthResponse;
const DescribeVpcIpv6AddressesRequest = models_1.Models.DescribeVpcIpv6AddressesRequest;
const DescribeCustomerGatewaysRequest = models_1.Models.DescribeCustomerGatewaysRequest;
const ModifyNatGatewayDestinationIpPortTranslationNatRuleResponse = models_1.Models.ModifyNatGatewayDestinationIpPortTranslationNatRuleResponse;
const ModifyIp6RuleResponse = models_1.Models.ModifyIp6RuleResponse;
const ModifyNetworkAclAttributeResponse = models_1.Models.ModifyNetworkAclAttributeResponse;
const DescribeVpnGatewaysResponse = models_1.Models.DescribeVpnGatewaysResponse;
const ServiceTemplateGroup = models_1.Models.ServiceTemplateGroup;
const CreateDhcpIpResponse = models_1.Models.CreateDhcpIpResponse;
const FlowLog = models_1.Models.FlowLog;
const CreateDefaultSecurityGroupRequest = models_1.Models.CreateDefaultSecurityGroupRequest;
const DescribeServiceTemplateGroupsResponse = models_1.Models.DescribeServiceTemplateGroupsResponse;
const DetachClassicLinkVpcRequest = models_1.Models.DetachClassicLinkVpcRequest;
const DeleteBandwidthPackageResponse = models_1.Models.DeleteBandwidthPackageResponse;
const ModifyNatGatewayAttributeRequest = models_1.Models.ModifyNatGatewayAttributeRequest;
const DescribeVpcLimitsResponse = models_1.Models.DescribeVpcLimitsResponse;
const AddBandwidthPackageResourcesRequest = models_1.Models.AddBandwidthPackageResourcesRequest;
const AssignIpv6SubnetCidrBlockRequest = models_1.Models.AssignIpv6SubnetCidrBlockRequest;
const CreateVpcResponse = models_1.Models.CreateVpcResponse;
const AssistantCidr = models_1.Models.AssistantCidr;
const ModifyNetworkAclEntriesRequest = models_1.Models.ModifyNetworkAclEntriesRequest;
const DescribeVpcPrivateIpAddressesRequest = models_1.Models.DescribeVpcPrivateIpAddressesRequest;
const AddressTemplate = models_1.Models.AddressTemplate;
const DescribeIp6TranslatorQuotaResponse = models_1.Models.DescribeIp6TranslatorQuotaResponse;
const VpnGatewayQuota = models_1.Models.VpnGatewayQuota;
const UnassignIpv6AddressesResponse = models_1.Models.UnassignIpv6AddressesResponse;
const CreateIp6TranslatorsResponse = models_1.Models.CreateIp6TranslatorsResponse;
const DescribeFlowLogsRequest = models_1.Models.DescribeFlowLogsRequest;
const AssociateNatGatewayAddressRequest = models_1.Models.AssociateNatGatewayAddressRequest;
const CreateDirectConnectGatewayRequest = models_1.Models.CreateDirectConnectGatewayRequest;
const ModifyBandwidthPackageAttributeRequest = models_1.Models.ModifyBandwidthPackageAttributeRequest;
const DisassociateNetworkInterfaceSecurityGroupsRequest = models_1.Models.DisassociateNetworkInterfaceSecurityGroupsRequest;
const SecurityGroupPolicySet = models_1.Models.SecurityGroupPolicySet;
const ModifyFlowLogAttributeRequest = models_1.Models.ModifyFlowLogAttributeRequest;
const AssociateNetworkAclSubnetsResponse = models_1.Models.AssociateNetworkAclSubnetsResponse;
const DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest = models_1.Models.DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest;
const ResetRoutesRequest = models_1.Models.ResetRoutesRequest;
const CheckDefaultSubnetRequest = models_1.Models.CheckDefaultSubnetRequest;
const CheckNetDetectStateRequest = models_1.Models.CheckNetDetectStateRequest;
const RouteTableAssociation = models_1.Models.RouteTableAssociation;
...
const DeleteCcnResponse = models_1.Models.DeleteCcnResponse;
const ServiceTemplate = models_1.Models.ServiceTemplate;
const DescribeCcnAttachedInstancesRequest = models_1.Models.DescribeCcnAttachedInstancesRequest;
const DescribeNatGatewaysRequest = models_1.Models.DescribeNatGatewaysRequest;
const ModifyFlowLogAttributeResponse = models_1.Models.ModifyFlowLogAttributeResponse;
const DescribeBandwidthPackagesResponse = models_1.Models.DescribeBandwidthPackagesResponse;
const DescribeDirectConnectGatewaysRequest = models_1.Models.DescribeDirectConnectGatewaysRequest;
const ModifyIp6TranslatorResponse = models_1.Models.ModifyIp6TranslatorResponse;
const DeleteIp6TranslatorsResponse = models_1.Models.DeleteIp6TranslatorsResponse;
const DescribeVpcsRequest = models_1.Models.DescribeVpcsRequest;
const DescribeRouteConflictsResponse = models_1.Models.DescribeRouteConflictsResponse;
const AcceptAttachCcnInstancesRequest = models_1.Models.AcceptAttachCcnInstancesRequest;
const DescribeGatewayFlowMonitorDetailResponse = models_1.Models.DescribeGatewayFlowMonitorDetailResponse;
const DeleteFlowLogRequest = models_1.Models.DeleteFlowLogRequest;
const NetDetectState = models_1.Models.NetDetectState;
const HaVipDisassociateAddressIpResponse = models_1.Models.HaVipDisassociateAddressIpResponse;
const DescribeTaskResultRequest = models_1.Models.DescribeTaskResultRequest;
const ModifyAddressInternetChargeTypeResponse = models_1.Models.ModifyAddressInternetChargeTypeResponse;
const UnassignIpv6SubnetCidrBlockRequest = models_1.Models.UnassignIpv6SubnetCidrBlockRequest;
const ModifyVpcAttributeRequest = models_1.Models.ModifyVpcAttributeRequest;
const AssignIpv6CidrBlockRequest = models_1.Models.AssignIpv6CidrBlockRequest;
const CreateSecurityGroupPoliciesResponse = models_1.Models.CreateSecurityGroupPoliciesResponse;
const HaVipAssociateAddressIpRequest = models_1.Models.HaVipAssociateAddressIpRequest;
const DisassociateNatGatewayAddressResponse = models_1.Models.DisassociateNatGatewayAddressResponse;
const DeleteRoutesResponse = models_1.Models.DeleteRoutesResponse;
const DescribeSecurityGroupAssociationStatisticsResponse = models_1.Models.DescribeSecurityGroupAssociationStatisticsResponse;
const ModifyAssistantCidrResponse = models_1.Models.ModifyAssistantCidrResponse;
const NatGatewayAddress = models_1.Models.NatGatewayAddress;
const ModifyNetworkAclEntriesResponse = models_1.Models.ModifyNetworkAclEntriesResponse;
const DescribeFlowLogRequest = models_1.Models.DescribeFlowLogRequest;
const DescribeIp6AddressesRequest = models_1.Models.DescribeIp6AddressesRequest;
const AddIp6RulesRequest = models_1.Models.AddIp6RulesRequest;
const DescribeAccountAttributesResponse = models_1.Models.DescribeAccountAttributesResponse;
const AssignPrivateIpAddressesResponse = models_1.Models.AssignPrivateIpAddressesResponse;
const DescribeSecurityGroupsRequest = models_1.Models.DescribeSecurityGroupsRequest;
const DescribeNatGatewayDestinationIpPortTranslationNatRulesRequest = models_1.Models.DescribeNatGatewayDestinationIpPortTranslationNatRulesRequest;
const AddBandwidthPackageResourcesResponse = models_1.Models.AddBandwidthPackageResourcesResponse;
const DisassociateNetworkAclSubnetsResponse = models_1.Models.DisassociateNetworkAclSubnetsResponse;
const SetCcnRegionBandwidthLimitsRequest = models_1.Models.SetCcnRegionBandwidthLimitsRequest;
const ModifyAddressInternetChargeTypeRequest = models_1.Models.ModifyAddressInternetChargeTypeRequest;
const ModifyIp6AddressesBandwidthRequest = models_1.Models.ModifyIp6AddressesBandwidthRequest;
const DescribeDirectConnectGatewaysResponse = models_1.Models.DescribeDirectConnectGatewaysResponse;
const Ip6RuleInfo = models_1.Models.Ip6RuleInfo;
const CreateSecurityGroupWithPoliciesResponse = models_1.Models.CreateSecurityGroupWithPoliciesResponse;
const DeleteAddressTemplateResponse = models_1.Models.DeleteAddressTemplateResponse;
const ModifySubnetAttributeResponse = models_1.Models.ModifySubnetAttributeResponse;
const ResetNatGatewayConnectionRequest = models_1.Models.ResetNatGatewayConnectionRequest;
const ReplaceDirectConnectGatewayCcnRoutesResponse = models_1.Models.ReplaceDirectConnectGatewayCcnRoutesResponse;
const DeleteAddressTemplateRequest = models_1.Models.DeleteAddressTemplateRequest;
const NetworkInterface = models_1.Models.NetworkInterface;
const TransformAddressRequest = models_1.Models.TransformAddressRequest;
const ReplaceDirectConnectGatewayCcnRoutesRequest = models_1.Models.ReplaceDirectConnectGatewayCcnRoutesRequest;
const ReferredSecurityGroup = models_1.Models.ReferredSecurityGroup;
const ModifyAddressTemplateAttributeRequest = models_1.Models.ModifyAddressTemplateAttributeRequest;
...
const ModifySecurityGroupAttributeRequest = models_1.Models.ModifySecurityGroupAttributeRequest;
const ModifyNetDetectRequest = models_1.Models.ModifyNetDetectRequest;
const DescribeVpcResourceDashboardResponse = models_1.Models.DescribeVpcResourceDashboardResponse;
const AllocateIp6AddressesBandwidthResponse = models_1.Models.AllocateIp6AddressesBandwidthResponse;
const DescribeNetDetectStatesRequest = models_1.Models.DescribeNetDetectStatesRequest;
const DescribeNatGatewaysResponse = models_1.Models.DescribeNatGatewaysResponse;
const DescribeFlowLogResponse = models_1.Models.DescribeFlowLogResponse;
const HaVipAssociateAddressIpResponse = models_1.Models.HaVipAssociateAddressIpResponse;
const DescribeBandwidthPackagesRequest = models_1.Models.DescribeBandwidthPackagesRequest;
const DeleteDirectConnectGatewayCcnRoutesResponse = models_1.Models.DeleteDirectConnectGatewayCcnRoutesResponse;
const DescribeAssistantCidrResponse = models_1.Models.DescribeAssistantCidrResponse;
const InstanceStatistic = models_1.Models.InstanceStatistic;
const CreateVpnConnectionRequest = models_1.Models.CreateVpnConnectionRequest;
const CcnRoute = models_1.Models.CcnRoute;
const DeleteSecurityGroupPoliciesRequest = models_1.Models.DeleteSecurityGroupPoliciesRequest;
const VpnConnection = models_1.Models.VpnConnection;
const DescribeCcnsRequest = models_1.Models.DescribeCcnsRequest;
const ModifyNatGatewayAttributeResponse = models_1.Models.ModifyNatGatewayAttributeResponse;
const DescribeNetDetectsRequest = models_1.Models.DescribeNetDetectsRequest;
const CreateAddressTemplateGroupRequest = models_1.Models.CreateAddressTemplateGroupRequest;
const DescribeCustomerGatewayVendorsResponse = models_1.Models.DescribeCustomerGatewayVendorsResponse;
const RouteConflict = models_1.Models.RouteConflict;
const DeleteSubnetResponse = models_1.Models.DeleteSubnetResponse;
const Vpc = models_1.Models.Vpc;
const CreateVpnGatewayResponse = models_1.Models.CreateVpnGatewayResponse;
const DescribeNatGatewayDestinationIpPortTranslationNatRulesResponse = models_1.Models.DescribeNatGatewayDestinationIpPortTranslationNatRulesResponse;
const DescribeVpcIpv6AddressesResponse = models_1.Models.DescribeVpcIpv6AddressesResponse;
const ResetAttachCcnInstancesResponse = models_1.Models.ResetAttachCcnInstancesResponse;
const RejectAttachCcnInstancesRequest = models_1.Models.RejectAttachCcnInstancesRequest;
const ModifyCcnRegionBandwidthLimitsTypeRequest = models_1.Models.ModifyCcnRegionBandwidthLimitsTypeRequest;
const DescribeVpcResourceDashboardRequest = models_1.Models.DescribeVpcResourceDashboardRequest;
const ModifyIp6RuleRequest = models_1.Models.ModifyIp6RuleRequest;
const ReplaceRouteTableAssociationRequest = models_1.Models.ReplaceRouteTableAssociationRequest;
const AssociateNetworkAclSubnetsRequest = models_1.Models.AssociateNetworkAclSubnetsRequest;
const CheckAssistantCidrRequest = models_1.Models.CheckAssistantCidrRequest;
const RenewVpnGatewayRequest = models_1.Models.RenewVpnGatewayRequest;
const SecurityGroupPolicy = models_1.Models.SecurityGroupPolicy;
const DeleteVpcRequest = models_1.Models.DeleteVpcRequest;
const ModifyServiceTemplateAttributeResponse = models_1.Models.ModifyServiceTemplateAttributeResponse;
const DescribeCcnsResponse = models_1.Models.DescribeCcnsResponse;
const TemplateLimit = models_1.Models.TemplateLimit;
const CreateSubnetResponse = models_1.Models.CreateSubnetResponse;
const DescribeSecurityGroupPoliciesResponse = models_1.Models.DescribeSecurityGroupPoliciesResponse;
const GetCcnRegionBandwidthLimitsResponse = models_1.Models.GetCcnRegionBandwidthLimitsResponse;
const ModifySecurityGroupPoliciesRequest = models_1.Models.ModifySecurityGroupPoliciesRequest;
const RemoveIp6RulesResponse = models_1.Models.RemoveIp6RulesResponse;
const AssociateDhcpIpWithAddressIpRequest = models_1.Models.AssociateDhcpIpWithAddressIpRequest;
const ReplaceRoutesRequest = models_1.Models.ReplaceRoutesRequest;
const CreateCustomerGatewayResponse = models_1.Models.CreateCustomerGatewayResponse;
const DeleteServiceTemplateGroupResponse = models_1.Models.DeleteServiceTemplateGroupResponse;
const DisassociateAddressRequest = models_1.Models.DisassociateAddressRequest;
const NetworkAclEntrySet = models_1.Models.NetworkAclEntrySet;
const DeleteVpnConnectionResponse = models_1.Models.DeleteVpnConnectionResponse;
const CreateCcnResponse = models_1.Models.CreateCcnResponse;
const EnableCcnRoutesRequest = models_1.Models.EnableCcnRoutesRequest;
const Tag = models_1.Models.Tag;
const DescribeVpcPrivateIpAddressesResponse = models_1.Models.DescribeVpcPrivateIpAddressesResponse;
const DefaultVpcSubnet = models_1.Models.DefaultVpcSubnet;
const DescribeIp6TranslatorsRequest = models_1.Models.DescribeIp6TranslatorsRequest;
const CreateSubnetsResponse = models_1.Models.CreateSubnetsResponse;
const DescribeGatewayFlowMonitorDetailRequest = models_1.Models.DescribeGatewayFlowMonitorDetailRequest;
const InquiryPriceCreateVpnGatewayResponse = models_1.Models.InquiryPriceCreateVpnGatewayResponse;
const DescribeSecurityGroupLimitsResponse = models_1.Models.DescribeSecurityGroupLimitsResponse;
const FilterObject = models_1.Models.FilterObject;
const ModifyDirectConnectGatewayAttributeRequest = models_1.Models.ModifyDirectConnectGatewayAttributeRequest;
const ModifyBandwidthPackageAttributeResponse = models_1.Models.ModifyBandwidthPackageAttributeResponse;
const DetachNetworkInterfaceResponse = models_1.Models.DetachNetworkInterfaceResponse;
const ResetRoutesResponse = models_1.Models.ResetRoutesResponse;
const DeleteNetworkAclRequest = models_1.Models.DeleteNetworkAclRequest;
const NatGatewayDestinationIpPortTranslationNatRule = models_1.Models.NatGatewayDestinationIpPortTranslationNatRule;
const DescribeNetDetectStatesResponse = models_1.Models.DescribeNetDetectStatesResponse;
const ModifyDhcpIpAttributeRequest = models_1.Models.ModifyDhcpIpAttributeRequest;
const ModifyIp6TranslatorRequest = models_1.Models.ModifyIp6TranslatorRequest;
const CreateVpnConnectionResponse = models_1.Models.CreateVpnConnectionResponse;
const AddressTemplateSpecification = models_1.Models.AddressTemplateSpecification;
const VpcIpv6Address = models_1.Models.VpcIpv6Address;
const AssignIpv6AddressesRequest = models_1.Models.AssignIpv6AddressesRequest;
const CreateServiceTemplateGroupResponse = models_1.Models.CreateServiceTemplateGroupResponse;
const NetDetect = models_1.Models.NetDetect;
const ModifyIpv6AddressesAttributeResponse = models_1.Models.ModifyIpv6AddressesAttributeResponse;
const ReplaceSecurityGroupPolicyRequest = models_1.Models.ReplaceSecurityGroupPolicyRequest;
const NatGateway = models_1.Models.NatGateway;
const ResourceDashboard = models_1.Models.ResourceDashboard;
const DescribeCcnAttachedInstancesResponse = models_1.Models.DescribeCcnAttachedInstancesResponse;
const DeleteCustomerGatewayResponse = models_1.Models.DeleteCustomerGatewayResponse;
const CreateNetDetectRequest = models_1.Models.CreateNetDetectRequest;
const CreateAddressTemplateResponse = models_1.Models.CreateAddressTemplateResponse;
const CreateNatGatewayDestinationIpPortTranslationNatRuleResponse = models_1.Models.CreateNatGatewayDestinationIpPortTranslationNatRuleResponse;
const DeleteAddressTemplateGroupRequest = models_1.Models.DeleteAddressTemplateGroupRequest;
const DescribeNetworkInterfaceLimitRequest = models_1.Models.DescribeNetworkInterfaceLimitRequest;
const CreateBandwidthPackageRequest = models_1.Models.CreateBandwidthPackageRequest;
const DescribeIp6AddressesResponse = models_1.Models.DescribeIp6AddressesResponse;
const ModifyRouteTableAttributeRequest = models_1.Models.ModifyRouteTableAttributeRequest;
const ModifyDirectConnectGatewayAttributeResponse = models_1.Models.ModifyDirectConnectGatewayAttributeResponse;
const DescribeVpnGatewaysRequest = models_1.Models.DescribeVpnGatewaysRequest;
const NetDetectIpState = models_1.Models.NetDetectIpState;
const ModifyIp6AddressesBandwidthResponse = models_1.Models.ModifyIp6AddressesBandwidthResponse;
const CreateSubnetsRequest = models_1.Models.CreateSubnetsRequest;
const ModifyServiceTemplateAttributeRequest = models_1.Models.ModifyServiceTemplateAttributeRequest;
...
const CreateNetworkAclRequest = models_1.Models.CreateNetworkAclRequest;
const DescribeAddressesRequest = models_1.Models.DescribeAddressesRequest;
const DescribeSecurityGroupPoliciesRequest = models_1.Models.DescribeSecurityGroupPoliciesRequest;
const ModifyNetworkInterfaceAttributeResponse = models_1.Models.ModifyNetworkInterfaceAttributeResponse;
const CreateSecurityGroupResponse = models_1.Models.CreateSecurityGroupResponse;
const DisassociateNetworkInterfaceSecurityGroupsResponse = models_1.Models.DisassociateNetworkInterfaceSecurityGroupsResponse;
const DescribeIp6TranslatorQuotaRequest = models_1.Models.DescribeIp6TranslatorQuotaRequest;
const DescribeNetworkInterfaceLimitResponse = models_1.Models.DescribeNetworkInterfaceLimitResponse;
const AssignIpv6CidrBlockResponse = models_1.Models.AssignIpv6CidrBlockResponse;
const CreateCcnRequest = models_1.Models.CreateCcnRequest;
const RemoveIp6RulesRequest = models_1.Models.RemoveIp6RulesRequest;
const AddIp6RulesResponse = models_1.Models.AddIp6RulesResponse;
const DeleteVpnConnectionRequest = models_1.Models.DeleteVpnConnectionRequest;
const NetworkAclEntry = models_1.Models.NetworkAclEntry;
const DescribeDhcpIpsRequest = models_1.Models.DescribeDhcpIpsRequest;
const DescribeAssistantCidrRequest = models_1.Models.DescribeAssistantCidrRequest;
const RenewVpnGatewayResponse = models_1.Models.RenewVpnGatewayResponse;
const DeleteDirectConnectGatewayResponse = models_1.Models.DeleteDirectConnectGatewayResponse;
const ModifyAddressesBandwidthRequest = models_1.Models.ModifyAddressesBandwidthRequest;
const ResetVpnGatewayInternetMaxBandwidthRequest = models_1.Models.ResetVpnGatewayInternetMaxBandwidthRequest;
const DirectConnectGateway = models_1.Models.DirectConnectGateway;
const Price = models_1.Models.Price;
const HaVipDisassociateAddressIpRequest = models_1.Models.HaVipDisassociateAddressIpRequest;
const ModifyVpnGatewayAttributeResponse = models_1.Models.ModifyVpnGatewayAttributeResponse;
const AssociateDirectConnectGatewayNatGatewayResponse = models_1.Models.AssociateDirectConnectGatewayNatGatewayResponse;
const DescribeVpnGatewayCcnRoutesRequest = models_1.Models.DescribeVpnGatewayCcnRoutesRequest;
const DisassociateDirectConnectGatewayNatGatewayResponse = models_1.Models.DisassociateDirectConnectGatewayNatGatewayResponse;
const CreateServiceTemplateGroupRequest = models_1.Models.CreateServiceTemplateGroupRequest;
const DescribeClassicLinkInstancesResponse = models_1.Models.DescribeClassicLinkInstancesResponse;
const DescribeVpnGatewayCcnRoutesResponse = models_1.Models.DescribeVpnGatewayCcnRoutesResponse;
const DetachCcnInstancesRequest = models_1.Models.DetachCcnInstancesRequest;
const CreateFlowLogResponse = models_1.Models.CreateFlowLogResponse;
const GetCcnRegionBandwidthLimitsRequest = models_1.Models.GetCcnRegionBandwidthLimitsRequest;
const ReleaseIp6AddressesBandwidthRequest = models_1.Models.ReleaseIp6AddressesBandwidthRequest;
const CcnAttachedInstance = models_1.Models.CcnAttachedInstance;
...
const DeleteHaVipResponse = models_1.Models.DeleteHaVipResponse;
const DescribeFlowLogsResponse = models_1.Models.DescribeFlowLogsResponse;
const VpcPrivateIpAddress = models_1.Models.VpcPrivateIpAddress;
const CvmInstance = models_1.Models.CvmInstance;
const DescribeNetworkAclsRequest = models_1.Models.DescribeNetworkAclsRequest;
...
const AddressTemplateGroup = models_1.Models.AddressTemplateGroup;
const DownloadCustomerGatewayConfigurationRequest = models_1.Models.DownloadCustomerGatewayConfigurationRequest;
const DeleteBandwidthPackageRequest = models_1.Models.DeleteBandwidthPackageRequest;
const HaVip = models_1.Models.HaVip;
const ModifyAddressesBandwidthResponse = models_1.Models.ModifyAddressesBandwidthResponse;
const ModifyCcnRegionBandwidthLimitsTypeResponse = models_1.Models.ModifyCcnRegionBandwidthLimitsTypeResponse;
const RejectAttachCcnInstancesResponse = models_1.Models.RejectAttachCcnInstancesResponse;
const SetCcnRegionBandwidthLimitsResponse = models_1.Models.SetCcnRegionBandwidthLimitsResponse;
const DescribeAccountAttributesRequest = models_1.Models.DescribeAccountAttributesRequest;
const DescribeCcnRoutesRequest = models_1.Models.DescribeCcnRoutesRequest;
const ModifyDhcpIpAttributeResponse = models_1.Models.ModifyDhcpIpAttributeResponse;
const CreateAndAttachNetworkInterfaceRequest = models_1.Models.CreateAndAttachNetworkInterfaceRequest;
const DownloadCustomerGatewayConfigurationResponse = models_1.Models.DownloadCustomerGatewayConfigurationResponse;
const DeleteDhcpIpResponse = models_1.Models.DeleteDhcpIpResponse;
const ModifyGatewayFlowQosRequest = models_1.Models.ModifyGatewayFlowQosRequest;
const DeleteNetDetectResponse = models_1.Models.DeleteNetDetectResponse;
...
const ModifyAssistantCidrRequest = models_1.Models.ModifyAssistantCidrRequest;
const CreateIp6TranslatorsRequest = models_1.Models.CreateIp6TranslatorsRequest;
const AssociateDhcpIpWithAddressIpResponse = models_1.Models.AssociateDhcpIpWithAddressIpResponse;
const ModifyGatewayFlowQosResponse = models_1.Models.ModifyGatewayFlowQosResponse;
const ModifySecurityGroupAttributeResponse = models_1.Models.ModifySecurityGroupAttributeResponse;
const AssociateDirectConnectGatewayNatGatewayRequest = models_1.Models.AssociateDirectConnectGatewayNatGatewayRequest;
const AddressTemplateItem = models_1.Models.AddressTemplateItem;
const ModifyAddressAttributeResponse = models_1.Models.ModifyAddressAttributeResponse;
const AttachClassicLinkVpcRequest = models_1.Models.AttachClassicLinkVpcRequest;
const GatewayFlowMonitorDetail = models_1.Models.GatewayFlowMonitorDetail;
const DeleteNatGatewayDestinationIpPortTranslationNatRuleResponse = models_1.Models.DeleteNatGatewayDestinationIpPortTranslationNatRuleResponse;
const DeleteVpnGatewayRequest = models_1.Models.DeleteVpnGatewayRequest;
const ReplaceRouteTableAssociationResponse = models_1.Models.ReplaceRouteTableAssociationResponse;
const AttachCcnInstancesRequest = models_1.Models.AttachCcnInstancesRequest;
const DescribeDirectConnectGatewayCcnRoutesRequest = models_1.Models.DescribeDirectConnectGatewayCcnRoutesRequest;
const CcnInstance = models_1.Models.CcnInstance;
...
const ConflictItem = models_1.Models.ConflictItem;
const InquiryPriceRenewVpnGatewayResponse = models_1.Models.InquiryPriceRenewVpnGatewayResponse;
const AssignIpv6SubnetCidrBlockResponse = models_1.Models.AssignIpv6SubnetCidrBlockResponse;
const DeleteAssistantCidrResponse = models_1.Models.DeleteAssistantCidrResponse;
const DescribeCcnRegionBandwidthLimitsResponse = models_1.Models.DescribeCcnRegionBandwidthLimitsResponse;
const DescribeAddressesResponse = models_1.Models.DescribeAddressesResponse;
const GatewayQos = models_1.Models.GatewayQos;
const ModifyIpv6AddressesAttributeRequest = models_1.Models.ModifyIpv6AddressesAttributeRequest;
const DescribeCustomerGatewayVendorsRequest = models_1.Models.DescribeCustomerGatewayVendorsRequest;
const DisableRoutesResponse = models_1.Models.DisableRoutesResponse;
const ResetVpnGatewayInternetMaxBandwidthResponse = models_1.Models.ResetVpnGatewayInternetMaxBandwidthResponse;
const AddressChargePrepaid = models_1.Models.AddressChargePrepaid;
const DescribeNetworkAclsResponse = models_1.Models.DescribeNetworkAclsResponse;
const DeleteFlowLogResponse = models_1.Models.DeleteFlowLogResponse;
const AttachCcnInstancesResponse = models_1.Models.AttachCcnInstancesResponse;
const CreateDefaultVpcResponse = models_1.Models.CreateDefaultVpcResponse;
...
const AlgType = models_1.Models.AlgType;
const MigratePrivateIpAddressResponse = models_1.Models.MigratePrivateIpAddressResponse;
const DeleteRouteTableResponse = models_1.Models.DeleteRouteTableResponse;
const DescribeVpcInstancesResponse = models_1.Models.DescribeVpcInstancesResponse;
const AccountAttribute = models_1.Models.AccountAttribute;
const DeleteDirectConnectGatewayCcnRoutesRequest = models_1.Models.DeleteDirectConnectGatewayCcnRoutesRequest;
const CreateNatGatewayDestinationIpPortTranslationNatRuleRequest = models_1.Models.CreateNatGatewayDestinationIpPortTranslationNatRuleRequest;
const CreateFlowLogRequest = models_1.Models.CreateFlowLogRequest;
const AttachNetworkInterfaceResponse = models_1.Models.AttachNetworkInterfaceResponse;
const DisassociateNatGatewayAddressRequest = models_1.Models.DisassociateNatGatewayAddressRequest;
const DescribeServiceTemplatesResponse = models_1.Models.DescribeServiceTemplatesResponse;
const DescribeRouteTablesRequest = models_1.Models.DescribeRouteTablesRequest;
const ResetAttachCcnInstancesRequest = models_1.Models.ResetAttachCcnInstancesRequest;
const CreateHaVipResponse = models_1.Models.CreateHaVipResponse;
const DescribeSecurityGroupReferencesRequest = models_1.Models.DescribeSecurityGroupReferencesRequest;
const DescribeTemplateLimitsResponse = models_1.Models.DescribeTemplateLimitsResponse;
const CheckDefaultSubnetResponse = models_1.Models.CheckDefaultSubnetResponse;
const DisableRoutesRequest = models_1.Models.DisableRoutesRequest;
const DisassociateDirectConnectGatewayNatGatewayRequest = models_1.Models.DisassociateDirectConnectGatewayNatGatewayRequest;
const EnableRoutesRequest = models_1.Models.EnableRoutesRequest;
const DescribeAddressTemplateGroupsResponse = models_1.Models.DescribeAddressTemplateGroupsResponse;
const ReleaseAddressesRequest = models_1.Models.ReleaseAddressesRequest;
const CreateDirectConnectGatewayCcnRoutesRequest = models_1.Models.CreateDirectConnectGatewayCcnRoutesRequest;
const CreateDirectConnectGatewayCcnRoutesResponse = models_1.Models.CreateDirectConnectGatewayCcnRoutesResponse;
const CreateRouteTableRequest = models_1.Models.CreateRouteTableRequest;
const MigrateNetworkInterfaceRequest = models_1.Models.MigrateNetworkInterfaceRequest;
const DisableCcnRoutesRequest = models_1.Models.DisableCcnRoutesRequest;
const ModifyAddressAttributeRequest = models_1.Models.ModifyAddressAttributeRequest;
const DhcpIp = models_1.Models.DhcpIp;
const DeleteAssistantCidrRequest = models_1.Models.DeleteAssistantCidrRequest;
const SubnetInput = models_1.Models.SubnetInput;
const UnassignIpv6SubnetCidrBlockResponse = models_1.Models.UnassignIpv6SubnetCidrBlockResponse;
const CreateNetDetectResponse = models_1.Models.CreateNetDetectResponse;
const DeleteCcnRequest = models_1.Models.DeleteCcnRequest;
const AssociateNetworkInterfaceSecurityGroupsResponse = models_1.Models.AssociateNetworkInterfaceSecurityGroupsResponse;
...
const DeleteNetDetectRequest = models_1.Models.DeleteNetDetectRequest;
const IPSECOptionsSpecification = models_1.Models.IPSECOptionsSpecification;
const UnassignIpv6AddressesRequest = models_1.Models.UnassignIpv6AddressesRequest;
const CreateAndAttachNetworkInterfaceResponse = models_1.Models.CreateAndAttachNetworkInterfaceResponse;
const ModifyCcnAttributeRequest = models_1.Models.ModifyCcnAttributeRequest;
const DeleteSecurityGroupPoliciesResponse = models_1.Models.DeleteSecurityGroupPoliciesResponse;
const DisassociateDhcpIpWithAddressIpResponse = models_1.Models.DisassociateDhcpIpWithAddressIpResponse;
const ModifyNetworkAclAttributeRequest = models_1.Models.ModifyNetworkAclAttributeRequest;
const DeleteVpnGatewayResponse = models_1.Models.DeleteVpnGatewayResponse;
const EnableCcnRoutesResponse = models_1.Models.EnableCcnRoutesResponse;
const DescribeHaVipsRequest = models_1.Models.DescribeHaVipsRequest;
const UnassignPrivateIpAddressesResponse = models_1.Models.UnassignPrivateIpAddressesResponse;
const Address = models_1.Models.Address;
const VpnGateway = models_1.Models.VpnGateway;
const EnableGatewayFlowMonitorResponse = models_1.Models.EnableGatewayFlowMonitorResponse;
const Resource = models_1.Models.Resource;
const DeleteDhcpIpRequest = models_1.Models.DeleteDhcpIpRequest;
const AllocateAddressesResponse = models_1.Models.AllocateAddressesResponse;
const BandwidthPackage = models_1.Models.BandwidthPackage;
const DescribeIp6TranslatorsResponse = models_1.Models.DescribeIp6TranslatorsResponse;
const CreateSecurityGroupPoliciesRequest = models_1.Models.CreateSecurityGroupPoliciesRequest;
const ModifyRouteTableAttributeResponse = models_1.Models.ModifyRouteTableAttributeResponse;
const DescribeSecurityGroupReferencesResponse = models_1.Models.DescribeSecurityGroupReferencesResponse;
const DisableGatewayFlowMonitorRequest = models_1.Models.DisableGatewayFlowMonitorRequest;
const CreateAddressTemplateGroupResponse = models_1.Models.CreateAddressTemplateGroupResponse;
const DescribeBandwidthPackageQuotaResponse = models_1.Models.DescribeBandwidthPackageQuotaResponse;
const DeleteServiceTemplateGroupRequest = models_1.Models.DeleteServiceTemplateGroupRequest;
const DeleteNatGatewayResponse = models_1.Models.DeleteNatGatewayResponse;
const CreateDirectConnectGatewayResponse = models_1.Models.CreateDirectConnectGatewayResponse;
const DescribeTaskResultResponse = models_1.Models.DescribeTaskResultResponse;
const DisassociateNetworkAclSubnetsRequest = models_1.Models.DisassociateNetworkAclSubnetsRequest;
const ModifyAddressTemplateGroupAttributeRequest = models_1.Models.ModifyAddressTemplateGroupAttributeRequest;
const ModifyServiceTemplateGroupAttributeRequest = models_1.Models.ModifyServiceTemplateGroupAttributeRequest;
const UnassignIpv6CidrBlockRequest = models_1.Models.UnassignIpv6CidrBlockRequest;
const CCN = models_1.Models.CCN;
const DeleteIp6TranslatorsRequest = models_1.Models.DeleteIp6TranslatorsRequest;
const Ip6Translator = models_1.Models.Ip6Translator;
const DestinationIpPortTranslationNatRule = models_1.Models.DestinationIpPortTranslationNatRule;
const CreateDefaultVpcRequest = models_1.Models.CreateDefaultVpcRequest;
...
const CheckAssistantCidrResponse = models_1.Models.CheckAssistantCidrResponse;
const InquiryPriceRenewVpnGatewayRequest = models_1.Models.InquiryPriceRenewVpnGatewayRequest;
const DeleteHaVipRequest = models_1.Models.DeleteHaVipRequest;
const ModifyVpnGatewayCcnRoutesResponse = models_1.Models.ModifyVpnGatewayCcnRoutesResponse;
const DetachCcnInstancesResponse = models_1.Models.DetachCcnInstancesResponse;
const ModifyServiceTemplateGroupAttributeResponse = models_1.Models.ModifyServiceTemplateGroupAttributeResponse;
const DeleteSubnetRequest = models_1.Models.DeleteSubnetRequest;
const DescribeAddressTemplateGroupsRequest = models_1.Models.DescribeAddressTemplateGroupsRequest;
const CheckNetDetectStateResponse = models_1.Models.CheckNetDetectStateResponse;
const AssociateNatGatewayAddressResponse = models_1.Models.AssociateNatGatewayAddressResponse;
const RemoveBandwidthPackageResourcesRequest = models_1.Models.RemoveBandwidthPackageResourcesRequest;
const VpngwCcnRoutes = models_1.Models.VpngwCcnRoutes;
...
const InquiryPriceResetVpnGatewayInternetMaxBandwidthResponse = models_1.Models.InquiryPriceResetVpnGatewayInternetMaxBandwidthResponse;
const DeleteAddressTemplateGroupResponse = models_1.Models.DeleteAddressTemplateGroupResponse;
const ReplaceRoutesResponse = models_1.Models.ReplaceRoutesResponse;
const DirectConnectGatewayCcnRoute = models_1.Models.DirectConnectGatewayCcnRoute;
const EnableRoutesResponse = models_1.Models.EnableRoutesResponse;
const CustomerGateway = models_1.Models.CustomerGateway;
const DescribeServiceTemplatesRequest = models_1.Models.DescribeServiceTemplatesRequest;
const DeleteRouteTableRequest = models_1.Models.DeleteRouteTableRequest;
const CreateVpnGatewayRequest = models_1.Models.CreateVpnGatewayRequest;
const DescribeVpcInstancesRequest = models_1.Models.DescribeVpcInstancesRequest;
const UnassignIpv6CidrBlockResponse = models_1.Models.UnassignIpv6CidrBlockResponse;
const CreateBandwidthPackageResponse = models_1.Models.CreateBandwidthPackageResponse;
...
const InquiryPriceResetVpnGatewayInternetMaxBandwidthRequest = models_1.Models.InquiryPriceResetVpnGatewayInternetMaxBandwidthRequest;
const ReplaceSecurityGroupPolicyResponse = models_1.Models.ReplaceSecurityGroupPolicyResponse;
const EnableGatewayFlowMonitorRequest = models_1.Models.EnableGatewayFlowMonitorRequest;
const ModifyPrivateIpAddressesAttributeResponse = models_1.Models.ModifyPrivateIpAddressesAttributeResponse;
const ModifyHaVipAttributeResponse = models_1.Models.ModifyHaVipAttributeResponse;
const CcnBandwidthInfo = models_1.Models.CcnBandwidthInfo;
const DeleteSecurityGroupResponse = models_1.Models.DeleteSecurityGroupResponse;
...
const RemoveBandwidthPackageResourcesResponse = models_1.Models.RemoveBandwidthPackageResourcesResponse;
const AssignIpv6AddressesResponse = models_1.Models.AssignIpv6AddressesResponse;
const CreateRoutesResponse = models_1.Models.CreateRoutesResponse;
const DescribeSecurityGroupsResponse = models_1.Models.DescribeSecurityGroupsResponse;
const ModifyVpnGatewayCcnRoutesRequest = models_1.Models.ModifyVpnGatewayCcnRoutesRequest;
const DescribeGatewayFlowQosRequest = models_1.Models.DescribeGatewayFlowQosRequest;
const MigratePrivateIpAddressRequest = models_1.Models.MigratePrivateIpAddressRequest;
const ModifySecurityGroupPoliciesResponse = models_1.Models.ModifySecurityGroupPoliciesResponse;
const ModifyNatGatewayDestinationIpPortTranslationNatRuleRequest = models_1.Models.ModifyNatGatewayDestinationIpPortTranslationNatRuleRequest;
const ServiceTemplateSpecification = models_1.Models.ServiceTemplateSpecification;
const DetachNetworkInterfaceRequest = models_1.Models.DetachNetworkInterfaceRequest;
const Ip6Rule = models_1.Models.Ip6Rule;
const AttachClassicLinkVpcResponse = models_1.Models.AttachClassicLinkVpcResponse;
const CreateAddressTemplateRequest = models_1.Models.CreateAddressTemplateRequest;
const DescribeRouteConflictsRequest = models_1.Models.DescribeRouteConflictsRequest;
const Subnet = models_1.Models.Subnet;
const AttachNetworkInterfaceRequest = models_1.Models.AttachNetworkInterfaceRequest;
const DescribeCcnRoutesResponse = models_1.Models.DescribeCcnRoutesResponse;
const AllocateIp6AddressesBandwidthRequest = models_1.Models.AllocateIp6AddressesBandwidthRequest;
const SecurityGroup = models_1.Models.SecurityGroup;
const DisableGatewayFlowMonitorResponse = models_1.Models.DisableGatewayFlowMonitorResponse;
const DisassociateAddressResponse = models_1.Models.DisassociateAddressResponse;
const DescribeGatewayFlowQosResponse = models_1.Models.DescribeGatewayFlowQosResponse;
const DeleteRoutesRequest = models_1.Models.DeleteRoutesRequest;
const AssociateAddressRequest = models_1.Models.AssociateAddressRequest;
const CcnRegionBandwidthLimit = models_1.Models.CcnRegionBandwidthLimit;
const CreateDefaultSecurityGroupResponse = models_1.Models.CreateDefaultSecurityGroupResponse;
const ClassicLinkInstance = models_1.Models.ClassicLinkInstance;
const NetworkInterfaceAttachment = models_1.Models.NetworkInterfaceAttachment;
const ModifyNetworkInterfaceAttributeRequest = models_1.Models.ModifyNetworkInterfaceAttributeRequest;
const ModifyHaVipAttributeRequest = models_1.Models.ModifyHaVipAttributeRequest;
const ModifyAddressTemplateGroupAttributeResponse = models_1.Models.ModifyAddressTemplateGroupAttributeResponse;
const VpcLimit = models_1.Models.VpcLimit;
const DetachClassicLinkVpcResponse = models_1.Models.DetachClassicLinkVpcResponse;
const MigrateNetworkInterfaceResponse = models_1.Models.MigrateNetworkInterfaceResponse;
const UnassignPrivateIpAddressesRequest = models_1.Models.UnassignPrivateIpAddressesRequest;
const Filter = models_1.Models.Filter;
const ModifyNetDetectResponse = models_1.Models.ModifyNetDetectResponse;
const CreateHaVipRequest = models_1.Models.CreateHaVipRequest;
const Ipv6SubnetCidrBlock = models_1.Models.Ipv6SubnetCidrBlock;
...
const DeleteSecurityGroupRequest = models_1.Models.DeleteSecurityGroupRequest;
const DescribeDhcpIpsResponse = models_1.Models.DescribeDhcpIpsResponse;
const CreateRouteTableResponse = models_1.Models.CreateRouteTableResponse;
const DeleteDirectConnectGatewayRequest = models_1.Models.DeleteDirectConnectGatewayRequest;
const DescribeDirectConnectGatewayCcnRoutesResponse = models_1.Models.DescribeDirectConnectGatewayCcnRoutesResponse;
const ModifyPrivateIpAddressesAttributeRequest = models_1.Models.ModifyPrivateIpAddressesAttributeRequest;
const ResetNatGatewayConnectionResponse = models_1.Models.ResetNatGatewayConnectionResponse;
const AssociateNetworkInterfaceSecurityGroupsRequest = models_1.Models.AssociateNetworkInterfaceSecurityGroupsRequest;
const CreateSecurityGroupRequest = models_1.Models.CreateSecurityGroupRequest;
const ModifyCcnAttributeResponse = models_1.Models.ModifyCcnAttributeResponse;
const DescribeSecurityGroupLimitsRequest = models_1.Models.DescribeSecurityGroupLimitsRequest;
const DescribeClassicLinkInstancesRequest = models_1.Models.DescribeClassicLinkInstancesRequest;
const CreateServiceTemplateResponse = models_1.Models.CreateServiceTemplateResponse;
const DeleteNetworkInterfaceResponse = models_1.Models.DeleteNetworkInterfaceResponse;
const DisableCcnRoutesResponse = models_1.Models.DisableCcnRoutesResponse;
const DescribeCcnRegionBandwidthLimitsRequest = models_1.Models.DescribeCcnRegionBandwidthLimitsRequest;
const InquiryPriceCreateVpnGatewayRequest = models_1.Models.InquiryPriceCreateVpnGatewayRequest;
const CreateAssistantCidrResponse = models_1.Models.CreateAssistantCidrResponse;
const CustomerGatewayVendor = models_1.Models.CustomerGatewayVendor;
const DescribeAddressTemplatesRequest = models_1.Models.DescribeAddressTemplatesRequest;
const ConflictSource = models_1.Models.ConflictSource;
const CreateDhcpIpRequest = models_1.Models.CreateDhcpIpRequest;
...
const DescribeAddressTemplatesResponse = models_1.Models.DescribeAddressTemplatesResponse;
...
const DeleteNetworkAclResponse = models_1.Models.DeleteNetworkAclResponse;
const AssignPrivateIpAddressesRequest = models_1.Models.AssignPrivateIpAddressesRequest;
const DescribeServiceTemplateGroupsRequest = models_1.Models.DescribeServiceTemplateGroupsRequest;
const CreateSecurityGroupWithPoliciesRequest = models_1.Models.CreateSecurityGroupWithPoliciesRequest;
const CreateVpcRequest = models_1.Models.CreateVpcRequest;
const DeleteServiceTemplateRequest = models_1.Models.DeleteServiceTemplateRequest;
const DescribeSecurityGroupAssociationStatisticsRequest = models_1.Models.DescribeSecurityGroupAssociationStatisticsRequest;
const Route = models_1.Models.Route;
const ModifySubnetAttributeRequest = models_1.Models.ModifySubnetAttributeRequest;
const DescribeBandwidthPackageQuotaRequest = models_1.Models.DescribeBandwidthPackageQuotaRequest;
const DeleteVpcResponse = models_1.Models.DeleteVpcResponse;
const DescribeTemplateLimitsRequest = models_1.Models.DescribeTemplateLimitsRequest;
const AcceptAttachCcnInstancesResponse = models_1.Models.AcceptAttachCcnInstancesResponse;
const InstanceChargePrepaid = models_1.Models.InstanceChargePrepaid;
const DescribeNetDetectsResponse = models_1.Models.DescribeNetDetectsResponse;
/**
 * vpc client
 * @class
 */
...
//# sourceMappingURL=vpc_client.js.map