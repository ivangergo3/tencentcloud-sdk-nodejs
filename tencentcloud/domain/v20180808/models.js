 ...
 * @class
 */
class CheckDomainResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 所查询域名名称
 ...
 * @class
 */
class DescribeDomainPriceListResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 域名价格列表
 ...
 * @class
 */
class CheckDomainRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 所查询域名名称
 ...
 * @class
 */
class PriceInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 域名后缀，例如.com
 ...
 * @class
 */
class DescribeDomainPriceListRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 查询价格的后缀列表。默认则为全部后缀
