...
const SentenceInfo = models_1.Models.SentenceInfo;
const InitOralProcessRequest = models_1.Models.InitOralProcessRequest;
const Keyword = models_1.Models.Keyword;
const KeywordEvaluateRequest = models_1.Models.KeywordEvaluateRequest;
const TransmitOralProcessRequest = models_1.Models.TransmitOralProcessRequest;
const TransmitOralProcessResponse = models_1.Models.TransmitOralProcessResponse;
const InitOralProcessResponse = models_1.Models.InitOralProcessResponse;
const KeywordEvaluateResponse = models_1.Models.KeywordEvaluateResponse;
const PhoneInfo = models_1.Models.PhoneInfo;
const WordRsp = models_1.Models.WordRsp;
const KeywordScore = models_1.Models.KeywordScore;
const TransmitOralProcessWithInitRequest = models_1.Models.TransmitOralProcessWithInitRequest;
const TransmitOralProcessWithInitResponse = models_1.Models.TransmitOralProcessWithInitResponse;
/**
 * soe client
 * @class
 */
class Client extends abstract_client_1.AbstractClient {
    ...
    InitOralProcess(req, cb) {
        const resp = new InitOralProcessResponse();
    ...
    KeywordEvaluate(req, cb) {
        const resp = new KeywordEvaluateResponse();
    ...
    TransmitOralProcess(req, cb) {
        const resp = new TransmitOralProcessResponse();
    ...
    TransmitOralProcessWithInit(req, cb) {
        const resp = new TransmitOralProcessWithInitResponse();
        this.request("TransmitOralProcessWithInit", req, resp, cb);
    }
}
exports.Client = Client;
//# sourceMappingURL=soe_client.js.map