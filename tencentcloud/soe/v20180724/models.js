 ...
 * @class
 */
class SentenceInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class InitOralProcessRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class KeywordEvaluateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class TransmitOralProcessRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 流式数据包的序号，从1开始，当IsEnd字段为1后后续序号无意义，当IsLongLifeSession不为1且为非流式模式时无意义。
 ...
 * @class
 */
class TransmitOralProcessResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class InitOralProcessResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音段唯一标识，一个完整语音一个SessionId
 ...
 * @class
 */
class KeywordEvaluateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 关键词得分
 ...
 * @class
 */
class PhoneInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 当前音节语音起始时间点，单位为ms
 ...
 * @class
 */
class WordRsp extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class KeywordScore extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 关键词
 ...
 * @class
 */
class TransmitOralProcessWithInitRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 流式数据包的序号，从1开始，当IsEnd字段为1后后续序号无意义，当IsLongLifeSession不为1且为非流式模式时无意义。
 ...
 * @class
 */
class TransmitOralProcessWithInitResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 发音精准度，取值范围[-1, 100]，当取-1时指完全不匹配，当为句子模式时，是所有已识别单词准确度的加权平均值，在reftext中但未识别出来的词不计入分数中。当为流式模式且请求中IsEnd未置1时，取值无意义。
