 ...
 * @class
 */
class TryLipstickPicRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唇色信息。
 ...
 * @class
 */
class GetModelListRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 起始序号，默认值为0。
 ...
 * @class
 */
class TryLipstickPicResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class LipColorInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 使用RGBA模型试唇色。
 ...
 * @class
 */
class RGBAInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * R通道数值。[0,255]。
 ...
 * @class
 */
class GetModelListResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唇色素材总数量。
 ...
 * @class
 */
class ModelInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唇色素材ID
 ...
 * @class
 */
class BeautifyPicRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class BeautifyPicResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * RspImgType 为 base64 时，返回处理后的图片 base64 数据。默认返回base64
