 ...
 * @class
 */
class DescribeDomainInfoResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DescribeIpInfoRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 要查询的IP
 ...
 * @class
 */
class DescribeThreatInfoResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 是否有数据，0代表有数据，1代表没有数据
 ...
 * @class
 */
class DescribeDomainInfoRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 要查询的域名
 ...
 * @class
 */
class IntelligenceType extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 来源
 ...
 * @class
 */
class FileInfoType extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 判定渠道
 ...
 * @class
 */
class TagType extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 标签
 ...
 * @class
 */
class DescribeFileInfoResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 是否有数据，0代表有数据，1代表没有数据
 ...
 * @class
 */
class DescribeThreatInfoRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 查询对象，域名或IP
 ...
 * @class
 */
class DescribeFileInfoRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 要查询文件的MD5
 ...
 * @class
 */
class DescribeIpInfoResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 是否有数据，0代表有数据，1代表没有数据
