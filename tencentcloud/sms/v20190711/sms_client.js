...
const PullSmsReplyStatusRequest = models_1.Models.PullSmsReplyStatusRequest;
const DeleteSmsTemplateResponse = models_1.Models.DeleteSmsTemplateResponse;
const ModifySmsTemplateResponse = models_1.Models.ModifySmsTemplateResponse;
const ModifySmsSignRequest = models_1.Models.ModifySmsSignRequest;
const AddSmsSignRequest = models_1.Models.AddSmsSignRequest;
const AddTemplateStatus = models_1.Models.AddTemplateStatus;
const DescribeSmsTemplateListResponse = models_1.Models.DescribeSmsTemplateListResponse;
const PullSmsSendStatusByPhoneNumberRequest = models_1.Models.PullSmsSendStatusByPhoneNumberRequest;
const AddSmsTemplateRequest = models_1.Models.AddSmsTemplateRequest;
const ModifySmsTemplateRequest = models_1.Models.ModifySmsTemplateRequest;
const PullSmsReplyStatus = models_1.Models.PullSmsReplyStatus;
const CallbackStatusStatisticsResponse = models_1.Models.CallbackStatusStatisticsResponse;
const PullSmsSendStatusRequest = models_1.Models.PullSmsSendStatusRequest;
const SmsPackagesStatistics = models_1.Models.SmsPackagesStatistics;
const PullSmsSendStatusByPhoneNumberResponse = models_1.Models.PullSmsSendStatusByPhoneNumberResponse;
const ModifySignStatus = models_1.Models.ModifySignStatus;
const DescribeSignListStatus = models_1.Models.DescribeSignListStatus;
const SendSmsResponse = models_1.Models.SendSmsResponse;
const SendStatusStatisticsResponse = models_1.Models.SendStatusStatisticsResponse;
const SendSmsRequest = models_1.Models.SendSmsRequest;
const SendStatusStatistics = models_1.Models.SendStatusStatistics;
const CallbackStatusStatisticsRequest = models_1.Models.CallbackStatusStatisticsRequest;
const DeleteTemplateStatus = models_1.Models.DeleteTemplateStatus;
const DescribeSmsSignListRequest = models_1.Models.DescribeSmsSignListRequest;
const SmsPackagesStatisticsRequest = models_1.Models.SmsPackagesStatisticsRequest;
const DescribeTemplateListStatus = models_1.Models.DescribeTemplateListStatus;
const AddSmsTemplateResponse = models_1.Models.AddSmsTemplateResponse;
const PullSmsSendStatus = models_1.Models.PullSmsSendStatus;
const DescribeSmsSignListResponse = models_1.Models.DescribeSmsSignListResponse;
const DescribeSmsTemplateListRequest = models_1.Models.DescribeSmsTemplateListRequest;
const CallbackStatusStatistics = models_1.Models.CallbackStatusStatistics;
const SendStatusStatisticsRequest = models_1.Models.SendStatusStatisticsRequest;
const DeleteSmsTemplateRequest = models_1.Models.DeleteSmsTemplateRequest;
const PullSmsReplyStatusByPhoneNumberResponse = models_1.Models.PullSmsReplyStatusByPhoneNumberResponse;
const SendStatus = models_1.Models.SendStatus;
const DeleteSmsSignResponse = models_1.Models.DeleteSmsSignResponse;
const AddSmsSignResponse = models_1.Models.AddSmsSignResponse;
const DeleteSmsSignRequest = models_1.Models.DeleteSmsSignRequest;
const PullSmsReplyStatusByPhoneNumberRequest = models_1.Models.PullSmsReplyStatusByPhoneNumberRequest;
const ModifySmsSignResponse = models_1.Models.ModifySmsSignResponse;
const AddSignStatus = models_1.Models.AddSignStatus;
const ModifyTemplateStatus = models_1.Models.ModifyTemplateStatus;
const PullSmsSendStatusResponse = models_1.Models.PullSmsSendStatusResponse;
const SmsPackagesStatisticsResponse = models_1.Models.SmsPackagesStatisticsResponse;
const DeleteSignStatus = models_1.Models.DeleteSignStatus;
const PullSmsReplyStatusResponse = models_1.Models.PullSmsReplyStatusResponse;
/**
 * sms client
 * @class
 */
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    ModifySmsSign(req, cb) {
        const resp = new ModifySmsSignResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
     ...
     */
    AddSmsSign(req, cb) {
        const resp = new AddSmsSignResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    PullSmsSendStatus(req, cb) {
        const resp = new PullSmsSendStatusResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
     ...
     */
    SendSms(req, cb) {
        const resp = new SendSmsResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    DeleteSmsTemplate(req, cb) {
        const resp = new DeleteSmsTemplateResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    SmsPackagesStatistics(req, cb) {
        const resp = new SmsPackagesStatisticsResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    SendStatusStatistics(req, cb) {
        const resp = new SendStatusStatisticsResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    CallbackStatusStatistics(req, cb) {
        const resp = new CallbackStatusStatisticsResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    DescribeSmsTemplateList(req, cb) {
        const resp = new DescribeSmsTemplateListResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    PullSmsReplyStatus(req, cb) {
        const resp = new PullSmsReplyStatusResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    DescribeSmsSignList(req, cb) {
        const resp = new DescribeSmsSignListResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    PullSmsSendStatusByPhoneNumber(req, cb) {
        const resp = new PullSmsSendStatusByPhoneNumberResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    ModifySmsTemplate(req, cb) {
        const resp = new ModifySmsTemplateResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    PullSmsReplyStatusByPhoneNumber(req, cb) {
        const resp = new PullSmsReplyStatusByPhoneNumberResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    DeleteSmsSign(req, cb) {
        const resp = new DeleteSmsSignResponse();
...
>- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2019-07-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    ...
    AddSmsTemplate(req, cb) {
        const resp = new AddSmsTemplateResponse();
        this.request("AddSmsTemplate", req, resp, cb);
    }
}
exports.Client = Client;
//# sourceMappingURL=sms_client.js.map