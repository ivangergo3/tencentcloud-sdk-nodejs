 ...
 * @class
 */
class DescribeMigrationTaskRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务ID，例如msp-jitoh33n
 ...
 * @class
 */
class TimeObj extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 创建时间
 ...
 * @class
 */
class ModifyMigrationTaskBelongToProjectRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务ID，例如msp-jitoh33n
 ...
 * @class
 */
class ModifyMigrationTaskStatusResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ListMigrationTaskRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 记录起始数，默认值为0
 ...
 * @class
 */
class DeregisterMigrationTaskResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class ModifyMigrationTaskBelongToProjectResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class ListMigrationProjectResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 项目列表
 ...
 * @class
 */
class RegisterMigrationTaskResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务ID
 ...
 * @class
 */
class ModifyMigrationTaskStatusRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ListMigrationProjectRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 记录起始数，默认值为0
 ...
 * @class
 */
class DeregisterMigrationTaskRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务ID
 ...
 * @class
 */
class ListMigrationTaskResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 记录总条数
 ...
 * @class
 */
class DescribeMigrationTaskResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 迁移详情列表
 ...
 * @class
 */
class RegisterMigrationTaskRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
