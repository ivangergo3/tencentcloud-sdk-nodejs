...
const DetectProductBetaResponse = models_1.Models.DetectProductBetaResponse;
const DetectDisgustRequest = models_1.Models.DetectDisgustRequest;
const DetectCelebrityResponse = models_1.Models.DetectCelebrityResponse;
const CropImageRequest = models_1.Models.CropImageRequest;
const DetectProductRequest = models_1.Models.DetectProductRequest;
const AssessQualityResponse = models_1.Models.AssessQualityResponse;
const DetectDisgustResponse = models_1.Models.DetectDisgustResponse;
const DetectLabelRequest = models_1.Models.DetectLabelRequest;
const DetectLabelResponse = models_1.Models.DetectLabelResponse;
const EnhanceImageResponse = models_1.Models.EnhanceImageResponse;
const ProductInfo = models_1.Models.ProductInfo;
const AssessQualityRequest = models_1.Models.AssessQualityRequest;
const DetectProductBetaRequest = models_1.Models.DetectProductBetaRequest;
const DetectMisbehaviorResponse = models_1.Models.DetectMisbehaviorResponse;
const RecognizeCarRequest = models_1.Models.RecognizeCarRequest;
const EnhanceImageRequest = models_1.Models.EnhanceImageRequest;
const CropImageResponse = models_1.Models.CropImageResponse;
const DetectCelebrityRequest = models_1.Models.DetectCelebrityRequest;
const Coord = models_1.Models.Coord;
const Face = models_1.Models.Face;
const DetectProductResponse = models_1.Models.DetectProductResponse;
const DetectLabelItem = models_1.Models.DetectLabelItem;
const Location = models_1.Models.Location;
const Labels = models_1.Models.Labels;
const Product = models_1.Models.Product;
const RegionDetected = models_1.Models.RegionDetected;
const CarTagItem = models_1.Models.CarTagItem;
const Threshold = models_1.Models.Threshold;
const RecognizeCarResponse = models_1.Models.RecognizeCarResponse;
const DetectMisbehaviorRequest = models_1.Models.DetectMisbehaviorRequest;
/**
 * tiia client
 * @class
 */
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
    ...
    DetectProductBeta(req, cb) {
        const resp = new DetectProductBetaResponse();
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     */
    RecognizeCar(req, cb) {
        const resp = new RecognizeCarResponse();
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     */
    DetectLabel(req, cb) {
        const resp = new DetectLabelResponse();
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
    ...
    AssessQuality(req, cb) {
        const resp = new AssessQualityResponse();
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
    ...
    DetectDisgust(req, cb) {
        const resp = new DetectDisgustResponse();
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     */
    CropImage(req, cb) {
        const resp = new CropImageResponse();
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
    ...
    DetectMisbehavior(req, cb) {
        const resp = new DetectMisbehaviorResponse();
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
    ...
    DetectProduct(req, cb) {
        const resp = new DetectProductResponse();
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     */
    EnhanceImage(req, cb) {
        const resp = new EnhanceImageResponse();
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
    ...
    DetectCelebrity(req, cb) {
        const resp = new DetectCelebrityResponse();
        this.request("DetectCelebrity", req, resp, cb);
    }
}
exports.Client = Client;
//# sourceMappingURL=tiia_client.js.map