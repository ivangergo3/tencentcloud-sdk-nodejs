 ...
 * @class
 */
class GetLocalEngineResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ScanFileHashResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 接口调用状态，成功返回200，失败返回400
 ...
 * @class
 */
class ScanFileHashRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ScanFileResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 接口调用状态，成功返回200，失败返回400
 ...
 * @class
 */
class GetScanResultResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 接口调用状态，成功返回200，失败返回400
 ...
 * @class
 */
class GetLocalEngineRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 购买服务后获得的授权信息，用于保证请求有效性
 ...
 * @class
 */
class GetScanResultRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 购买服务后获得的授权信息，用于保证请求有效性
 ...
 * @class
 */
class ScanFileRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 购买服务后获得的授权信息，用于保证请求有效性
