 ...
 * @class
 */
class MarketingValueJudgementRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 手机账号类型填写4
 ...
 * @class
 */
class Data extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 操作时间戳，单位秒
 ...
 * @class
 */
class MarketingValueJudgementResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 返回数据
