 ...
 * @class
 */
class SwapGenderPicRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人脸转化性别信息。
 ...
 * @class
 */
class AgeInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 变化到的人脸年龄 [10,80]。
 ...
 * @class
 */
class GenderInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 选择转换方向，0：男变女，1：女变男。
 ...
 * @class
 */
class SwapGenderPicResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ChangeAgePicResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * RspImgType 为 base64 时，返回处理后的图片 base64 数据。默认返回base64
 ...
 * @class
 */
class ChangeAgePicRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人脸变老变年轻信息。
