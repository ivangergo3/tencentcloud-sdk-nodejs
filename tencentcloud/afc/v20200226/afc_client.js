...
const QueryAntiFraudVipRequest = models_1.Models.QueryAntiFraudVipRequest;
const RiskDetail = models_1.Models.RiskDetail;
const QueryAntiFraudVipResponse = models_1.Models.QueryAntiFraudVipResponse;
/**
 * afc client
 * @class
 */
...
的损失。
    ...
    QueryAntiFraudVip(req, cb) {
        const resp = new QueryAntiFraudVipResponse();
        this.request("QueryAntiFraudVip", req, resp, cb);
    }
}
exports.Client = Client;
//# sourceMappingURL=afc_client.js.map