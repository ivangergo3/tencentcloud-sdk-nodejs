...
const UploadFileRequest = models_1.Models.UploadFileRequest;
const UploadFileResponse = models_1.Models.UploadFileResponse;
const UploadDataJsonResponse = models_1.Models.UploadDataJsonResponse;
const DescribeTaskStatusResponse = models_1.Models.DescribeTaskStatusResponse;
const DownloadReportRequest = models_1.Models.DownloadReportRequest;
const ApplyCreditAuditResponse = models_1.Models.ApplyCreditAuditResponse;
const UploadDataFileResponse = models_1.Models.UploadDataFileResponse;
const SingleBlackApply = models_1.Models.SingleBlackApply;
const SingleRecord = models_1.Models.SingleRecord;
const QueryInstantDataResponse = models_1.Models.QueryInstantDataResponse;
const DownloadRecordListRequest = models_1.Models.DownloadRecordListRequest;
const UploadDataJsonRequest = models_1.Models.UploadDataJsonRequest;
const DescribeCreditResultResponse = models_1.Models.DescribeCreditResultResponse;
const DownloadDialogueTextResponse = models_1.Models.DownloadDialogueTextResponse;
const QueryInstantDataRequest = models_1.Models.QueryInstantDataRequest;
const ApplyBlackListResponse = models_1.Models.ApplyBlackListResponse;
const DescribeRecordsRequest = models_1.Models.DescribeRecordsRequest;
const DescribeCreditResultRequest = models_1.Models.DescribeCreditResultRequest;
const ApplyBlackListRequest = models_1.Models.ApplyBlackListRequest;
const ApplyCreditAuditRequest = models_1.Models.ApplyCreditAuditRequest;
const DownloadReportResponse = models_1.Models.DownloadReportResponse;
const DownloadRecordListResponse = models_1.Models.DownloadRecordListResponse;
const UploadDataFileRequest = models_1.Models.UploadDataFileRequest;
const DescribeTaskStatusRequest = models_1.Models.DescribeTaskStatusRequest;
const DescribeRecordsResponse = models_1.Models.DescribeRecordsResponse;
const DownloadDialogueTextRequest = models_1.Models.DownloadDialogueTextRequest;
/**
 * cr client
 * @class
 */
class Client extends abstract_client_1.AbstractClient {
    ...
    DownloadReport(req, cb) {
        const resp = new DownloadReportResponse();
     ...
     */
    UploadFile(req, cb) {
        const resp = new UploadFileResponse();
    ...
    UploadDataJson(req, cb) {
        const resp = new UploadDataJsonResponse();
    ...
    DescribeRecords(req, cb) {
        const resp = new DescribeRecordsResponse();
    ...
    DescribeCreditResult(req, cb) {
        const resp = new DescribeCreditResultResponse();
    ...
    DownloadDialogueText(req, cb) {
        const resp = new DownloadDialogueTextResponse();
    ...
    UploadDataFile(req, cb) {
        const resp = new UploadDataFileResponse();
        let options = {
            multipart: true
        };
    ...
    QueryInstantData(req, cb) {
        const resp = new QueryInstantDataResponse();
...
<p>注意：录音清单中的录音下载链接仅次日20:00之前有效，请及时下载。</p>
    ...
    DownloadRecordList(req, cb) {
        const resp = new DownloadRecordListResponse();
    ...
    ApplyBlackList(req, cb) {
        const resp = new ApplyBlackListResponse();
    ...
    ApplyCreditAudit(req, cb) {
        const resp = new ApplyCreditAuditResponse();
        this.request("ApplyCreditAudit", req, resp, cb);
    }
}
exports.Client = Client;
//# sourceMappingURL=cr_client.js.map