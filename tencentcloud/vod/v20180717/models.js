 ...
 * @class
 */
class Canvas extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 背景颜色，取值有：
 ...
 * @class
 */
class ModifySampleSnapshotTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ModifyWatermarkTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 水印模板唯一标识。
 ...
 * @class
 */
class AiRecognitionTaskAsrFullTextSegmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 识别片段置信度。取值：0~100。
 ...
 * @class
 */
class UserDefineOcrTextReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 用户自定文本审核任务开关，可选值：
 ...
 * @class
 */
class DescribeAllClassRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 点播[子应用](/document/product/266/14574) ID。如果要访问子应用中的资源，则将该字段填写为子应用 ID；否则无需填写该字段。
 ...
 * @class
 */
class WeChatMiniProgramPublishRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 媒体文件 ID。
 ...
 * @class
 */
class AiAnalysisTaskClassificationInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频智能分类模板 ID。
 ...
 * @class
 */
class SvgWatermarkInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class CreateTranscodeTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class TransitionOpertion extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转场类型，取值有：
 ...
 * @class
 */
class AudioTrackItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class MediaAiAnalysisHighlightItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能精彩集锦地址。
 ...
 * @class
 */
class DescribeAnimatedGraphicsTemplatesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AiReviewTaskProhibitedAsrResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AdaptiveDynamicStreamingTemplate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转自适应码流模板唯一标识。
 ...
 * @class
 */
class DeleteAnimatedGraphicsTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class AiReviewTaskProhibitedOcrResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class AiRecognitionTaskAsrFullTextResultOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音全文识别片段列表。
 ...
 * @class
 */
class AiReviewProhibitedOcrTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class MediaMiniProgramReviewElem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 审核类型。
 ...
 * @class
 */
class AiAnalysisTaskCoverOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能封面列表。
 ...
 * @class
 */
class MediaSnapshotByTimeOffsetItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ModifySampleSnapshotTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 采样截图模板唯一标识。
 ...
 * @class
 */
class AiReviewPoliticalOcrTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 鉴政模板 ID。
 ...
 * @class
 */
class MediaInputInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频 URL。
 ...
 * @class
 */
class CreateImageSpriteTask2017 extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 截图雪碧图任务 ID。
 ...
 * @class
 */
class TempCertificate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 临时安全证书 Id。
 ...
 * @class
 */
class AiReviewTaskPoliticalOcrResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class AiSampleWord extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 关键词。
 ...
 * @class
 */
class CreateImageSpriteTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 采样类型，取值：
 ...
 * @class
 */
class MediaSnapshotByTimePicInfoItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class UserDefineFaceReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 用户自定义人物审核任务开关，可选值：
 ...
 * @class
 */
class ContentReviewTemplateItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 内容审核模板唯一标识。
 ...
 * @class
 */
class DeleteAIRecognitionTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class DeleteContentReviewTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 内容审核模板唯一标识。
 ...
 * @class
 */
class AiReviewPoliticalTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 鉴政模板 ID。
 ...
 * @class
 */
class AudioTransform extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 音频操作类型，取值有：
 ...
 * @class
 */
class ResetProcedureTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务流名字
 ...
 * @class
 */
class ComposeMediaResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DeleteSampleSnapshotTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 采样截图模板唯一标识。
 ...
 * @class
 */
class DescribeStorageDataResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 当前媒体总量。
 ...
 * @class
 */
class AudioTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 音频流的编码格式。
 ...
 * @class
 */
class ModifySubAppIdInfoRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 子应用 ID。
 ...
 * @class
 */
class DeletePersonSampleRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人物 ID。
 ...
 * @class
 */
class MediaSampleSnapshotItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AiRecognitionTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频智能识别模板 ID 。
 ...
 * @class
 */
class AudioTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 音频流的编码格式。
 ...
 * @class
 */
class ExecuteFunctionResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class CoverConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能封面任务开关，可选值：
 ...
 * @class
 */
class ComposeMediaRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AIRecognitionTemplateItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频内容识别模板唯一标识。
 ...
 * @class
 */
class AiReviewPornAsrTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 鉴黄模板 ID。
 ...
 * @class
 */
class AiRecognitionTaskFaceResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class AiRecognitionTaskHeadTailResultInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频片头片尾识别模板 ID。
 ...
 * @class
 */
class CreateAdaptiveDynamicStreamingTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 自适应转码格式，取值范围：
 ...
 * @class
 */
class PushUrlCacheResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class MediaProcessTaskSampleSnapshotResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class TerrorismImgReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面鉴恐任务开关，可选值：
 ...
 * @class
 */
class ModifyTranscodeTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转码模板唯一标识。
 ...
 * @class
 */
class AiAnalysisTaskHighlightResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class DeleteAIAnalysisTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class ApplyUploadResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class TextWatermarkTemplateInputForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 字体类型，目前可以支持两种：
 ...
 * @class
 */
class DeleteSuperPlayerConfigRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 播放器配置名称。
 ...
 * @class
 */
class AiReviewTerrorismOcrTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 鉴恐模板 ID。
 ...
 * @class
 */
class AiRecognitionTaskOcrWordsResultInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本关键词识别模板 ID。
 ...
 * @class
 */
class AiReviewPornTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 鉴黄模板 ID。
 ...
 * @class
 */
class CreateProcedureTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务流名字（支持中文，不超过20个字）。
 ...
 * @class
 */
class DescribeMediaProcessUsageDataRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class CreatePersonSampleRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人物名称，长度限制：20 个字符。
 ...
 * @class
 */
class MediaTransitionItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class MediaAiAnalysisCoverItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能封面地址。
 ...
 * @class
 */
class TagConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能标签任务开关，可选值：
 ...
 * @class
 */
class ModifySuperPlayerConfigResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class AiRecognitionTaskOcrWordsResultOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本关键词识别结果集。
 ...
 * @class
 */
class ConcatTask2017 extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频拼接任务 ID。
 ...
 * @class
 */
class DeleteAIRecognitionTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频内容识别模板唯一标识。
 ...
 * @class
 */
class FileUploadTask extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文件唯一 ID。
 ...
 * @class
 */
class AiAnalysisTaskCoverResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class AiAnalysisTaskClassificationOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频智能分类列表。
 ...
 * @class
 */
class FileDeleteTask extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 删除文件 ID 列表。
 ...
 * @class
 */
class AiRecognitionTaskOcrFullTextResultOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本全文识别结果集。
 ...
 * @class
 */
class EditMediaTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class UserDefineAsrTextReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 用户自定语音审核任务开关，可选值：
 ...
 * @class
 */
class DescribeWordSamplesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合条件的记录总数。
 ...
 * @class
 */
class AiSampleFaceInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人脸图片 ID。
 ...
 * @class
 */
class MediaProcessTaskAdaptiveDynamicStreamingResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class OcrWordsConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本关键词识别任务开关，可选值：
 ...
 * @class
 */
class WatermarkTemplate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 水印模板唯一标识。
 ...
 * @class
 */
class CoverBySnapshotTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 封面 URL。
 ...
 * @class
 */
class TextWatermarkTemplateInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 字体类型，目前可以支持两种：
 ...
 * @class
 */
class ForbidMediaDistributionRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 媒体文件列表，每次最多可提交 20 条。
 ...
 * @class
 */
class DescribeAIRecognitionTemplatesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合过滤条件的记录总数。
 ...
 * @class
 */
class EditMediaResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class PoliticalOcrReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本鉴政任务开关，可选值：
 ...
 * @class
 */
class ProcessMediaByUrlRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ModifyMediaInfoRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 媒体文件唯一标识。
 ...
 * @class
 */
class DeleteTranscodeTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转码模板唯一标识。
 ...
 * @class
 */
class PornAsrReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音鉴黄任务开关，可选值：
 ...
 * @class
 */
class MediaAnimatedGraphicsInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频转动图结果信息
 ...
 * @class
 */
class DescribeSnapshotByTimeOffsetTemplatesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AiRecognitionTaskAsrFullTextResultInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音全文识别模板 ID。
 ...
 * @class
 */
class MediaMiniProgramReviewInfoItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class TaskStatData extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务类型。
 ...
 * @class
 */
class OcrFullTextConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本全文识别任务开关，可选值：
 ...
 * @class
 */
class ProcessMediaByProcedureRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 媒体文件 ID。
 ...
 * @class
 */
class MediaProcessTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频转码任务列表。
 ...
 * @class
 */
class MediaProcessTaskAnimatedGraphicResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class ProcessMediaResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务 ID
 ...
 * @class
 */
class CreateWordSamplesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class ClassificationConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能分类任务开关，可选值：
 ...
 * @class
 */
class DeleteAdaptiveDynamicStreamingTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class CreateWordSamplesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * <b>关键词应用场景，可选值：</b>
 ...
 * @class
 */
class PoliticalAsrReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音鉴政任务开关，可选值：
 ...
 * @class
 */
class WechatMiniProgramPublishTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AiSampleFaceOperation extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class SvgWatermarkInputForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 水印的宽度，支持 px，%，W%，H%，S%，L% 六种格式：
 ...
 * @class
 */
class AiReviewTaskTerrorismOcrResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class AiRecognitionTaskOcrWordsResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class PornAsrReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音鉴黄任务开关，可选值：
 ...
 * @class
 */
class AiRecognitionTaskSegmentResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class ProhibitedAsrReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音违禁任务开关，可选值：
 ...
 * @class
 */
class ModifyAnimatedGraphicsTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class ModifyAIAnalysisTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class LiveRealTimeClipRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DeleteAdaptiveDynamicStreamingTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 自适应转码模板唯一标识。
 ...
 * @class
 */
class AiRecognitionTaskOcrFullTextSegmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 识别片段起始的偏移时间，单位：秒。
 ...
 * @class
 */
class EditMediaOutputConfig extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AiReviewPornAsrTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * Asr 文字涉黄评分，分值为0到100。
 ...
 * @class
 */
class SimpleHlsClipResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 裁剪后的视频地址。
 ...
 * @class
 */
class DeleteAIAnalysisTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频内容分析模板唯一标识。
 ...
 * @class
 */
class EditMediaRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ConcatFileInfo2017 extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 错误码
 ...
 * @class
 */
class MediaProcessTaskImageSpriteResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class DescribeMediaInfosResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 媒体文件信息列表。
 ...
 * @class
 */
class DeleteProcedureTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class DescribeAdaptiveDynamicStreamingTemplatesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合过滤条件的记录总数。
 ...
 * @class
 */
class MediaMiniProgramReviewInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 审核信息列表。
 ...
 * @class
 */
class ForbidMediaDistributionResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 不存在的文件 ID 列表。
 ...
 * @class
 */
class DescribeAdaptiveDynamicStreamingTemplatesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ImageWatermarkInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ObjectConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 物体识别任务开关，可选值：
 ...
 * @class
 */
class AsrFullTextConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音全文识别任务开关，可选值：
 ...
 * @class
 */
class AiRecognitionTaskHeadTailResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class TranscodeTask2017 extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转码任务 ID。
 ...
 * @class
 */
class CreatePersonSampleResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人物信息。
 ...
 * @class
 */
class CreateContentReviewTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 内容审核模板唯一标识。
 ...
 * @class
 */
class HighlightsConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能精彩片段任务开关，可选值：
 ...
 * @class
 */
class DescribeProcedureTemplatesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ProhibitedConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音违禁控制参数。
 ...
 * @class
 */
class TagConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能标签任务开关，可选值：
 ...
 * @class
 */
class DeleteWordSamplesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 关键词，数组长度限制：100 个词。
 ...
 * @class
 */
class EmptyTrackItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 持续时间，单位为秒。
 ...
 * @class
 */
class StickerTrackItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class VideoTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频流的编码格式，可选值：
 ...
 * @class
 */
class PoliticalOcrReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本鉴政任务开关，可选值：
 ...
 * @class
 */
class PornOcrReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本鉴黄任务开关，可选值：
 ...
 * @class
 */
class AiReviewTaskPornOcrResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class ModifyContentReviewTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class DescribeWatermarkTemplatesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class CoverBySnapshotTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 指定时间点截图模板 ID。
 ...
 * @class
 */
class SegmentConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频拆条识别任务开关，可选值：
 ...
 * @class
 */
class UserDefineConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 用户自定义人物审核控制参数。
 ...
 * @class
 */
class AiRecognitionTaskSegmentSegmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AiReviewPornOcrTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 鉴黄模板 ID。
 ...
 * @class
 */
class OcrWordsConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本关键词识别任务开关，可选值：
 ...
 * @class
 */
class CreateSuperPlayerConfigResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class AiAnalysisTaskFrameTagOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频按帧标签列表。
 ...
 * @class
 */
class ModifyAdaptiveDynamicStreamingTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 自适应转码模板唯一标识。
 ...
 * @class
 */
class MediaAnimatedGraphicsItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转动图的文件地址。
 ...
 * @class
 */
class DescribeCDNUsageDataResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 时间粒度，单位：分钟。
 ...
 * @class
 */
class ModifyWordSampleRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 关键词，长度限制：128 个字符。
 ...
 * @class
 */
class AiRecognitionTaskFaceSegmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 识别片段起始的偏移时间，单位：秒。
 ...
 * @class
 */
class DeleteMediaResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class ModifySnapshotByTimeOffsetTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class AiRecognitionTaskObjectResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class AiAnalysisTaskTagResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class SearchMediaResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合搜索条件的记录总数。
 ...
 * @class
 */
class AiAnalysisTaskTagOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频智能标签列表。
 ...
 * @class
 */
class AiAnalysisTaskHighlightOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频智能精彩片段列表。
 ...
 * @class
 */
class ProcessMediaRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ModifyMediaInfoResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 新的视频封面 URL。
 ...
 * @class
 */
class AiRecognitionTaskOcrFullTextResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class MediaProcessTaskSnapshotByTimeOffsetResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class AiRecognitionTaskAsrWordsResultOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音关键词识别结果集。
 ...
 * @class
 */
class ModifyAdaptiveDynamicStreamingTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class MediaProcessTaskTranscodeResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class AiRecognitionTaskSegmentResultOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频拆条片段列表。
 ...
 * @class
 */
class ImageSpriteTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 雪碧图模板 ID。
 ...
 * @class
 */
class ObjectConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 物体识别任务开关，可选值：
 ...
 * @class
 */
class DeleteMediaRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 媒体文件的唯一标识。
 ...
 * @class
 */
class CreateSuperPlayerConfigRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ImageWatermarkTemplate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 水印图片地址。
 ...
 * @class
 */
class ModifySubAppIdInfoResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class AsrWordsConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音关键词识别任务开关，可选值：
 ...
 * @class
 */
class ModifySubAppIdStatusResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class SimpleHlsClipRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class MediaDeleteItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AiSamplePerson extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人物 ID。
 ...
 * @class
 */
class MediaAdaptiveDynamicStreamingInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转自适应码流信息数组。
 ...
 * @class
 */
class DescribeSuperPlayerConfigsResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合过滤条件的记录总数。
 ...
 * @class
 */
class AsrWordsConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音关键词识别任务开关，可选值：
 ...
 * @class
 */
class DescribeStorageDataRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 点播[子应用](/document/product/266/14574) ID。如果要访问子应用中的资源，则将该字段填写为子应用 ID；否则无需填写该字段。
 ...
 * @class
 */
class DeleteImageSpriteTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class DescribeContentReviewTemplatesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合过滤条件的记录总数。
 ...
 * @class
 */
class TEHDConfig extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 极速高清类型，可选值：
 ...
 * @class
 */
class AnimatedGraphicsTemplate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转动图模板唯一标识。
 ...
 * @class
 */
class TerrorismOcrReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本鉴恐任务开关，可选值：
 ...
 * @class
 */
class UserDefineAsrTextReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 用户自定语音审核任务开关，可选值：
 ...
 * @class
 */
class AiRecognitionTaskHeadTailResultOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 片头识别置信度。取值：0~100。
 ...
 * @class
 */
class ModifyImageSpriteTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class MediaProcessTaskCoverBySnapshotResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class CreateWatermarkTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 水印类型，可选值：
 ...
 * @class
 */
class TerrorismConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面鉴恐任务控制参数。
 ...
 * @class
 */
class WechatMiniProgramPublishTask extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务 ID。
 ...
 * @class
 */
class ComposeMediaTask extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务 ID。
 ...
 * @class
 */
class HeadTailConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频片头片尾识别任务开关，可选值：
 ...
 * @class
 */
class TranscodePlayInfo2017 extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 播放地址。
 ...
 * @class
 */
class ComposeMediaTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AnimatedGraphicTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频转动图模板 ID
 ...
 * @class
 */
class MosaicInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 原点位置，目前仅支持：
 ...
 * @class
 */
class AIAnalysisTemplateItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能分析模板唯一标识。
 ...
 * @class
 */
class AiRecognitionTaskObjectResultItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 识别的物体名称。
 ...
 * @class
 */
class MediaSnapshotByTimeOffsetInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DescribeImageSpriteTemplatesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class MediaKeyFrameDescItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 打点的视频偏移时间，单位：秒。
 ...
 * @class
 */
class AiSampleTagOperation extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class PlayerConfig extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 播放器配置名字。
 ...
 * @class
 */
class ConfirmEventsRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class CreateAIRecognitionTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频内容识别模板唯一标识。
 ...
 * @class
 */
class ModifySubAppIdStatusRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 子应用 ID。
 ...
 * @class
 */
class CreateSubAppIdResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 新创建的子应用 ID。
 ...
 * @class
 */
class CreateWatermarkTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 水印模板唯一标识。
 ...
 * @class
 */
class AiReviewTerrorismTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频暴恐评分，分值为0到100。
 ...
 * @class
 */
class ResetProcedureTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class ProhibitedConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音违禁控制参数。
 ...
 * @class
 */
class DrmStreamingsInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AiReviewTerrorismOcrTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * Ocr 文字涉恐评分，分值为0到100。
 ...
 * @class
 */
class AiAnalysisResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务的类型，可以取的值有：
 ...
 * @class
 */
class DescribeAIAnalysisTemplatesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class MediaTranscodeInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ResolutionNameInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频短边长度，单位：像素。
 ...
 * @class
 */
class AiRecognitionTaskOcrWordsResultItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本关键词。
 ...
 * @class
 */
class ParseStreamingManifestRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 待解析的索引文件内容。
 ...
 * @class
 */
class DeleteSampleSnapshotTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class AiAnalysisTaskTagInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频智能标签模板 ID。
 ...
 * @class
 */
class MediaTrackItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 片段类型。取值有：
 ...
 * @class
 */
class DescribeStorageDetailsResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 存储统计数据，每分钟/小时/天一条数据。
 ...
 * @class
 */
class PullEventsResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 事件列表。
 ...
 * @class
 */
class AiRecognitionTaskObjectResultInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 物体识别模板 ID。
 ...
 * @class
 */
class OutputVideoStream extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频流的编码格式，可选值：
 ...
 * @class
 */
class ProcedureTemplate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务流名字。
 ...
 * @class
 */
class AiReviewTaskTerrorismResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class ProcessMediaByUrlResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务 ID
 ...
 * @class
 */
class MediaContentReviewAsrTextSegmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 嫌疑片段起始的偏移时间，单位：秒。
 ...
 * @class
 */
class MediaContentReviewPoliticalSegmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 嫌疑片段起始的偏移时间，单位：秒。
 ...
 * @class
 */
class DeletePersonSampleResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class CreateSnapshotByTimeOffsetTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 时间点截图模板唯一标识。
 ...
 * @class
 */
class ModifyContentReviewTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 内容审核模板唯一标识。
 ...
 * @class
 */
class ImageWatermarkInputForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 水印图片 [Base64](https://tools.ietf.org/html/rfc4648) 编码后的字符串。支持 jpeg、png 图片格式。
 ...
 * @class
 */
class AiContentReviewTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频内容审核模板 ID。
 ...
 * @class
 */
class CreateAdaptiveDynamicStreamingTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 自适应转码模板唯一标识。
 ...
 * @class
 */
class ClassificationConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能分类任务开关，可选值：
 ...
 * @class
 */
class AiAnalysisTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频内容分析模板 ID。
 ...
 * @class
 */
class ImageSpriteTemplate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 雪碧图模板唯一标识。
 ...
 * @class
 */
class AiRecognitionTaskOcrFullTextSegmentTextItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 识别片段置信度。取值：0~100。
 ...
 * @class
 */
class SnapshotByTimeOffsetTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 指定时间点截图模板 ID。
 ...
 * @class
 */
class SegmentConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频拆条识别任务开关，可选值：
 ...
 * @class
 */
class TaskStatDataItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ParseStreamingManifestResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 分片文件列表。
 ...
 * @class
 */
class AiReviewPornOcrTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * Ocr 文字涉黄评分，分值为0到100。
 ...
 * @class
 */
class ApplyUploadRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class CreateSampleSnapshotTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 采样截图模板唯一标识。
 ...
 * @class
 */
class AiAnalysisTaskHighlightInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频智能精彩片段模板 ID。
 ...
 * @class
 */
class DeleteContentReviewTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class MediaBasicInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 媒体文件名称。
 ...
 * @class
 */
class AiReviewPoliticalAsrTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 鉴政模板 ID。
 ...
 * @class
 */
class PullUploadRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ClipTask2017 extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频剪辑任务 ID。
 ...
 * @class
 */
class TranscodeTemplate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转码模板唯一标识。
 ...
 * @class
 */
class DescribeCDNUsageDataRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class PornOcrReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本鉴黄任务开关，可选值：
 ...
 * @class
 */
class AiReviewTaskPoliticalAsrResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class AiRecognitionTaskAsrWordsSegmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 识别片段起始的偏移时间，单位：秒。
 ...
 * @class
 */
class DescribeReviewDetailsRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 起始日期。使用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
 ...
 * @class
 */
class PornConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面鉴黄控制参数。
 ...
 * @class
 */
class AiReviewProhibitedAsrTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 鉴违禁模板 ID。
 ...
 * @class
 */
class MediaContentReviewSegmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 嫌疑片段起始的偏移时间，单位：秒。
 ...
 * @class
 */
class TerrorismOcrReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本鉴恐任务开关，可选值：
 ...
 * @class
 */
class AiReviewTaskPornResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class AiRecognitionTaskObjectResultOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能物体识别结果集。
 ...
 * @class
 */
class AiReviewProhibitedAsrTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DeleteSuperPlayerConfigResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class DescribeSampleSnapshotTemplatesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class CoverConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能封面任务开关，可选值：
 ...
 * @class
 */
class AiAnalysisTaskClassificationResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class PoliticalImgReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面鉴政任务开关，可选值：
 ...
 * @class
 */
class UserDefineOcrTextReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 用户自定文本审核任务开关，可选值：
 ...
 * @class
 */
class AdaptiveStreamTemplate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频参数信息。
 ...
 * @class
 */
class TranscodeTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频转码模板 ID。
 ...
 * @class
 */
class ModifyAIRecognitionTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频内容识别模板唯一标识。
 ...
 * @class
 */
class WechatPublishTask extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务 ID。
 ...
 * @class
 */
class ClipFileInfo2017 extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 错误码
 ...
 * @class
 */
class StatDataItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class MediaSourceData extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 媒体文件的来源类别：
 ...
 * @class
 */
class ProhibitedAsrReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音违禁任务开关，可选值：
 ...
 * @class
 */
class PushUrlCacheRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class CreateAIAnalysisTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频内容分析模板唯一标识。
 ...
 * @class
 */
class HeadTailConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频片头片尾识别任务开关，可选值：
 ...
 * @class
 */
class EventContent extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class HighlightsConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能精彩片段任务开关，可选值：
 ...
 * @class
 */
class UserDefineConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 用户自定义人物审核控制参数。
 ...
 * @class
 */
class AiReviewPoliticalAsrTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class OutputAudioStream extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 音频流的编码格式，可选值：
 ...
 * @class
 */
class ModifyClassRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 分类 ID
 ...
 * @class
 */
class SpecificationDataItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务规格。
 ...
 * @class
 */
class TEHDConfigForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 极速高清类型，可选值：
 ...
 * @class
 */
class ComposeMediaTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文件类型，例如 mp4、mp3 等。
 ...
 * @class
 */
class DescribeMediaInfosRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ModifyPersonSampleRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人物 ID。
 ...
 * @class
 */
class AsrFullTextConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音全文识别任务开关，可选值：
 ...
 * @class
 */
class CreateAIRecognitionTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频内容识别模板名称，长度限制：64 个字符。
 ...
 * @class
 */
class MediaAiAnalysisClassificationItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能分类的类别名称。
 ...
 * @class
 */
class AiAnalysisTaskFrameTagResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class AiReviewPornTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频鉴黄评分，分值为0到100。
 ...
 * @class
 */
class AiRecognitionTaskAsrFullTextResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class ModifyAIRecognitionTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class PoliticalImgReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面鉴政任务开关，可选值：
 ...
 * @class
 */
class PoliticalConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面鉴政控制参数。
 ...
 * @class
 */
class ModifyAnimatedGraphicsTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转动图模板唯一标识。
 ...
 * @class
 */
class AiRecognitionTaskOcrWordsSegmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 识别片段起始的偏移时间，单位：秒。
 ...
 * @class
 */
class MediaProcessTaskResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务的类型，可以取的值有：
 ...
 * @class
 */
class DeleteWordSamplesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class DeleteProcedureTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务流名字。
 ...
 * @class
 */
class WatermarkInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 水印模板 ID。
 ...
 * @class
 */
class AiSampleWordInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 关键词，长度限制：20 个字符。
 ...
 * @class
 */
class AdaptiveDynamicStreamingInfoItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转自适应码流规格。
 ...
 * @class
 */
class ProhibitedOcrReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本违禁任务开关，可选值：
 ...
 * @class
 */
class ModifyTranscodeTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class MediaSampleSnapshotInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DescribeSubAppIdsResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 子应用信息集合。
 ...
 * @class
 */
class MediaInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class VideoTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频流的编码格式，可选值：
 ...
 * @class
 */
class CreateContentReviewTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 审核结果是否进入审核墙（对审核结果进行人工复核）的开关。
 ...
 * @class
 */
class DescribeContentReviewTemplatesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AdaptiveDynamicStreamingTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转自适应码流模板 ID。
 ...
 * @class
 */
class DescribeImageSpriteTemplatesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合过滤条件的记录总数。
 ...
 * @class
 */
class AiAnalysisTaskFrameTagInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频智能按帧标签模板 ID。
 ...
 * @class
 */
class MediaAiAnalysisFrameTagSegmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 按帧标签起始的偏移时间。
 ...
 * @class
 */
class AiRecognitionTaskAsrWordsResultItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音关键词。
 ...
 * @class
 */
class MediaAiAnalysisTagItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 标签名称。
 ...
 * @class
 */
class MediaKeyFrameDescInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频打点信息数组。
 ...
 * @class
 */
class DeleteImageSpriteTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 雪碧图模板唯一标识。
 ...
 * @class
 */
class AiSampleFailFaceInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class UserDefineFaceReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 用户自定义人物审核任务开关，可选值：
 ...
 * @class
 */
class CreateProcedureTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class DescribeMediaProcessUsageDataResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DescribeSuperPlayerConfigsRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AiRecognitionTaskOcrFullTextResultInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本全文识别模板 ID。
 ...
 * @class
 */
class AiRecognitionTaskSegmentResultInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频拆条模板 ID。
 ...
 * @class
 */
class DescribeSubAppIdsRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
    }
    /**
 ...
 * @class
 */
class AiRecognitionTaskFaceResultInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人脸识别模板 ID。
 ...
 * @class
 */
class AiReviewPoliticalTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频涉政评分，分值为0到100。
 ...
 * @class
 */
class AiReviewTaskPoliticalResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class ModifySnapshotByTimeOffsetTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 指定时间点截图模板唯一标识。
 ...
 * @class
 */
class ProcedureTask extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频处理任务 ID。
 ...
 * @class
 */
class ModifySuperPlayerConfigRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 播放器配置名称。
 ...
 * @class
 */
class TaskSimpleInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务 ID。
 ...
 * @class
 */
class DescribeSnapshotByTimeOffsetTemplatesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合过滤条件的记录总数。
 ...
 * @class
 */
class MediaVideoStreamItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频流的码率，单位：bps。
 ...
 * @class
 */
class SnapshotByTimeOffsetTemplate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 指定时间点截图模板唯一标识。
 ...
 * @class
 */
class DeleteSnapshotByTimeOffsetTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class ProhibitedOcrReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本违禁任务开关，可选值：
 ...
 * @class
 */
class DescribeReviewDetailsResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 发起内容审核次数。
 ...
 * @class
 */
class CreateTranscodeTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转码模板唯一标识。
 ...
 * @class
 */
class AiRecognitionTaskAsrWordsResultInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音关键词识别模板 ID。
 ...
 * @class
 */
class SnapshotByTimeOffset2017 extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 错误码
 ...
 * @class
 */
class CreateAIAnalysisTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AiReviewTerrorismTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 鉴恐模板 ID。
 ...
 * @class
 */
class MediaAudioStreamItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 音频流的码率，单位：bps。
 ...
 * @class
 */
class SubAppIdInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 子应用 ID。
 ...
 * @class
 */
class DescribeAllClassResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 分类信息集合
 ...
 * @class
 */
class ModifyImageSpriteTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 雪碧图模板唯一标识。
 ...
 * @class
 */
class AiReviewProhibitedOcrTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 鉴违禁模板 ID。
 ...
 * @class
 */
class DeleteWatermarkTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 水印模板唯一标识。
 ...
 * @class
 */
class EditMediaStreamInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 录制的流 ID
 ...
 * @class
 */
class DescribeWordSamplesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * <b>关键词应用场景过滤条件，可选值：</b>
 ...
 * @class
 */
class LiveRealTimeClipResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 剪辑后的视频播放 URL。
 ...
 * @class
 */
class ModifyAIAnalysisTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频内容分析模板唯一标识。
 ...
 * @class
 */
class CommitUploadResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 媒体文件的唯一标识。
 ...
 * @class
 */
class DescribeSampleSnapshotTemplatesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合过滤条件的记录总数。
 ...
 * @class
 */
class ModifyWordSampleResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class AiContentReviewResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务的类型，可以取的值有：
 ...
 * @class
 */
class TerrorismImgReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面鉴恐任务开关，可选值：
 ...
 * @class
 */
class DrmStreamingsInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 保护类型为 SimpleAES 的转自适应码流模板 ID。
 ...
 * @class
 */
class DescribeTranscodeTemplatesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class PoliticalConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面鉴政控制参数。
 ...
 * @class
 */
class DescribeWatermarkTemplatesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合过滤条件的记录总数。
 ...
 * @class
 */
class WeChatMiniProgramPublishResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务 ID。
 ...
 * @class
 */
class ImageTransform extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 类型，取值有：
 ...
 * @class
 */
class CreateAnimatedGraphicsTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 帧率，取值范围：[1, 30]，单位：Hz。
 ...
 * @class
 */
class FrameTagConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能按帧标签任务开关，可选值：
 ...
 * @class
 */
class ExecuteFunctionRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 调用后端接口名称。
 ...
 * @class
 */
class ConfirmEventsResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class ModifyPersonSampleResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人物信息。
 ...
 * @class
 */
class VideoTrackItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DeleteTranscodeTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class MediaTranscodeItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转码后的视频文件地址。
 ...
 * @class
 */
class DescribePersonSamplesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合条件的记录总数。
 ...
 * @class
 */
class PornConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面鉴黄控制参数。
 ...
 * @class
 */
class AiRecognitionTaskObjectSeqmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 识别片段起始的偏移时间，单位：秒。
 ...
 * @class
 */
class PullEventsRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 保留字段，特殊用途时使用。
 ...
 * @class
 */
class FaceConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人脸识别任务开关，可选值：
 ...
 * @class
 */
class DescribeAIAnalysisTemplatesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合过滤条件的记录总数。
 ...
 * @class
 */
class CreateSnapshotByTimeOffsetTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 指定时间点截图模板名称，长度限制：64 个字符。
 ...
 * @class
 */
class AiRecognitionTaskAsrWordsResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class CreateSubAppIdRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 子应用名称，长度限制：40个字符。
 ...
 * @class
 */
class DescribeProcedureTemplatesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合过滤条件的记录总数。
 ...
 * @class
 */
class SearchMediaRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class CreateSampleSnapshotTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 采样截图类型，取值：
 ...
 * @class
 */
class MediaContentReviewOcrTextSegmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 嫌疑片段起始的偏移时间，单位：秒。
 ...
 * @class
 */
class AudioVolumeParam extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 是否静音，取值范围0或1。
 ...
 * @class
 */
class AiReviewTaskPornAsrResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务状态，有 PROCESSING，SUCCESS 和 FAIL 三种。
 ...
 * @class
 */
class ModifyClassResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class EditMediaFileInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频的 ID。
 ...
 * @class
 */
class ProcessMediaByProcedureResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务 ID。
 ...
 * @class
 */
class PullUploadResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class FaceConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人脸识别任务开关，可选值：
 ...
 * @class
 */
class AiRecognitionTaskFaceResultOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能人脸识别结果集。
 ...
 * @class
 */
class PornImgReviewTemplateInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面鉴黄任务开关，可选值：
 ...
 * @class
 */
class EditMediaTask extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务 ID。
 ...
 * @class
 */
class PornImgReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面鉴黄任务开关，可选值：
 ...
 * @class
 */
class AiReviewPoliticalOcrTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class OcrFullTextConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文本全文识别任务开关，可选值：
 ...
 * @class
 */
class CommitUploadRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class WatermarkCycleConfigForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class SnapshotByTimeOffsetTask2017 extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 截图任务 ID。
 ...
 * @class
 */
class MediaClassInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 分类 ID
 ...
 * @class
 */
class DescribeTranscodeTemplatesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合过滤条件的记录总数。
 ...
 * @class
 */
class DeleteAnimatedGraphicsTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转动图模板唯一标识。
 ...
 * @class
 */
class DeleteSnapshotByTimeOffsetTemplateRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 指定时间点截图模板唯一标识。
 ...
 * @class
 */
class DescribeAnimatedGraphicsTemplatesResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 符合过滤条件的记录总数。
 ...
 * @class
 */
class MediaAiAnalysisFrameTagItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 按帧标签名称。
 ...
 * @class
 */
class SampleSnapshotTaskInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 采样截图模板 ID。
 ...
 * @class
 */
class TerrorismConfigureInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 画面鉴恐任务控制参数。
 ...
 * @class
 */
class PoliticalAsrReviewTemplateInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 语音鉴政任务开关，可选值：
 ...
 * @class
 */
class CreateAnimatedGraphicsTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转动图模板唯一标识。
 ...
 * @class
 */
class SampleSnapshotTemplate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 采样截图模板唯一标识。
 ...
 * @class
 */
class MediaImageSpriteItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DescribePersonSamplesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 拉取的人物类型，可选值：
 ...
 * @class
 */
class AiRecognitionTaskFaceResultItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人物唯一标识 ID。
 ...
 * @class
 */
class AiAnalysisTaskCoverInput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 视频智能封面模板 ID。
 ...
 * @class
 */
class DescribeStorageDetailsRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class MediaTrack extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 轨道类型，取值有：
 ...
 * @class
 */
class MediaOutputInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class EditMediaTaskOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文件类型，例如 mp4、flv 等。
 ...
 * @class
 */
class HighlightSegmentItem extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 置信度。
 ...
 * @class
 */
class DeleteWatermarkTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class ComposeMediaOutput extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 文件名称，最长 64 个字符。
 ...
 * @class
 */
class PullUploadTask extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 转拉上传任务 ID。
 ...
 * @class
 */
class FrameTagConfigureInfoForUpdate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 智能按帧标签任务开关，可选值：
 ...
 * @class
 */
class CreateImageSpriteTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 雪碧图模板唯一标识。
 ...
 * @class
 */
class DescribeAIRecognitionTemplatesRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class ModifyWatermarkTemplateResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class AiRecognitionResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 任务的类型，取值范围：
