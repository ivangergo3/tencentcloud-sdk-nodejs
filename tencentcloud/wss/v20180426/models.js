 ...
 * @class
 */
class DeleteCertRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DeleteCertResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class DescribeCertListResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 总数量。
 ...
 * @class
 */
class SSLCertificate extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 所属账户
 ...
 * @class
 */
class DescribeCertListRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 模块名称，应填 ssl。
 ...
 * @class
 */
class SSLProjectInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 项目ID
