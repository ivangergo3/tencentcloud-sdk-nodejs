 ...
 * @class
 */
class QueryRegisterProtectionResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class QueryRegisterProtectionRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 注册来源的外网 IP。
...
如果是微信公众号或第三方登录，则为授权的 access_token（注意：不是普通 access_token，具体看 微信官方文档）。
    ...
    deserialize(params) {
        ...
        this.RegisterSource = 'RegisterSource' in params ? params.RegisterSource : null;
        ...
        this.RegisterSpend = 'RegisterSpend' in params ? params.RegisterSpend : null;
