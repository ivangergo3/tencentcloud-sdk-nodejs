 ...
 * @class
 */
class SegmentPortraitPicResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DetectBodyJointsResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class UpperBodyClothSleeve extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class BodyAttributeInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人体年龄信息。
 ...
 * @class
 */
class SegmentationOptions extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 分割选项-背景
 ...
 * @class
 */
class ModifyPersonInfoResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 ...
 * @class
 */
class Trace extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人体轨迹图片 Base64 数组。
 ...
 * @class
 */
class ModifyPersonInfoRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人员ID。
 ...
 * @class
 */
class Gender extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class SegmentCustomizedPortraitPicRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 此参数为分割选项，请根据需要选择自己所想从图片中分割的部分。注意所有选项均为非必选，如未选择则值默认为false, 但是必须要保证多于一个选项的描述为true。
 ...
 * @class
 */
class LowerBodyCloth extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 下衣颜色信息。
 ...
 * @class
 */
class UpperBodyClothTexture extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class TraceInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人体轨迹ID。
 ...
 * @class
 */
class BodyRect extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人体框左上角横坐标。
 ...
 * @class
 */
class DetectBodyRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人体图片 Base64 数据。
 ...
 * @class
 */
class Age extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class SearchTraceRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 希望搜索的人体库ID。
 ...
 * @class
 */
class KeyPointInfo extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DetectBodyResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 图中检测出来的人体框。
 ...
 * @class
 */
class Bag extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class SegmentCustomizedPortraitPicResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class DetectBodyJointsRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 图片 base64 数据，base64 编码后大小不可超过5M。
 ...
 * @class
 */
class SegmentPortraitPicRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 图片 base64 数据，base64 编码后大小不可超过5M。
 ...
 * @class
 */
class UpperBodyClothColor extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class BodyDetectResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 检测出的人体置信度。
 ...
 * @class
 */
class Orientation extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class BodyJointsResult extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 图中检测出来的人体框。
 ...
 * @class
 */
class UpperBodyCloth extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 上衣纹理信息。
 ...
 * @class
 */
class LowerBodyClothLength extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class SearchTraceResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 识别出的最相似候选人。
 ...
 * @class
 */
class CreateTraceResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人员轨迹唯一标识。
 ...
 * @class
 */
class BoundRect extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人体框左上角横坐标。
 ...
 * @class
 */
class LowerBodyClothColor extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class LowerBodyClothType extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class CreateTraceRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 人员ID。
 ...
 * @class
 */
class AttributesOptions extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 返回年龄信息
