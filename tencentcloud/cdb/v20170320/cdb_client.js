...
const ModifyAuditConfigRequest = models_1.Models.ModifyAuditConfigRequest;
const CreateDBInstanceRequest = models_1.Models.CreateDBInstanceRequest;
const TaskDetail = models_1.Models.TaskDetail;
const DeviceDiskInfo = models_1.Models.DeviceDiskInfo;
const DescribeAccountPrivilegesResponse = models_1.Models.DescribeAccountPrivilegesResponse;
const CreateDBImportJobRequest = models_1.Models.CreateDBImportJobRequest;
const DescribeDatabasesRequest = models_1.Models.DescribeDatabasesRequest;
const DescribeBackupConfigRequest = models_1.Models.DescribeBackupConfigRequest;
const DescribeRoMinScaleResponse = models_1.Models.DescribeRoMinScaleResponse;
const CreateAuditRuleResponse = models_1.Models.CreateAuditRuleResponse;
const StopDBImportJobRequest = models_1.Models.StopDBImportJobRequest;
const RoWeightValue = models_1.Models.RoWeightValue;
const DescribeSlowLogDataResponse = models_1.Models.DescribeSlowLogDataResponse;
const SellType = models_1.Models.SellType;
const DescribeDBInstanceInfoResponse = models_1.Models.DescribeDBInstanceInfoResponse;
const DescribeErrorLogDataRequest = models_1.Models.DescribeErrorLogDataRequest;
const Parameter = models_1.Models.Parameter;
const DescribeAuditLogFilesResponse = models_1.Models.DescribeAuditLogFilesResponse;
const DescribeDBInstanceRebootTimeRequest = models_1.Models.DescribeDBInstanceRebootTimeRequest;
...
const CreateAccountsResponse = models_1.Models.CreateAccountsResponse;
const RegionSellConf = models_1.Models.RegionSellConf;
const InstanceRollbackRangeTime = models_1.Models.InstanceRollbackRangeTime;
const SqlFileInfo = models_1.Models.SqlFileInfo;
const CreateDeployGroupResponse = models_1.Models.CreateDeployGroupResponse;
const DescribeTablesResponse = models_1.Models.DescribeTablesResponse;
const SellConfig = models_1.Models.SellConfig;
const DescribeDBSecurityGroupsResponse = models_1.Models.DescribeDBSecurityGroupsResponse;
const MasterInfo = models_1.Models.MasterInfo;
const DeleteAuditRuleRequest = models_1.Models.DeleteAuditRuleRequest;
const DeleteParamTemplateResponse = models_1.Models.DeleteParamTemplateResponse;
const ParamInfo = models_1.Models.ParamInfo;
const DescribeRoMinScaleRequest = models_1.Models.DescribeRoMinScaleRequest;
const DescribeDefaultParamsRequest = models_1.Models.DescribeDefaultParamsRequest;
const DBSwitchInfo = models_1.Models.DBSwitchInfo;
const ModifyNameOrDescByDpIdResponse = models_1.Models.ModifyNameOrDescByDpIdResponse;
const StopDBImportJobResponse = models_1.Models.StopDBImportJobResponse;
const DescribeDBPriceResponse = models_1.Models.DescribeDBPriceResponse;
const DescribeTasksResponse = models_1.Models.DescribeTasksResponse;
const ReleaseIsolatedDBInstancesResponse = models_1.Models.ReleaseIsolatedDBInstancesResponse;
const AuditLogFilter = models_1.Models.AuditLogFilter;
const DescribeParamTemplatesRequest = models_1.Models.DescribeParamTemplatesRequest;
const DescribeRollbackRangeTimeRequest = models_1.Models.DescribeRollbackRangeTimeRequest;
const DescribeBackupOverviewRequest = models_1.Models.DescribeBackupOverviewRequest;
const DescribeBackupsRequest = models_1.Models.DescribeBackupsRequest;
const DescribeAuditPoliciesResponse = models_1.Models.DescribeAuditPoliciesResponse;
const DescribeInstanceParamRecordsResponse = models_1.Models.DescribeInstanceParamRecordsResponse;
const DescribeDBInstanceGTIDResponse = models_1.Models.DescribeDBInstanceGTIDResponse;
const OpenDBInstanceGTIDResponse = models_1.Models.OpenDBInstanceGTIDResponse;
const DescribeDBZoneConfigRequest = models_1.Models.DescribeDBZoneConfigRequest;
const DescribeDBInstanceRebootTimeResponse = models_1.Models.DescribeDBInstanceRebootTimeResponse;
const DeleteParamTemplateRequest = models_1.Models.DeleteParamTemplateRequest;
const DrInfo = models_1.Models.DrInfo;
const RoGroup = models_1.Models.RoGroup;
const DescribeDataBackupOverviewResponse = models_1.Models.DescribeDataBackupOverviewResponse;
const ParameterDetail = models_1.Models.ParameterDetail;
const DeleteAuditPolicyRequest = models_1.Models.DeleteAuditPolicyRequest;
const BackupSummaryItem = models_1.Models.BackupSummaryItem;
const SwitchForUpgradeRequest = models_1.Models.SwitchForUpgradeRequest;
const ModifyInstanceTagResponse = models_1.Models.ModifyInstanceTagResponse;
const CreateParamTemplateResponse = models_1.Models.CreateParamTemplateResponse;
const CreateDBInstanceHourResponse = models_1.Models.CreateDBInstanceHourResponse;
const ReleaseIsolatedDBInstancesRequest = models_1.Models.ReleaseIsolatedDBInstancesRequest;
const BinlogInfo = models_1.Models.BinlogInfo;
...
const SlaveConfig = models_1.Models.SlaveConfig;
const DescribeErrorLogDataResponse = models_1.Models.DescribeErrorLogDataResponse;
const AddTimeWindowRequest = models_1.Models.AddTimeWindowRequest;
const ImportRecord = models_1.Models.ImportRecord;
const DeleteAuditLogFileResponse = models_1.Models.DeleteAuditLogFileResponse;
const DescribeRollbackTaskDetailResponse = models_1.Models.DescribeRollbackTaskDetailResponse;
const CreateAccountsRequest = models_1.Models.CreateAccountsRequest;
const CreateDBInstanceHourRequest = models_1.Models.CreateDBInstanceHourRequest;
const DescribeDeployGroupListRequest = models_1.Models.DescribeDeployGroupListRequest;
const RollbackInstancesInfo = models_1.Models.RollbackInstancesInfo;
const DescribeParamTemplateInfoRequest = models_1.Models.DescribeParamTemplateInfoRequest;
const BackupInfo = models_1.Models.BackupInfo;
const CloseWanServiceResponse = models_1.Models.CloseWanServiceResponse;
...
const ModifyDBInstanceVipVportResponse = models_1.Models.ModifyDBInstanceVipVportResponse;
const DescribeDBSwitchRecordsResponse = models_1.Models.DescribeDBSwitchRecordsResponse;
const TableName = models_1.Models.TableName;
const RenewDBInstanceRequest = models_1.Models.RenewDBInstanceRequest;
const RollbackTableName = models_1.Models.RollbackTableName;
const DeleteBackupResponse = models_1.Models.DeleteBackupResponse;
const ModifyInstanceParamRequest = models_1.Models.ModifyInstanceParamRequest;
...
const CreateAuditLogFileResponse = models_1.Models.CreateAuditLogFileResponse;
const DescribeBackupSummariesRequest = models_1.Models.DescribeBackupSummariesRequest;
const StartBatchRollbackResponse = models_1.Models.StartBatchRollbackResponse;
const DescribeRoGroupsRequest = models_1.Models.DescribeRoGroupsRequest;
const DescribeDBSwitchRecordsRequest = models_1.Models.DescribeDBSwitchRecordsRequest;
const ModifyBackupConfigResponse = models_1.Models.ModifyBackupConfigResponse;
const DescribeSupportedPrivilegesRequest = models_1.Models.DescribeSupportedPrivilegesRequest;
...
const ModifyInstanceTagRequest = models_1.Models.ModifyInstanceTagRequest;
const DescribeDBInstanceCharsetResponse = models_1.Models.DescribeDBInstanceCharsetResponse;
const DeleteAccountsResponse = models_1.Models.DeleteAccountsResponse;
const DescribeRoGroupsResponse = models_1.Models.DescribeRoGroupsResponse;
const CloseWanServiceRequest = models_1.Models.CloseWanServiceRequest;
const RestartDBInstancesResponse = models_1.Models.RestartDBInstancesResponse;
const CreateRoInstanceIpResponse = models_1.Models.CreateRoInstanceIpResponse;
const DescribeBackupDatabasesResponse = models_1.Models.DescribeBackupDatabasesResponse;
const DescribeBackupSummariesResponse = models_1.Models.DescribeBackupSummariesResponse;
const DescribeInstanceParamRecordsRequest = models_1.Models.DescribeInstanceParamRecordsRequest;
const ParamTemplateInfo = models_1.Models.ParamTemplateInfo;
const ModifyAutoRenewFlagResponse = models_1.Models.ModifyAutoRenewFlagResponse;
const DeleteTimeWindowResponse = models_1.Models.DeleteTimeWindowResponse;
const DescribeBinlogBackupOverviewRequest = models_1.Models.DescribeBinlogBackupOverviewRequest;
const RollbackTask = models_1.Models.RollbackTask;
const DescribeBackupsResponse = models_1.Models.DescribeBackupsResponse;
const CreateAuditPolicyRequest = models_1.Models.CreateAuditPolicyRequest;
const CreateRoInstanceIpRequest = models_1.Models.CreateRoInstanceIpRequest;
const ModifyInstanceParamResponse = models_1.Models.ModifyInstanceParamResponse;
const DescribeDBImportRecordsResponse = models_1.Models.DescribeDBImportRecordsResponse;
const CreateAuditPolicyResponse = models_1.Models.CreateAuditPolicyResponse;
const BackupItem = models_1.Models.BackupItem;
const DatabaseName = models_1.Models.DatabaseName;
const AuditFilter = models_1.Models.AuditFilter;
const DescribeBackupConfigResponse = models_1.Models.DescribeBackupConfigResponse;
const DeleteDeployGroupsResponse = models_1.Models.DeleteDeployGroupsResponse;
const ModifyDBInstanceSecurityGroupsRequest = models_1.Models.ModifyDBInstanceSecurityGroupsRequest;
const DescribeParamTemplatesResponse = models_1.Models.DescribeParamTemplatesResponse;
const DescribeBackupTablesResponse = models_1.Models.DescribeBackupTablesResponse;
const Outbound = models_1.Models.Outbound;
const SlaveInstanceInfo = models_1.Models.SlaveInstanceInfo;
const ModifyDBInstanceVipVportRequest = models_1.Models.ModifyDBInstanceVipVportRequest;
const ModifyParamTemplateResponse = models_1.Models.ModifyParamTemplateResponse;
...
const StartBatchRollbackRequest = models_1.Models.StartBatchRollbackRequest;
const SecurityGroup = models_1.Models.SecurityGroup;
const ZoneConf = models_1.Models.ZoneConf;
const BalanceRoGroupLoadResponse = models_1.Models.BalanceRoGroupLoadResponse;
const DeviceNetInfo = models_1.Models.DeviceNetInfo;
const SlaveInfo = models_1.Models.SlaveInfo;
const TagInfo = models_1.Models.TagInfo;
const RollbackTimeRange = models_1.Models.RollbackTimeRange;
const DescribeSupportedPrivilegesResponse = models_1.Models.DescribeSupportedPrivilegesResponse;
const OfflineIsolatedInstancesRequest = models_1.Models.OfflineIsolatedInstancesRequest;
...
const OpenDBInstanceGTIDRequest = models_1.Models.OpenDBInstanceGTIDRequest;
const UpgradeDBInstanceEngineVersionResponse = models_1.Models.UpgradeDBInstanceEngineVersionResponse;
const InquiryPriceUpgradeInstancesRequest = models_1.Models.InquiryPriceUpgradeInstancesRequest;
const ModifyAuditRuleResponse = models_1.Models.ModifyAuditRuleResponse;
const DescribeAsyncRequestInfoRequest = models_1.Models.DescribeAsyncRequestInfoRequest;
const VerifyRootAccountRequest = models_1.Models.VerifyRootAccountRequest;
const BalanceRoGroupLoadRequest = models_1.Models.BalanceRoGroupLoadRequest;
const DescribeAuditRulesRequest = models_1.Models.DescribeAuditRulesRequest;
const DescribeBackupOverviewResponse = models_1.Models.DescribeBackupOverviewResponse;
const ColumnPrivilege = models_1.Models.ColumnPrivilege;
const DescribeUploadedFilesRequest = models_1.Models.DescribeUploadedFilesRequest;
const ErrlogItem = models_1.Models.ErrlogItem;
const DescribeDeviceMonitorInfoRequest = models_1.Models.DescribeDeviceMonitorInfoRequest;
const DescribeDBPriceRequest = models_1.Models.DescribeDBPriceRequest;
const AssociateSecurityGroupsResponse = models_1.Models.AssociateSecurityGroupsResponse;
const TagsInfoOfInstance = models_1.Models.TagsInfoOfInstance;
const DescribeUploadedFilesResponse = models_1.Models.DescribeUploadedFilesResponse;
const CreateBackupResponse = models_1.Models.CreateBackupResponse;
const DescribeDBInstanceConfigResponse = models_1.Models.DescribeDBInstanceConfigResponse;
const DescribeDefaultParamsResponse = models_1.Models.DescribeDefaultParamsResponse;
const ModifyAccountPrivilegesResponse = models_1.Models.ModifyAccountPrivilegesResponse;
const DeviceCpuRateInfo = models_1.Models.DeviceCpuRateInfo;
const BackupConfig = models_1.Models.BackupConfig;
const ModifyAuditRuleRequest = models_1.Models.ModifyAuditRuleRequest;
const VerifyRootAccountResponse = models_1.Models.VerifyRootAccountResponse;
const DeviceCpuInfo = models_1.Models.DeviceCpuInfo;
const AuditPolicy = models_1.Models.AuditPolicy;
const DescribeDeployGroupListResponse = models_1.Models.DescribeDeployGroupListResponse;
const DescribeDBInstanceConfigRequest = models_1.Models.DescribeDBInstanceConfigRequest;
const DescribeBackupTablesRequest = models_1.Models.DescribeBackupTablesRequest;
const DescribeBinlogsResponse = models_1.Models.DescribeBinlogsResponse;
const OfflineIsolatedInstancesResponse = models_1.Models.OfflineIsolatedInstancesResponse;
const DatabasePrivilege = models_1.Models.DatabasePrivilege;
const RoGroupAttr = models_1.Models.RoGroupAttr;
const ModifyAuditConfigResponse = models_1.Models.ModifyAuditConfigResponse;
const RoVipInfo = models_1.Models.RoVipInfo;
...
const ModifyAccountPasswordRequest = models_1.Models.ModifyAccountPasswordRequest;
const DescribeAuditPoliciesRequest = models_1.Models.DescribeAuditPoliciesRequest;
const DescribeTablesRequest = models_1.Models.DescribeTablesRequest;
const InstanceRebootTime = models_1.Models.InstanceRebootTime;
...
const ModifyParamTemplateRequest = models_1.Models.ModifyParamTemplateRequest;
const AddTimeWindowResponse = models_1.Models.AddTimeWindowResponse;
const DescribeAuditConfigRequest = models_1.Models.DescribeAuditConfigRequest;
const ZoneSellConf = models_1.Models.ZoneSellConf;
const DescribeAuditRulesResponse = models_1.Models.DescribeAuditRulesResponse;
const DescribeBinlogBackupOverviewResponse = models_1.Models.DescribeBinlogBackupOverviewResponse;
const RollbackTables = models_1.Models.RollbackTables;
const InitDBInstancesRequest = models_1.Models.InitDBInstancesRequest;
const RoInstanceInfo = models_1.Models.RoInstanceInfo;
const RollbackDBName = models_1.Models.RollbackDBName;
const CreateParamTemplateRequest = models_1.Models.CreateParamTemplateRequest;
const DeleteAuditRuleResponse = models_1.Models.DeleteAuditRuleResponse;
const IsolateDBInstanceRequest = models_1.Models.IsolateDBInstanceRequest;
const CreateAuditRuleRequest = models_1.Models.CreateAuditRuleRequest;
const ModifyTimeWindowRequest = models_1.Models.ModifyTimeWindowRequest;
const AuditLogFile = models_1.Models.AuditLogFile;
const ModifyAccountPrivilegesRequest = models_1.Models.ModifyAccountPrivilegesRequest;
const Account = models_1.Models.Account;
const CreateBackupRequest = models_1.Models.CreateBackupRequest;
const ModifyRoGroupInfoResponse = models_1.Models.ModifyRoGroupInfoResponse;
const CommonTimeWindow = models_1.Models.CommonTimeWindow;
const AccountInfo = models_1.Models.AccountInfo;
const DescribeDBInstanceCharsetRequest = models_1.Models.DescribeDBInstanceCharsetRequest;
const DescribeTimeWindowRequest = models_1.Models.DescribeTimeWindowRequest;
const DescribeBackupDatabasesRequest = models_1.Models.DescribeBackupDatabasesRequest;
const ModifyTimeWindowResponse = models_1.Models.ModifyTimeWindowResponse;
const DeviceMemInfo = models_1.Models.DeviceMemInfo;
const ModifyAutoRenewFlagRequest = models_1.Models.ModifyAutoRenewFlagRequest;
const UpgradeDBInstanceEngineVersionRequest = models_1.Models.UpgradeDBInstanceEngineVersionRequest;
const ModifyBackupConfigRequest = models_1.Models.ModifyBackupConfigRequest;
const DeleteDeployGroupsRequest = models_1.Models.DeleteDeployGroupsRequest;
const DescribeSlowLogDataRequest = models_1.Models.DescribeSlowLogDataRequest;
const DescribeAuditConfigResponse = models_1.Models.DescribeAuditConfigResponse;
...
const CreateAuditLogFileRequest = models_1.Models.CreateAuditLogFileRequest;
const DeleteAuditLogFileRequest = models_1.Models.DeleteAuditLogFileRequest;
const DescribeSlowLogsResponse = models_1.Models.DescribeSlowLogsResponse;
const DescribeDBImportRecordsRequest = models_1.Models.DescribeDBImportRecordsRequest;
const CreateDBImportJobResponse = models_1.Models.CreateDBImportJobResponse;
const DescribeTagsOfInstanceIdsRequest = models_1.Models.DescribeTagsOfInstanceIdsRequest;
const UpgradeDBInstanceRequest = models_1.Models.UpgradeDBInstanceRequest;
const DescribeTimeWindowResponse = models_1.Models.DescribeTimeWindowResponse;
const DeleteTimeWindowRequest = models_1.Models.DeleteTimeWindowRequest;
const DeleteAuditPolicyResponse = models_1.Models.DeleteAuditPolicyResponse;
const DescribeDBInstancesResponse = models_1.Models.DescribeDBInstancesResponse;
const TablePrivilege = models_1.Models.TablePrivilege;
const SlowLogInfo = models_1.Models.SlowLogInfo;
const InitDBInstancesResponse = models_1.Models.InitDBInstancesResponse;
const DescribeDataBackupOverviewRequest = models_1.Models.DescribeDataBackupOverviewRequest;
const DescribeParamTemplateInfoResponse = models_1.Models.DescribeParamTemplateInfoResponse;
const ParamRecord = models_1.Models.ParamRecord;
const RestartDBInstancesRequest = models_1.Models.RestartDBInstancesRequest;
const DescribeDBInstanceInfoRequest = models_1.Models.DescribeDBInstanceInfoRequest;
const DescribeInstanceParamsResponse = models_1.Models.DescribeInstanceParamsResponse;
const DescribeDBZoneConfigResponse = models_1.Models.DescribeDBZoneConfigResponse;
const CreateDeployGroupRequest = models_1.Models.CreateDeployGroupRequest;
const DisassociateSecurityGroupsRequest = models_1.Models.DisassociateSecurityGroupsRequest;
const DeleteAccountsRequest = models_1.Models.DeleteAccountsRequest;
const SwitchForUpgradeResponse = models_1.Models.SwitchForUpgradeResponse;
...
const OpenWanServiceRequest = models_1.Models.OpenWanServiceRequest;
const DeleteBackupRequest = models_1.Models.DeleteBackupRequest;
const ModifyNameOrDescByDpIdRequest = models_1.Models.ModifyNameOrDescByDpIdRequest;
const DescribeInstanceParamsRequest = models_1.Models.DescribeInstanceParamsRequest;
const SlowLogItem = models_1.Models.SlowLogItem;
const DescribeDeviceMonitorInfoResponse = models_1.Models.DescribeDeviceMonitorInfoResponse;
const UploadInfo = models_1.Models.UploadInfo;
const DescribeRollbackTaskDetailRequest = models_1.Models.DescribeRollbackTaskDetailRequest;
const DescribeRollbackRangeTimeResponse = models_1.Models.DescribeRollbackRangeTimeResponse;
const ModifyRoGroupInfoRequest = models_1.Models.ModifyRoGroupInfoRequest;
const ReleaseResult = models_1.Models.ReleaseResult;
const InstanceInfo = models_1.Models.InstanceInfo;
const OpenWanServiceResponse = models_1.Models.OpenWanServiceResponse;
const DescribeAuditLogFilesRequest = models_1.Models.DescribeAuditLogFilesRequest;
const DescribeTagsOfInstanceIdsResponse = models_1.Models.DescribeTagsOfInstanceIdsResponse;
const ModifyAccountPasswordResponse = models_1.Models.ModifyAccountPasswordResponse;
const AuditRule = models_1.Models.AuditRule;
const DescribeBinlogsRequest = models_1.Models.DescribeBinlogsRequest;
const DisassociateSecurityGroupsResponse = models_1.Models.DisassociateSecurityGroupsResponse;
const DescribeDBInstanceGTIDRequest = models_1.Models.DescribeDBInstanceGTIDRequest;
const DeployGroupInfo = models_1.Models.DeployGroupInfo;
const InquiryPriceUpgradeInstancesResponse = models_1.Models.InquiryPriceUpgradeInstancesResponse;
/**
 * cdb client
 * @class
 */
class Client extends abstract_client_1.AbstractClient {
    ...
    DescribeDBInstanceGTID(req, cb) {
        const resp = new DescribeDBInstanceGTIDResponse();
    ...
    CreateRoInstanceIp(req, cb) {
        const resp = new CreateRoInstanceIpResponse();
    ...
    CreateAuditPolicy(req, cb) {
        const resp = new CreateAuditPolicyResponse();
    ...
    DescribeDataBackupOverview(req, cb) {
        const resp = new DescribeDataBackupOverviewResponse();
    ...
    BalanceRoGroupLoad(req, cb) {
        const resp = new BalanceRoGroupLoadResponse();
...
2、实例状态必须为正常，并且没有其他异步任务在执行中。
    ...
    ModifyInstanceTag(req, cb) {
        const resp = new ModifyInstanceTagResponse();
    ...
    DescribeTimeWindow(req, cb) {
        const resp = new DescribeTimeWindowResponse();
    ...
    DescribeBackupOverview(req, cb) {
        const resp = new DescribeBackupOverviewResponse();
...
注意，实例下线后，相关资源和数据将无法找回，请谨慎操作。
    ...
    OfflineIsolatedInstances(req, cb) {
        const resp = new OfflineIsolatedInstancesResponse();
    ...
    CreateAuditLogFile(req, cb) {
        const resp = new CreateAuditLogFileResponse();
    ...
    OpenDBInstanceGTID(req, cb) {
        const resp = new OpenDBInstanceGTIDResponse();
    ...
    DescribeRollbackTaskDetail(req, cb) {
        const resp = new DescribeRollbackTaskDetailResponse();
    ...
    DescribeBackupConfig(req, cb) {
        const resp = new DescribeBackupConfigResponse();
    ...
    CloseWanService(req, cb) {
        const resp = new CloseWanServiceResponse();
    ...
    DescribeDefaultParams(req, cb) {
        const resp = new DescribeDefaultParamsResponse();
    ...
    DescribeAuditPolicies(req, cb) {
        const resp = new DescribeAuditPoliciesResponse();
    ...
    DescribeTagsOfInstanceIds(req, cb) {
        const resp = new DescribeTagsOfInstanceIdsResponse();
    ...
    DescribeErrorLogData(req, cb) {
        const resp = new DescribeErrorLogDataResponse();
    ...
    ReleaseIsolatedDBInstances(req, cb) {
        const resp = new ReleaseIsolatedDBInstancesResponse();
    ...
    ModifyAuditConfig(req, cb) {
        const resp = new ModifyAuditConfigResponse();
    ...
    ModifyTimeWindow(req, cb) {
        const resp = new ModifyTimeWindowResponse();
    ...
    DeleteDeployGroups(req, cb) {
        const resp = new DeleteDeployGroupsResponse();
    ...
    SwitchForUpgrade(req, cb) {
        const resp = new SwitchForUpgradeResponse();
    ...
    DeleteParamTemplate(req, cb) {
        const resp = new DeleteParamTemplateResponse();
    ...
    CreateParamTemplate(req, cb) {
        const resp = new CreateParamTemplateResponse();
...
5. 当入参指定 Port，ParamList 或 Password 时，该实例会进行初始化操作；
    ...
    AddTimeWindow(req, cb) {
        const resp = new AddTimeWindowResponse();
    ...
    ModifyDBInstanceVipVport(req, cb) {
        const resp = new ModifyDBInstanceVipVportResponse();
    ...
    DescribeDBInstanceConfig(req, cb) {
        const resp = new DescribeDBInstanceConfigResponse();
...
新版本支持(CreateBackup)创建逻辑备份的时候，直接发起指定库表备份，用户直接下载该备份文件即可。
    ...
    DescribeBackupTables(req, cb) {
        const resp = new DescribeBackupTablesResponse();
    ...
    DeleteAuditPolicy(req, cb) {
        const resp = new DeleteAuditPolicyResponse();
    ...
    InquiryPriceUpgradeInstances(req, cb) {
        const resp = new InquiryPriceUpgradeInstancesResponse();
...
5. 当入参指定 Port，ParamList 或 Password 时，该实例会进行初始化操作；
    ...
    ModifyParamTemplate(req, cb) {
        const resp = new ModifyParamTemplateResponse();
    ...
    DescribeDeployGroupList(req, cb) {
        const resp = new DescribeDeployGroupListResponse();
    ...
    StopDBImportJob(req, cb) {
        const resp = new StopDBImportJobResponse();
    ...
    CreateAccounts(req, cb) {
        const resp = new CreateAccountsResponse();
    ...
    UpgradeDBInstanceEngineVersion(req, cb) {
        const resp = new UpgradeDBInstanceEngineVersionResponse();
    ...
    DescribeAuditLogFiles(req, cb) {
        const resp = new DescribeAuditLogFilesResponse();
    ...
    DeleteAuditRule(req, cb) {
        const resp = new DeleteAuditRuleResponse();
    ...
    DescribeBackupSummaries(req, cb) {
        const resp = new DescribeBackupSummariesResponse();
    ...
    DescribeParamTemplateInfo(req, cb) {
        const resp = new DescribeParamTemplateInfoResponse();
    ...
    DescribeBinlogBackupOverview(req, cb) {
        const resp = new DescribeBinlogBackupOverviewResponse();
    ...
    DeleteAccounts(req, cb) {
        const resp = new DeleteAccountsResponse();
    ...
    DescribeDBInstanceInfo(req, cb) {
        const resp = new DescribeDBInstanceInfoResponse();
    ...
    DescribeRollbackRangeTime(req, cb) {
        const resp = new DescribeRollbackRangeTimeResponse();
    ...
    DescribeParamTemplates(req, cb) {
        const resp = new DescribeParamTemplatesResponse();
     ...
     */
    DeleteBackup(req, cb) {
        const resp = new DeleteBackupResponse();
    ...
    DescribeRoMinScale(req, cb) {
        const resp = new DescribeRoMinScaleResponse();
    ...
    DescribeAuditConfig(req, cb) {
        const resp = new DescribeAuditConfigResponse();
    ...
    ModifyInstanceParam(req, cb) {
        const resp = new ModifyInstanceParamResponse();
    ...
    DescribeDBZoneConfig(req, cb) {
        const resp = new DescribeDBZoneConfigResponse();
    ...
    DescribeDBInstanceRebootTime(req, cb) {
        const resp = new DescribeDBInstanceRebootTimeResponse();
    ...
    ModifyRoGroupInfo(req, cb) {
        const resp = new ModifyRoGroupInfoResponse();
    ...
    CreateAuditRule(req, cb) {
        const resp = new CreateAuditRuleResponse();
    ...
    DescribeDBInstanceCharset(req, cb) {
        const resp = new DescribeDBInstanceCharsetResponse();
...
注意，修改账号权限时，需要传入该账号下的全量权限信息。用户可以先通过 [查询云数据库账户的权限信息
    ...
    ModifyAccountPrivileges(req, cb) {
        const resp = new ModifyAccountPrivilegesResponse();
    ...
    DescribeDBImportRecords(req, cb) {
        const resp = new DescribeDBImportRecordsResponse();
    ...
    DescribeDBSwitchRecords(req, cb) {
        const resp = new DescribeDBSwitchRecordsResponse();
...
注意，用户进行数据导入任务的文件，必须提前上传到腾讯云。用户须在控制台进行文件导入。
    ...
    CreateDBImportJob(req, cb) {
        const resp = new CreateDBImportJobResponse();
    ...
    VerifyRootAccount(req, cb) {
        const resp = new VerifyRootAccountResponse();
    ...
    ModifyAccountPassword(req, cb) {
        const resp = new ModifyAccountPasswordResponse();
    ...
    DescribeUploadedFiles(req, cb) {
        const resp = new DescribeUploadedFilesResponse();
    ...
    DescribeSlowLogData(req, cb) {
        const resp = new DescribeSlowLogDataResponse();
    ...
    DeleteAuditLogFile(req, cb) {
        const resp = new DeleteAuditLogFileResponse();
    ...
    ModifyBackupConfig(req, cb) {
        const resp = new ModifyBackupConfigResponse();
...
新版本支持(CreateBackup)创建逻辑备份的时候，直接发起指定库表备份，用户直接下载该备份文件即可。
    ...
    DescribeBackupDatabases(req, cb) {
        const resp = new DescribeBackupDatabasesResponse();
...
注意：对某个地域进行询价，请使用对应地域的接入点，接入点信息请参照 <a href="https://cloud.tencent.com/document/api/236/15832">服务地址</a> 文档。例如：对广州地域进行询价，请把请求发到：cdb.ap-guangzhou.tencentcloudapi.com。同理对上海地域询价，把请求发到：cdb.ap-shanghai.tencentcloudapi.com。
    ...
    DescribeDBPrice(req, cb) {
        const resp = new DescribeDBPriceResponse();
    ...
    ModifyAutoRenewFlag(req, cb) {
        const resp = new ModifyAutoRenewFlagResponse();
    ...
    StartBatchRollback(req, cb) {
        const resp = new StartBatchRollbackResponse();
    ...
    DescribeDeviceMonitorInfo(req, cb) {
        const resp = new DescribeDeviceMonitorInfoResponse();
...
注意，实例开通外网访问之前，需要先将实例进行 [实例初始化](https://cloud.tencent.com/document/api/236/15873) 操作。
    ...
    OpenWanService(req, cb) {
        const resp = new OpenWanServiceResponse();
    ...
    ModifyAuditRule(req, cb) {
        const resp = new ModifyAuditRuleResponse();
    ...
    DescribeAuditRules(req, cb) {
        const resp = new DescribeAuditRulesResponse();
    ...
    DescribeSupportedPrivileges(req, cb) {
        const resp = new DescribeSupportedPrivilegesResponse();
    ...
    DescribeBinlogs(req, cb) {
        const resp = new DescribeBinlogsResponse();
    ...
    DescribeRoGroups(req, cb) {
        const resp = new DescribeRoGroupsResponse();
    ...
    ModifyNameOrDescByDpId(req, cb) {
        const resp = new ModifyNameOrDescByDpIdResponse();
    ...
    CreateDeployGroup(req, cb) {
        const resp = new CreateDeployGroupResponse();
    ...
    DeleteTimeWindow(req, cb) {
        const resp = new DeleteTimeWindowResponse();
        this.request("DeleteTimeWindow", req, resp, cb);
    }
}
exports.Client = Client;
//# sourceMappingURL=cdb_client.js.map