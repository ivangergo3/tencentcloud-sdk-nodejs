 ...
 * @class
 */
class DescribeStatusRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
 ...
 * @class
 */
class StartAnalyseResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 接口调用状态，1表示成功，非1表示失败
 ...
 * @class
 */
class StartAnalyseRequest extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 购买服务后获得的授权帐号，用于保证请求有效性
 ...
 * @class
 */
class DescribeStatusResponse extends abstract_model_1.AbstractModel {
    constructor() {
        super();
        /**
         * 接口调用状态，1表示成功，非1表示失败
