...
const DescribeStatusRequest = models_1.Models.DescribeStatusRequest;
const StartAnalyseResponse = models_1.Models.StartAnalyseResponse;
const StartAnalyseRequest = models_1.Models.StartAnalyseRequest;
const DescribeStatusResponse = models_1.Models.DescribeStatusResponse;
/**
 * habo client
 * @class
 */
class Client extends abstract_client_1.AbstractClient {
     ...
     */
    StartAnalyse(req, cb) {
        const resp = new StartAnalyseResponse();
    ...
    DescribeStatus(req, cb) {
        const resp = new DescribeStatusResponse();
