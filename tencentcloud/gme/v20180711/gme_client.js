...
const ScanVoiceResponse = models_1.Models.ScanVoiceResponse;
const AppStatisticsItem = models_1.Models.AppStatisticsItem;
const ModifyAppStatusRequest = models_1.Models.ModifyAppStatusRequest;
const DescribeScanResultListResponse = models_1.Models.DescribeScanResultListResponse;
const VoiceFilterRequest = models_1.Models.VoiceFilterRequest;
const VoiceMessageStatisticsItem = models_1.Models.VoiceMessageStatisticsItem;
const DescribeScanResultListRequest = models_1.Models.DescribeScanResultListRequest;
const RealTimeSpeechStatisticsItem = models_1.Models.RealTimeSpeechStatisticsItem;
const VoiceFilterResponse = models_1.Models.VoiceFilterResponse;
const Tag = models_1.Models.Tag;
const VoiceMessageConf = models_1.Models.VoiceMessageConf;
const DescribeFilterResultListResponse = models_1.Models.DescribeFilterResultListResponse;
const DescribeAppStatisticsResponse = models_1.Models.DescribeAppStatisticsResponse;
const Task = models_1.Models.Task;
const VoiceFilterStatisticsItem = models_1.Models.VoiceFilterStatisticsItem;
const VoiceFilterInfo = models_1.Models.VoiceFilterInfo;
const DescribeFilterResultResponse = models_1.Models.DescribeFilterResultResponse;
const DescribeScanResult = models_1.Models.DescribeScanResult;
const DescribeFilterResultListRequest = models_1.Models.DescribeFilterResultListRequest;
const VoiceFilter = models_1.Models.VoiceFilter;
const ScanDetail = models_1.Models.ScanDetail;
const CreateAppRequest = models_1.Models.CreateAppRequest;
const RealtimeSpeechConf = models_1.Models.RealtimeSpeechConf;
const ScanVoiceResult = models_1.Models.ScanVoiceResult;
const CreateAppResponse = models_1.Models.CreateAppResponse;
const DescribeAppStatisticsRequest = models_1.Models.DescribeAppStatisticsRequest;
const ScanPiece = models_1.Models.ScanPiece;
const ModifyAppStatusResponse = models_1.Models.ModifyAppStatusResponse;
const DescribeFilterResultRequest = models_1.Models.DescribeFilterResultRequest;
const VoiceFilterConf = models_1.Models.VoiceFilterConf;
const ScanVoiceRequest = models_1.Models.ScanVoiceRequest;
/**
 * gme client
 * @class
 */
class Client extends abstract_client_1.AbstractClient {
    ...
    DescribeFilterResult(req, cb) {
        const resp = new DescribeFilterResultResponse();
    ...
    DescribeAppStatistics(req, cb) {
        const resp = new DescribeAppStatisticsResponse();
...
<p style="color:red">如果在提交语音检测任务时未设置 Callback 字段，则需要通过本接口获取检测结果</p>
    ...
    DescribeScanResultList(req, cb) {
        const resp = new DescribeScanResultListResponse();
...
Type表示过滤类型，1：政治，2：色情，3：谩骂
     ...
     */
    VoiceFilter(req, cb) {
        const resp = new VoiceFilterResponse();
    ...
    DescribeFilterResultList(req, cb) {
        const resp = new DescribeFilterResultListResponse();
...
<pre><code>{
     ...
     */
    ScanVoice(req, cb) {
        const resp = new ScanVoiceResponse();
     ...
     */
    CreateApp(req, cb) {
        const resp = new CreateAppResponse();
    ...
    ModifyAppStatus(req, cb) {
        const resp = new ModifyAppStatusResponse();
        this.request("ModifyAppStatus", req, resp, cb);
    }
}
exports.Client = Client;
//# sourceMappingURL=gme_client.js.map