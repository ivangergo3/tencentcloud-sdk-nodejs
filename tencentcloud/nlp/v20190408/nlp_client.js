...
const LexicalAnalysisResponse = models_1.Models.LexicalAnalysisResponse;
const SentenceEmbeddingRequest = models_1.Models.SentenceEmbeddingRequest;
const DescribeTripleRequest = models_1.Models.DescribeTripleRequest;
const WordSimilarityRequest = models_1.Models.WordSimilarityRequest;
const SearchWordItemsResponse = models_1.Models.SearchWordItemsResponse;
const DpToken = models_1.Models.DpToken;
const TextSimilarityResponse = models_1.Models.TextSimilarityResponse;
const WordEmbeddingRequest = models_1.Models.WordEmbeddingRequest;
const ChatBotResponse = models_1.Models.ChatBotResponse;
const KeywordsExtractionResponse = models_1.Models.KeywordsExtractionResponse;
const AutoSummarizationRequest = models_1.Models.AutoSummarizationRequest;
const ChatBotRequest = models_1.Models.ChatBotRequest;
const DescribeRelationRequest = models_1.Models.DescribeRelationRequest;
const KeywordsExtractionRequest = models_1.Models.KeywordsExtractionRequest;
const DictInfo = models_1.Models.DictInfo;
const DescribeEntityResponse = models_1.Models.DescribeEntityResponse;
const WordItem = models_1.Models.WordItem;
const ClassificationResult = models_1.Models.ClassificationResult;
const DescribeEntityRequest = models_1.Models.DescribeEntityRequest;
const Keyword = models_1.Models.Keyword;
const UpdateDictResponse = models_1.Models.UpdateDictResponse;
const DescribeDictsRequest = models_1.Models.DescribeDictsRequest;
const DescribeRelationResponse = models_1.Models.DescribeRelationResponse;
const SearchResult = models_1.Models.SearchResult;
const CreateWordItemsRequest = models_1.Models.CreateWordItemsRequest;
const TextCorrectionRequest = models_1.Models.TextCorrectionRequest;
const DeleteWordItemsResponse = models_1.Models.DeleteWordItemsResponse;
const SentenceEmbeddingResponse = models_1.Models.SentenceEmbeddingResponse;
const UpdateDictRequest = models_1.Models.UpdateDictRequest;
const TextClassificationResponse = models_1.Models.TextClassificationResponse;
const DeleteDictResponse = models_1.Models.DeleteDictResponse;
const DescribeWordItemsRequest = models_1.Models.DescribeWordItemsRequest;
const SearchWordItemsRequest = models_1.Models.SearchWordItemsRequest;
const TextClassificationRequest = models_1.Models.TextClassificationRequest;
const CreateDictResponse = models_1.Models.CreateDictResponse;
const TextSimilarityRequest = models_1.Models.TextSimilarityRequest;
const AutoSummarizationResponse = models_1.Models.AutoSummarizationResponse;
const WordEmbeddingResponse = models_1.Models.WordEmbeddingResponse;
const DescribeTripleResponse = models_1.Models.DescribeTripleResponse;
const DescribeWordItemsResponse = models_1.Models.DescribeWordItemsResponse;
const SimilarWordsRequest = models_1.Models.SimilarWordsRequest;
const DescribeDictRequest = models_1.Models.DescribeDictRequest;
const PosToken = models_1.Models.PosToken;
const SentimentAnalysisResponse = models_1.Models.SentimentAnalysisResponse;
const DeleteWordItemsRequest = models_1.Models.DeleteWordItemsRequest;
const DescribeDictResponse = models_1.Models.DescribeDictResponse;
const TextCorrectionResponse = models_1.Models.TextCorrectionResponse;
const DescribeDictsResponse = models_1.Models.DescribeDictsResponse;
const DependencyParsingRequest = models_1.Models.DependencyParsingRequest;
const DeleteDictRequest = models_1.Models.DeleteDictRequest;
const NerToken = models_1.Models.NerToken;
const SimilarWordsResponse = models_1.Models.SimilarWordsResponse;
const EntityRelationObject = models_1.Models.EntityRelationObject;
const DependencyParsingResponse = models_1.Models.DependencyParsingResponse;
const Similarity = models_1.Models.Similarity;
const CCIToken = models_1.Models.CCIToken;
const LexicalAnalysisRequest = models_1.Models.LexicalAnalysisRequest;
const CreateWordItemsResponse = models_1.Models.CreateWordItemsResponse;
const SentimentAnalysisRequest = models_1.Models.SentimentAnalysisRequest;
...
const WordSimilarityResponse = models_1.Models.WordSimilarityResponse;
const TripleContent = models_1.Models.TripleContent;
const CreateDictRequest = models_1.Models.CreateDictRequest;
/**
 * nlp client
 * @class
 */
class Client extends abstract_client_1.AbstractClient {
     ...
     */
    DescribeDict(req, cb) {
        const resp = new DescribeDictResponse();
    ...
    SearchWordItems(req, cb) {
        const resp = new SearchWordItemsResponse();
    ...
    DeleteWordItems(req, cb) {
        const resp = new DeleteWordItemsResponse();
     ...
     */
    UpdateDict(req, cb) {
        const resp = new UpdateDictResponse();
    ...
    DependencyParsing(req, cb) {
        const resp = new DependencyParsingResponse();
...
https://ai.tencent.com/ailab/nlp/zh/embedding.html
    ...
    WordEmbedding(req, cb) {
        const resp = new WordEmbeddingResponse();
    ...
    DescribeDicts(req, cb) {
        const resp = new DescribeDictsResponse();
     ...
     */
    CreateDict(req, cb) {
        const resp = new CreateDictResponse();
...
更多垂直领域的分类体系即将推出，敬请期待。
    ...
    TextClassification(req, cb) {
        const resp = new TextClassificationResponse();
    ...
    WordSimilarity(req, cb) {
        const resp = new WordSimilarityResponse();
...
该句向量服务由腾讯云自然语言处理团队联合微信智言团队共同打造，基于千亿级大规模互联网语料并采用Bert等领先的深度神经网络模型训练而成，在腾讯内部诸多业务的NLP任务上实测效果显著。
    ...
    SentenceEmbedding(req, cb) {
        const resp = new SentenceEmbeddingResponse();
    ...
    DescribeWordItems(req, cb) {
        const resp = new DescribeWordItemsResponse();
...
此功能是基于千亿级大规模互联网语料和LSTM、BERT等深度神经网络模型进行训练，并持续迭代更新，以保证效果不断提升，是搜索引擎、语音识别、内容审核等功能更好运行的基础之一。
    ...
    TextCorrection(req, cb) {
        const resp = new TextCorrectionResponse();
    ...
    CreateWordItems(req, cb) {
        const resp = new CreateWordItemsResponse();
...
鉴于句子相似度是一个应用非常广泛的功能，腾讯云自然语言处理团队在Bert等领先的深度神经网络模型的基础上，专门针对文本相似任务进行了优化，并持续迭代更新。基于句子相似度，可以轻松实现诸如文本去重、相似推荐等功能。
    ...
    TextSimilarity(req, cb) {
        const resp = new TextSimilarityResponse();
...
该功能基于千亿级大规模互联网语料和LSTM、BERT等深度神经网络模型进行训练，并持续迭代更新，以保证效果不断提升。
    ...
    SentimentAnalysis(req, cb) {
        const resp = new SentimentAnalysisResponse();
     ...
     */
    ChatBot(req, cb) {
        const resp = new ChatBotResponse();
...
所有的功能均基于千亿级大规模互联网语料进行持续迭代更新，以保证效果不断提升，用户无需担心新词发现、歧义消除、调用性能等问题。目前词法分析已经在泛互联网、金融、政务等不同垂直领域提供业务支持，并取得良好的效果。
    ...
    LexicalAnalysis(req, cb) {
        const resp = new LexicalAnalysisResponse();
    ...
    KeywordsExtraction(req, cb) {
        const resp = new KeywordsExtractionResponse();
     ...
     */
    DeleteDict(req, cb) {
        const resp = new DeleteDictResponse();
     ...
     */
    SimilarWords(req, cb) {
        const resp = new SimilarWordsResponse();
    ...
    AutoSummarization(req, cb) {
        const resp = new AutoSummarizationResponse();
        this.request("AutoSummarization", req, resp, cb);
    }
}
exports.Client = Client;
//# sourceMappingURL=nlp_client.js.map