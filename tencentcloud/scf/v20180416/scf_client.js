...
const AccessInfo = models_1.Models.AccessInfo;
const Trigger = models_1.Models.Trigger;
const ListAliasesResponse = models_1.Models.ListAliasesResponse;
const DeleteLayerVersionResponse = models_1.Models.DeleteLayerVersionResponse;
const GetAliasResponse = models_1.Models.GetAliasResponse;
const VersionWeight = models_1.Models.VersionWeight;
const LayerVersionInfo = models_1.Models.LayerVersionInfo;
const UpdateFunctionConfigurationResponse = models_1.Models.UpdateFunctionConfigurationResponse;
const PublishLayerVersionResponse = models_1.Models.PublishLayerVersionResponse;
const PublicNetConfigIn = models_1.Models.PublicNetConfigIn;
const UpdateAliasRequest = models_1.Models.UpdateAliasRequest;
const RoutingConfig = models_1.Models.RoutingConfig;
const UpdateAliasResponse = models_1.Models.UpdateAliasResponse;
const GetFunctionLogsRequest = models_1.Models.GetFunctionLogsRequest;
const Tag = models_1.Models.Tag;
const LogFilter = models_1.Models.LogFilter;
const EipConfigIn = models_1.Models.EipConfigIn;
const ListLayerVersionsResponse = models_1.Models.ListLayerVersionsResponse;
const DeleteFunctionRequest = models_1.Models.DeleteFunctionRequest;
const CopyFunctionResponse = models_1.Models.CopyFunctionResponse;
const Namespace = models_1.Models.Namespace;
const GetFunctionRequest = models_1.Models.GetFunctionRequest;
const ListNamespacesRequest = models_1.Models.ListNamespacesRequest;
const PublishVersionRequest = models_1.Models.PublishVersionRequest;
const DeleteAliasRequest = models_1.Models.DeleteAliasRequest;
const ListVersionByFunctionResponse = models_1.Models.ListVersionByFunctionResponse;
const GetAliasRequest = models_1.Models.GetAliasRequest;
const CreateNamespaceResponse = models_1.Models.CreateNamespaceResponse;
const PublicNetConfigOut = models_1.Models.PublicNetConfigOut;
const UpdateFunctionCodeRequest = models_1.Models.UpdateFunctionCodeRequest;
const UpdateFunctionConfigurationRequest = models_1.Models.UpdateFunctionConfigurationRequest;
const ListTriggersResponse = models_1.Models.ListTriggersResponse;
const UpdateNamespaceResponse = models_1.Models.UpdateNamespaceResponse;
const ListLayersRequest = models_1.Models.ListLayersRequest;
const CopyFunctionRequest = models_1.Models.CopyFunctionRequest;
const DeleteNamespaceResponse = models_1.Models.DeleteNamespaceResponse;
const LayerVersionSimple = models_1.Models.LayerVersionSimple;
const CfsConfig = models_1.Models.CfsConfig;
const DeleteNamespaceRequest = models_1.Models.DeleteNamespaceRequest;
const ListFunctionsRequest = models_1.Models.ListFunctionsRequest;
const CreateTriggerRequest = models_1.Models.CreateTriggerRequest;
const ListLayersResponse = models_1.Models.ListLayersResponse;
const DeleteFunctionResponse = models_1.Models.DeleteFunctionResponse;
const Result = models_1.Models.Result;
const CreateAliasResponse = models_1.Models.CreateAliasResponse;
const LogSearchContext = models_1.Models.LogSearchContext;
const TriggerInfo = models_1.Models.TriggerInfo;
const CreateFunctionRequest = models_1.Models.CreateFunctionRequest;
const DeleteAliasResponse = models_1.Models.DeleteAliasResponse;
const PublishVersionResponse = models_1.Models.PublishVersionResponse;
const Environment = models_1.Models.Environment;
const GetFunctionAddressRequest = models_1.Models.GetFunctionAddressRequest;
const InvokeResponse = models_1.Models.InvokeResponse;
const InvokeRequest = models_1.Models.InvokeRequest;
const CreateAliasRequest = models_1.Models.CreateAliasRequest;
const VersionMatch = models_1.Models.VersionMatch;
const ListLayerVersionsRequest = models_1.Models.ListLayerVersionsRequest;
const CreateTriggerResponse = models_1.Models.CreateTriggerResponse;
const PublishLayerVersionRequest = models_1.Models.PublishLayerVersionRequest;
const CreateNamespaceRequest = models_1.Models.CreateNamespaceRequest;
const DeleteLayerVersionRequest = models_1.Models.DeleteLayerVersionRequest;
const Filter = models_1.Models.Filter;
const Variable = models_1.Models.Variable;
const GetFunctionResponse = models_1.Models.GetFunctionResponse;
const Code = models_1.Models.Code;
const UpdateNamespaceRequest = models_1.Models.UpdateNamespaceRequest;
const GetLayerVersionResponse = models_1.Models.GetLayerVersionResponse;
const FunctionLog = models_1.Models.FunctionLog;
const CfsInsInfo = models_1.Models.CfsInsInfo;
const FunctionVersion = models_1.Models.FunctionVersion;
const Function = models_1.Models.Function;
const DeadLetterConfig = models_1.Models.DeadLetterConfig;
const ListVersionByFunctionRequest = models_1.Models.ListVersionByFunctionRequest;
const ListFunctionsResponse = models_1.Models.ListFunctionsResponse;
const ListTriggersRequest = models_1.Models.ListTriggersRequest;
const CreateFunctionResponse = models_1.Models.CreateFunctionResponse;
const ListAliasesRequest = models_1.Models.ListAliasesRequest;
const EipOutConfig = models_1.Models.EipOutConfig;
const Alias = models_1.Models.Alias;
const GetLayerVersionRequest = models_1.Models.GetLayerVersionRequest;
const GetFunctionLogsResponse = models_1.Models.GetFunctionLogsResponse;
const DeleteTriggerResponse = models_1.Models.DeleteTriggerResponse;
const DeleteTriggerRequest = models_1.Models.DeleteTriggerRequest;
const VpcConfig = models_1.Models.VpcConfig;
const GetFunctionAddressResponse = models_1.Models.GetFunctionAddressResponse;
const ListNamespacesResponse = models_1.Models.ListNamespacesResponse;
const EipConfigOut = models_1.Models.EipConfigOut;
const UpdateFunctionCodeResponse = models_1.Models.UpdateFunctionCodeResponse;
/**
 * scf client
 * @class
 */
class Client extends abstract_client_1.AbstractClient {
     ...
     */
    ListTriggers(req, cb) {
        const resp = new ListTriggersResponse();
...
如有需要，您可以在复制后手动配置新函数。
     ...
     */
    ListAliases(req, cb) {
        const resp = new ListAliasesResponse();
     ...
     */
    DeleteAlias(req, cb) {
        const resp = new DeleteAliasResponse();
...
一个别名必须指向一个主版本，此外还可以同时指向一个附加版本。调用函数时指定特定的别名，则请求会被发送到别名指向的版本上，您可以配置请求发送到主版本和附加版本的比例。
     ...
     */
    CreateAlias(req, cb) {
        const resp = new CreateAliasResponse();
     ...
     */
    GetAlias(req, cb) {
        const resp = new GetAliasResponse();
...
//# sourceMappingURL=scf_client.js.map