...
class GetDetectInfoEnhancedRequest extends AbstractModel {
    ...
    BestFramesCount: number | null
    
    IsCutIdCardImage: boolean | null
    
    IsNeedIdCardAvatar: boolean | null
...
class LivenessCompareResponse extends AbstractModel {
    ...
    BestFrameList: Array<string> | null
...
class DetectInfoText extends AbstractModel {
    ...
    LivenessDetail: Array<DetectDetail> | null
