...
* 伸缩策略所属伸缩组处于伸缩活动时，会拒绝执行伸缩策略。
     ...
     * @public
     */
    ExecuteScalingPolicy(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAutoScalingGroup(req: any, cb: any): void {
     ...
     * @public
     */
    PreviewPaiDomainName(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyScalingPolicy(req: any, cb: any): void {
...
如果参数为空，返回当前用户一定数量（Limit所指定的数量，默认为20）的通知。
     ...
     * @public
     */
    DescribeNotificationConfigurations(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAutoScalingGroup(req: any, cb: any): void {
...
* 本接口支持批量操作，每次请求开机实例的上限为100
     ...
     * @public
     */
    StartAutoScalingInstances(req: any, cb: any): void {
     ...
     * @public
     */
    CreatePaiInstance(req: any, cb: any): void {
...
* 升级修改启动配置后，已经使用该启动配置扩容的存量实例不会发生变更，此后使用该启动配置的新增实例会按照新的配置进行扩容。
     ...
     * @public
     */
    UpgradeLaunchConfiguration(req: any, cb: any): void {
     ...
     * @public
     */
    AttachInstances(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeScalingPolicies(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteScheduledAction(req: any, cb: any): void {
...
* 如果伸缩组处于`DISABLED`状态，移出操作不校验`IN_SERVICE`实例数量和最小值的关系
     ...
     * @public
     */
    DetachInstances(req: any, cb: any): void {
     ...
     * @public
     */
    CreateScheduledAction(req: any, cb: any): void {
...
* 如果伸缩组处于`DISABLED`状态，删除操作不校验`IN_SERVICE`实例数量和最小值的关系
     ...
     * @public
     */
    DeleteScalingPolicy(req: any, cb: any): void {
...
* 用户通过调用本接口，指定一个具体的生命周期挂钩的结果（“CONITNUE”或者“ABANDON”）。如果一直不调用本接口，则生命周期挂钩会在超时后按照“DefaultResult”进行处理。
     ...
     * @public
     */
    CompleteLifecycleAction(req: any, cb: any): void {
...
* 本接口会立即修改伸缩组的负载均衡器，并生成一个伸缩活动，异步修改存量实例的负载均衡器。
     ...
     * @public
     */
    ModifyLoadBalancers(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyDesiredCapacity(req: any, cb: any): void {
...
子机设置为移除保护之后，当发生不健康替换、报警策略、期望值变更等触发缩容时，将不对此子机缩容操作。
     ...
     * @public
     */
    SetInstancesProtection(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyNotificationConfiguration(req: any, cb: any): void {
...
* 本接口支持批量操作，每次请求关机实例的上限为100
     ...
     * @public
     */
    StopAutoScalingInstances(req: any, cb: any): void {
...
* 每个项目最多只能创建20个启动配置，详见[使用限制](https://cloud.tencent.com/document/product/377/3120)。
     ...
     * @public
     */
    CreateLaunchConfiguration(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAutoScalingGroup(req: any, cb: any): void {
     ...
     * @public
     */
    CreateNotificationConfiguration(req: any, cb: any): void {
...
* 如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的实例。
     ...
     * @public
     */
    DescribeAutoScalingInstances(req: any, cb: any): void {
...
说明：根据按包年包月计费的实例所创建的伸缩组，其扩容的实例为按量计费实例。
     ...
     * @public
     */
    CreateAutoScalingGroupFromInstance(req: any, cb: any): void {
...
```
     ...
     * @public
     */
    CreateLifecycleHook(req: any, cb: any): void {
...
* 本接口用于升级生命周期挂钩，采用“完全覆盖”风格，无论之前参数如何，统一按照接口参数设置为新的配置。对于非必填字段，不填写则按照默认值赋值。
     ...
     * @public
     */
    UpgradeLifecycleHook(req: any, cb: any): void {
     ...
     * @public
     */
    DisableAutoScalingGroup(req: any, cb: any): void {
...
* 如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的启动配置。
     ...
     * @public
     */
    DescribeLaunchConfigurations(req: any, cb: any): void {
...
* 如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的PAI实例。
     ...
     * @public
     */
    DescribePaiInstances(req: any, cb: any): void {
     ...
     * @public
     */
    CreateScalingPolicy(req: any, cb: any): void {
...
* 若启动配置在伸缩组中属于生效状态，则该启动配置不允许删除。
     ...
     * @public
     */
    DeleteLaunchConfiguration(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLifecycleHook(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAutoScalingGroupLastActivities(req: any, cb: any): void {
...
* 如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的生命周期挂钩。
     ...
     * @public
     */
    DescribeLifecycleHooks(req: any, cb: any): void {
     ...
     * @public
     */
    EnableAutoScalingGroup(req: any, cb: any): void {
...
* 如果参数为空，返回当前用户一定数量（Limit所指定的数量，默认为20）的定时任务。
     ...
     * @public
     */
    DescribeScheduledActions(req: any, cb: any): void {
...
* 如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的伸缩组。
     ...
     * @public
     */
    DescribeAutoScalingGroups(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyScheduledAction(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAutoScalingActivities(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteNotificationConfiguration(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAccountLimits(req: any, cb: any): void {
...
* 本接口支持修改部分简单类型。
     ...
     * @public
     */
    ModifyLaunchConfigurationAttributes(req: any, cb: any): void {
