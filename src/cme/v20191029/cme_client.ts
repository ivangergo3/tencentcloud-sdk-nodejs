...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DescribeMaterials(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTeams(req: any, cb: any): void {
     ...
     * @public
     */
    ExportVideoEditProject(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSharedSpace(req: any, cb: any): void {
     ...
     * @public
     */
    GrantResourceAuthorization(req: any, cb: any): void {
     ...
     * @public
     */
    SearchMaterial(req: any, cb: any): void {
     ...
     * @public
     */
    RevokeResourceAuthorization(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeJoinTeams(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeResourceAuthorization(req: any, cb: any): void {
     ...
     * @public
     */
    ImportMaterial(req: any, cb: any): void {
     ...
     * @public
     */
    ExportVideoByEditorTrackData(req: any, cb: any): void {
...
<li>导出项目输出信息：包括输出的素材 Id 等。</li>
     ...
     * @public
     */
    CreateLink(req: any, cb: any): void {
...
<li>修改团队名称。</li>
     ...
     * @public
     */
    ModifyTeam(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteMaterial(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyMaterial(req: any, cb: any): void {
...
<li>要删除的团队必须没有归属的分类。</li>
     ...
     * @public
     */
    DeleteTeam(req: any, cb: any): void {
     ...
     * @public
     */
    AddTeamMember(req: any, cb: any): void {
...
<li>如果 SourceClassPath = /素材/视频/NBA，DestinationClassPath = /素材/视频/篮球，当 DestinationClassPath 不存在时候，操作结果为重命名 ClassPath，如果 DestinationClassPath 存在时候，操作结果为产生新目录 /素材/视频/篮球/NBA。</li>
     ...
     * @public
     */
    ModifyTeamMember(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteTeamMembers(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLoginStatus(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeProjects(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLoginStatus(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeClass(req: any, cb: any): void {
     ...
     * @public
     */
    CreateTeam(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyProject(req: any, cb: any): void {
...
<li>子分类数不能超过10。</li>
     ...
     * @public
     */
    ImportMediaToProject(req: any, cb: any): void {
     ...
     * @public
     */
    CreateProject(req: any, cb: any): void {
...
<li>分类下没有绑定素材。</li>
     ...
     * @public
     */
    DeleteProject(req: any, cb: any): void {
     ...
     * @public
     */
    FlattenListMedia(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTeamMembers(req: any, cb: any): void {
