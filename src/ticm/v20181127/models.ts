...
class VodPoliticalOcrReviewResult extends AbstractModel {
    ...
    SegmentSet: Array<VodOcrTextSegmentItem> | null
...
class VodPoliticalAsrReviewResult extends AbstractModel {
    ...
    SegmentSet: Array<VodAsrTextSegmentItem> | null
...
class VodMetaData extends AbstractModel {
    ...
    VideoStreamSet: Array<VodVideoStreamItem> | null
    
    AudioStreamSet: Array<VodAudioStreamItem> | null
...
class VodPornReviewResult extends AbstractModel {
    ...
    SegmentSet: Array<VodPornReviewSegmentItem> | null
...
class VodPoliticalReviewResult extends AbstractModel {
    ...
    SegmentSet: Array<VodPoliticalReviewSegmentItem> | null
...
class DescribeVideoTaskResponse extends AbstractModel {
    ...
    PornResult: VodPornReviewResult | null
    
    TerrorismResult: VodTerrorismReviewResult | null
    
    PoliticalResult: VodPoliticalReviewResult | null
    
    PoliticalOcrResult: VodPoliticalOcrReviewResult | null
    
    PornAsrResult: VodPornAsrReviewResult | null
    
    PoliticalAsrResult: VodPoliticalAsrReviewResult | null
    
    PornOcrResult: VodPornOcrResult | null
