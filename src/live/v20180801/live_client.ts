...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DropLiveStream(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveWatermarks(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeConcurrentRecordStreamNum(req: any, cb: any): void {
...
- 注意事项
  ...
  4. 此调用方式暂时不支持海外推流录制。
     ...
     * @public
     */
    CreateLiveRecord(req: any, cb: any): void {
     ...
     * @public
     */
    UpdateLiveWatermark(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyLiveSnapshotTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyLiveRecordTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    CreateLiveWatermarkRule(req: any, cb: any): void {
...
注意：该接口可通过使用IsFilter进行过滤，返回推流历史记录。
     ...
     * @public
     */
    DescribeLiveStreamEventList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePullStreamConfigs(req: any, cb: any): void {
...
备注：数据延迟1小时，如10:00-10:59点的数据12点才能查到。
     ...
     * @public
     */
    DescribeHttpStatusInfoList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeProvinceIspPlayInfoList(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyLivePlayDomain(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeStreamPushInfoList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveSnapshotRules(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLiveTranscodeTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTopClientIpSumInfoList(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyPullStreamStatus(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveRecordTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyLiveDomainCert(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeVisitTopSumInfoList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveDomainCert(req: any, cb: any): void {
     ...
     * @public
     */
    AddLiveWatermark(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLiveWatermarkRule(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLiveCallbackRule(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyPullStreamConfig(req: any, cb: any): void {
...
<br>截图相关文档：[直播截图](/document/product/267/32737)。
     ...
     * @public
     */
    CreateLiveSnapshotTemplate(req: any, cb: any): void {
...
注意：该接口仅适用于流数少于2万路的情况，对于流数较大用户请联系售后。
     ...
     * @public
     */
    DescribeLiveStreamOnlineList(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLiveCallbackTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLivePushAuthKey(req: any, cb: any): void {
     ...
     * @public
     */
    DeletePullStreamConfig(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveRecordTemplate(req: any, cb: any): void {
...
最佳实践：https://cloud.tencent.com/document/product/267/45566
     ...
     * @public
     */
    CreateCommonMixStream(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLiveWatermark(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePlayErrorCodeSumInfoList(req: any, cb: any): void {
...
使用场景：对重要直播，避免出现突发状况，可通过设置延迟播放，提前做好把控。
     ...
     * @public
     */
    AddDelayLiveStream(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeStreamDayPlayInfoList(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyLivePushAuthKey(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyLiveTranscodeTemplate(req: any, cb: any): void {
...
DomainName+AppName+StreamName+TemplateId唯一标识单个转码规则，如需删除需要强匹配。其中TemplateId必填，其余参数为空时也需要传空字符串进行强匹配。
     ...
     * @public
     */
    DeleteLiveTranscodeRule(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLiveSnapshotRule(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveForbidStreamList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveCert(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyLiveCert(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveDomains(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLiveCert(req: any, cb: any): void {
...
<br>回调协议相关文档：[事件消息通知](/document/product/267/32744)。
     ...
     * @public
     */
    CreateLiveCallbackTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    ResumeLiveStream(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveCallbackTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLiveDomain(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyLiveCallbackTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeProIspPlaySumInfoList(req: any, cb: any): void {
...
注意：按AppName查询请先联系工单申请，开通后配置生效预计需要5个工作日左右，具体时间以最终回复为准。
     ...
     * @public
     */
    DescribeStreamPlayInfoList(req: any, cb: any): void {
     ...
     * @public
     */
    CreateLiveCert(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveTranscodeRules(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveSnapshotTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveCallbackTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    StopRecordTask(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveSnapshotTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    StopLiveRecord(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyLivePlayAuthKey(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveTranscodeTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeScreenShotSheetNumList(req: any, cb: any): void {
     ...
     * @public
     */
    UnBindLiveDomainCert(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteRecordTask(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveTranscodeDetailInfo(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLogDownloadList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveRecordRules(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveDelayInfoList(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLiveRecordRule(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveDomain(req: any, cb: any): void {
...
<br>回调协议相关文档：[事件消息通知](/document/product/267/32744)。
     ...
     * @public
     */
    CreateLiveCallbackRule(req: any, cb: any): void {
...
注意：需先调用添加证书接口进行证书添加。获取到证书Id后再调用该接口进行绑定。
     ...
     * @public
     */
    BindLiveDomainCert(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveCallbackRules(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePlayErrorCodeDetailInfoList(req: any, cb: any): void {
...
注意：分页最多支持查询1万条记录，可通过调整查询时间范围来获取更多数据。
     ...
     * @public
     */
    DescribeLiveStreamPublishedList(req: any, cb: any): void {
     ...
     * @public
     */
    ForbidLiveStream(req: any, cb: any): void {
     ...
     * @public
     */
    AddLiveDomain(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDeliverBandwidthList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveDomainPlayInfoList(req: any, cb: any): void {
...
<br>录制相关文档：[直播录制](/document/product/267/32739)。
     ...
     * @public
     */
    CreateLiveRecordRule(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveWatermark(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveTranscodeTemplates(req: any, cb: any): void {
...
<br>录制相关文档：[直播录制](/document/product/267/32739)。
     ...
     * @public
     */
    CreateLiveRecordTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBillBandwidthAndFluxList(req: any, cb: any): void {
     ...
     * @public
     */
    ForbidLiveDomain(req: any, cb: any): void {
...
<br>转码相关文档：[直播转封装及转码](/document/product/267/32736)。
     ...
     * @public
     */
    CreateLiveTranscodeRule(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveWatermarkRules(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLiveRecord(req: any, cb: any): void {
...
注意：单个域名仅支持关联一个截图模板。
     ...
     * @public
     */
    CreateLiveSnapshotRule(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeGroupProIspPlayInfoList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAllStreamPlayInfoList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLivePlayAuthKey(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveStreamState(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLiveRecordTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    ResumeDelayLiveStream(req: any, cb: any): void {
...
4. 当前录制任务管理API（CreateRecordTask/StopRecordTask/DeleteRecordTask）与旧API（CreateLiveRecord/StopLiveRecord/DeleteLiveRecord）不兼容，两套接口不能混用。
     ...
     * @public
     */
    CreateRecordTask(req: any, cb: any): void {
...
<br>转码相关文档：[直播转封装及转码](/document/product/267/32736)。
     ...
     * @public
     */
    CreateLiveTranscodeTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveCerts(req: any, cb: any): void {
     ...
     * @public
     */
    EnableLiveDomain(req: any, cb: any): void {
     ...
     * @public
     */
    CancelCommonMixStream(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLivePackageInfo(req: any, cb: any): void {
...
但转推目标地址即 ToUrl 目前限制为已注册的腾讯直播域名。
     ...
     * @public
     */
    CreatePullStreamConfig(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLiveStreamPushInfoList(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLiveSnapshotTemplate(req: any, cb: any): void {
