...
class CreateCallBackRequest extends AbstractModel {
    ...
    SrcDisplayNum: string | null
    
    DstDisplayNum: string | null
    
    Record: string | null
    
    MaxAllowTime: string | null
    ...
    PreCallerHandle: RreCallerHandle | null
...
class CallBackCdr extends AbstractModel {
    ...
    StartSrcCallTime: string | null
    
    StartSrcRingTime: string | null
    
    SrcAcceptTime: string | null
    
    StartDstCallTime: string | null
    
    StartDstRingTime: string | null
    
    DstAcceptTime: string | null
    
    EndCallTime: string | null
    
    CallEndStatus: string | null
...
class RreCallerHandle extends AbstractModel {
    ...
    KeyList: Array<KeyList> | null
    
    RepeatTimes: string | null
    
    KeyPressUrl: string | null
    
    PromptGender: string | null
...
class DescribeCallerDisplayListResponse extends AbstractModel {
    ...
    CodeList: Array<CallBackPhoneCode> | null
...
class GetVirtualNumRequest extends AbstractModel {
    ...
    AccreditList: Array<string> | null
    
    AssignVirtualNum: string | null
...
class VirturalNumCdr extends AbstractModel {
    ...
    DstVirtualNum: string | null
    
    CallCenterAcceptTime: string | null
    ...
    SrcDuration: string | null
    
    DstDuration: string | null
