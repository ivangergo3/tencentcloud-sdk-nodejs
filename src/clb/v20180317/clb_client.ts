...
本接口为异步接口，本接口返回成功后需以返回的RequestID为入参，调用DescribeTaskStatus接口查询本次任务是否成功。
     ...
     * @public
     */
    RegisterTargets(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLoadBalancerListByCertId(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeClassicalLBListeners(req: any, cb: any): void {
     ...
     * @public
     */
    CreateTopic(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLoadBalancerSnatIps(req: any, cb: any): void {
...
本接口为异步接口，接口返回成功后，需以得到的 RequestID 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    DeleteListener(req: any, cb: any): void {
     ...
     * @public
     */
    SetSecurityGroupForLoadbalancers(req: any, cb: any): void {
     ...
     * @public
     */
    BatchDeregisterTargets(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的 RequestID 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    RegisterTargetGroupInstances(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的RequestID为入参，调用DescribeTaskStatus接口查询本次任务是否成功。
     ...
     * @public
     */
    SetLoadBalancerClsLog(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的RequestID为入参，调用DescribeTaskStatus接口查询本次任务是否成功。
     ...
     * @public
     */
    AutoRewrite(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的 RequestID 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    DisassociateTargetGroups(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的RequestID为入参，调用DescribeTaskStatus接口查询本次任务是否成功。
     ...
     * @public
     */
    ModifyListener(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的 RequestID 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    DeleteLoadBalancerListeners(req: any, cb: any): void {
...
解绑操作时，入参需要传入负载均衡实例执行解绑后所绑定的所有安全组；如果要解绑所有安全组，可不传此参数，或传入空数组。注意：内网负载均衡不支持绑定安全组。
     ...
     * @public
     */
    SetLoadBalancerSecurityGroups(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteTargetGroups(req: any, cb: any): void {
...
（接口灰度中，如需使用请提工单）
     ...
     * @public
     */
    ModifyBlockIPList(req: any, cb: any): void {
...
本接口为异步接口，接口返回成功后，需以返回的 RequestId 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    DeregisterTargetsFromClassicalLB(req: any, cb: any): void {
     ...
     * @public
     */
    CreateClsLogSet(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLoadBalancersDetail(req: any, cb: any): void {
...
本接口为异步接口，接口返回成功后，需以返回的 RequestId 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    DeleteLoadBalancer(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后，需以返回的RequestId为入参，调用DescribeTaskStatus接口查询本次任务是否成功。
     ...
     * @public
     */
    ModifyDomainAttributes(req: any, cb: any): void {
...
注：本接口仅可从广州地域调用。
     ...
     * @public
     */
    ReplaceCertForLoadBalancers(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的 RequestID 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    AssociateTargetGroups(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的 RequestID 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    DeregisterTargetGroupInstances(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLoadBalancers(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBlockIPList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeListeners(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeClassicalLBTargets(req: any, cb: any): void {
...
本接口为异步接口，接口返回成功后，需以返回的 RequestId 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    CreateListener(req: any, cb: any): void {
     ...
     * @public
     */
    BatchRegisterTargets(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeClsLogSet(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的RequestID为入参，调用DescribeTaskStatus接口查询本次任务是否成功。
     ...
     * @public
     */
    ModifyTargetPort(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的RequestID为入参，调用DescribeTaskStatus接口查询本次任务是否成功。
     ...
     * @public
     */
    ModifyTargetWeight(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTaskStatus(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的RequestID为入参，调用DescribeTaskStatus接口查询本次任务是否成功。
     ...
     * @public
     */
    ModifyRule(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTargetHealth(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTargetGroupList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBlockIPTask(req: any, cb: any): void {
     ...
     * @public
     */
    CreateTargetGroup(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTargets(req: any, cb: any): void {
...
本接口为异步接口，接口返回成功后，需以返回的 RequestId 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    RegisterTargetsWithClassicalLB(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRewrite(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTargetGroups(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyTargetGroupAttribute(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeClassicalLBHealthStatus(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的RequestID为入参，调用DescribeTaskStatus接口查询本次任务是否成功。
     ...
     * @public
     */
    DeregisterTargets(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyLoadBalancerAttributes(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的 RequestID 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    ModifyTargetGroupInstancesWeight(req: any, cb: any): void {
     ...
     * @public
     */
    CreateLoadBalancerSnatIps(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeClassicalLBByInstanceId(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTargetGroupInstances(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的 RequestID 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    ModifyTargetGroupInstancesPort(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的 RequestID 为入参，调用 DescribeTaskStatus 接口查询本次任务是否成功。
     ...
     * @public
     */
    BatchModifyTargetWeight(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的RequestID为入参，调用DescribeTaskStatus接口查询本次任务是否成功。
     ...
     * @public
     */
    DeleteRewrite(req: any, cb: any): void {
...
本接口为异步接口，接口成功返回后，可使用 DescribeLoadBalancers 接口查询负载均衡实例的状态（如创建中、正常），以确定是否创建成功。
     ...
     * @public
     */
    CreateLoadBalancer(req: any, cb: any): void {
...
本接口为异步接口，本接口返回成功后需以返回的RequestID为入参，调用DescribeTaskStatus接口查询本次任务是否成功。
     ...
     * @public
     */
    ManualRewrite(req: any, cb: any): void {
