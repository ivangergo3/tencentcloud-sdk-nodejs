...
该接口不用于发起网络调用，而是用来帮助生成各个语言平台的 SDK，您可以参考 SDK 的中解析函数的实现事件通知的解析。
     ...
     * @public
     */
    ParseNotification(req: any, cb: any): void {
...
该接口不用于发起网络调用，而是用来帮助生成各个语言平台的 SDK，您可以参考 SDK 的中解析函数的实现事件通知的解析。
     ...
     * @public
     */
    ParseLiveStreamProcessNotification(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeWorkflows(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeMediaMetaData(req: any, cb: any): void {
     ...
     * @public
     */
    ResetWorkflow(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteWorkflow(req: any, cb: any): void {
     ...
     * @public
     */
    DisableWorkflow(req: any, cb: any): void {
     ...
     * @public
     */
    EnableWorkflow(req: any, cb: any): void {
...
> 注意：目前仅支持终止执行中的直播流处理任务。
     ...
     * @public
     */
    ManageTask(req: any, cb: any): void {
...
注意：创建工作流成功后是禁用状态，需要手动启用。
     ...
     * @public
     */
    CreateWorkflow(req: any, cb: any): void {
...
直播流处理事件通知实时写入用户指定的消息队列 CMQ 中，用户需要从消息队列 CMQ 中获取事件通知结果，同时处理过程中存在输出文件的，会写入用户指定的输出文件的目标存储中。
     ...
     * @public
     */
    ProcessLiveStream(req: any, cb: any): void {
