...
class DescribeEndUserStatisticResponse extends AbstractModel {
    ...
    PlatformStatistics: Array<PlatformStatistic> | null
...
class DescribeEnvFreeQuotaResponse extends AbstractModel {
    ...
    QuotaItems: Array<PostpayEnvQuota> | null
...
class DescribeExtraPkgBillingInfoResponse extends AbstractModel {
    ...
    EnvInfoList: Array<EnvBillingInfoItem> | null
...
class EnvInfo extends AbstractModel {
    ...
    Databases: Array<DatabasesInfo> | null
    
    Storages: Array<StorageInfo> | null
    
    Functions: Array<FunctionInfo> | null
    
    PackageId: string | null
    
    PackageName: string | null
    
    LogServices: Array<LogServiceInfo> | null
    
    StaticStorages: Array<StaticStorageInfo> | null
...
class DescribeEnvLimitResponse extends AbstractModel {
    ...
    MaxEnvNum: number | null
    
    CurrentEnvNum: number | null
    
    MaxFreeEnvNum: number | null
    
    CurrentFreeEnvNum: number | null
    
    MaxDeleteTotal: number | null
    
    CurrentDeleteTotal: number | null
    
    MaxDeleteMonthly: number | null
    
    CurrentDeleteMonthly: number | null
...
class DescribePostpayPackageFreeQuotasResponse extends AbstractModel {
    ...
    PackageFreeQuotaInfos: Array<PackageFreeQuotaInfo> | null
...
class DescribeEndUserLoginStatisticResponse extends AbstractModel {
    ...
    LoginStatistics: Array<LoginStatistic> | null
