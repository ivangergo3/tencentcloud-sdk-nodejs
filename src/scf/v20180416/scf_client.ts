...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DeleteFunction(req: any, cb: any): void {
     ...
     * @public
     */
    ListTriggers(req: any, cb: any): void {
     ...
     * @public
     */
    GetLayerVersion(req: any, cb: any): void {
     ...
     * @public
     */
    CreateTrigger(req: any, cb: any): void {
...
如有需要，您可以在复制后手动配置新函数。
     ...
     * @public
     */
    CopyFunction(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteTrigger(req: any, cb: any): void {
     ...
     * @public
     */
    ListAliases(req: any, cb: any): void {
     ...
     * @public
     */
    GetFunctionLogs(req: any, cb: any): void {
     ...
     * @public
     */
    UpdateNamespace(req: any, cb: any): void {
     ...
     * @public
     */
    PublishVersion(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLayerVersion(req: any, cb: any): void {
     ...
     * @public
     */
    GetFunction(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAlias(req: any, cb: any): void {
...
一个别名必须指向一个主版本，此外还可以同时指向一个附加版本。调用函数时指定特定的别名，则请求会被发送到别名指向的版本上，您可以配置请求发送到主版本和附加版本的比例。
     ...
     * @public
     */
    CreateAlias(req: any, cb: any): void {
     ...
     * @public
     */
    ListVersionByFunction(req: any, cb: any): void {
     ...
     * @public
     */
    ListLayers(req: any, cb: any): void {
     ...
     * @public
     */
    ListLayerVersions(req: any, cb: any): void {
     ...
     * @public
     */
    ListFunctions(req: any, cb: any): void {
     ...
     * @public
     */
    UpdateFunctionConfiguration(req: any, cb: any): void {
     ...
     * @public
     */
    PublishLayerVersion(req: any, cb: any): void {
     ...
     * @public
     */
    GetFunctionAddress(req: any, cb: any): void {
     ...
     * @public
     */
    CreateFunction(req: any, cb: any): void {
     ...
     * @public
     */
    ListNamespaces(req: any, cb: any): void {
     ...
     * @public
     */
    UpdateFunctionCode(req: any, cb: any): void {
