...
export class Client extends AbstractClient {
     ...
     * @public
     */
    CreateScanInstances(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeShieldResult(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteScanInstances(req: any, cb: any): void {
     ...
     * @public
     */
    CreateResourceInstances(req: any, cb: any): void {
     ...
     * @public
     */
    CreateBindInstance(req: any, cb: any): void {
     ...
     * @public
     */
    CreateCosSecKeyInstance(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeResourceInstances(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeScanResults(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeShieldPlanInstance(req: any, cb: any): void {
     ...
     * @public
     */
    CreateShieldInstance(req: any, cb: any): void {
...
可以通过指定任务唯一标识ItemId来查询指定app的详细信息，或通过设定过滤器来查询满足过滤条件的app的详细信息。 指定偏移(Offset)和限制(Limit)来选择结果中的一部分，默认返回满足条件的前20个app信息。
     ...
     * @public
     */
    DescribeShieldInstances(req: any, cb: any): void {
     ...
     * @public
     */
    CreateShieldPlanInstance(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeUserBaseInfoInstance(req: any, cb: any): void {
...
可以通过指定任务唯一标识ItemId来查询指定app的详细信息，或通过设定过滤器来查询满足过滤条件的app的详细信息。 指定偏移(Offset)和限制(Limit)来选择结果中的一部分，默认返回满足条件的前20个app信息。
     ...
     * @public
     */
    DescribeScanInstances(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteShieldInstances(req: any, cb: any): void {
