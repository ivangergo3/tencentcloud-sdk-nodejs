...
- 构成人体轨迹单张图片大小不得超过2M，分辨率不得超过1920*1080。
     ...
     * @public
     */
    SearchTrace(req: any, cb: any): void {
     ...
     * @public
     */
    DetectBody(req: any, cb: any): void {
     ...
     * @public
     */
    SegmentPortraitPic(req: any, cb: any): void {
     ...
     * @public
     */
    DetectBodyJoints(req: any, cb: any): void {
...
- 构成人体轨迹单张图片大小限制为2M，分辨率限制为1920*1080。
     ...
     * @public
     */
    CreateTrace(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyPersonInfo(req: any, cb: any): void {
...
- 构成人体轨迹单张图片大小不得超过2M，分辨率不得超过1920*1080。
     ...
     * @public
     */
    SegmentCustomizedPortraitPic(req: any, cb: any): void {
