...
const SearchResultSeg = models.SearchResultSeg;
const DataManipulationResult = models.DataManipulationResult;
const SearchResultItem = models.SearchResultItem;
const DataSearchResponse = models.DataSearchResponse;
const DataSearchRequest = models.DataSearchRequest;
const DataManipulationResultItem = models.DataManipulationResultItem;
