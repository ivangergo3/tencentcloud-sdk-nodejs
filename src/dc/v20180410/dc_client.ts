...
export class Client extends AbstractClient {
     ...
     * @public
     */
    ModifyDirectConnectAttribute(req: any, cb: any): void {
     ...
     * @public
     */
    CreateDirectConnectTunnel(req: any, cb: any): void {
...
只能删除处于已连接状态的物理专线。
     ...
     * @public
     */
    DeleteDirectConnect(req: any, cb: any): void {
     ...
     * @public
     */
    AcceptDirectConnectTunnel(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteDirectConnectTunnel(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAccessPoints(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDirectConnectTunnels(req: any, cb: any): void {
...
若账户下存在欠费状态的物理专线，则不能申请更多的物理专线。
     ...
     * @public
     */
    CreateDirectConnect(req: any, cb: any): void {
     ...
     * @public
     */
    RejectDirectConnectTunnel(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDirectConnects(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyDirectConnectTunnelAttribute(req: any, cb: any): void {
