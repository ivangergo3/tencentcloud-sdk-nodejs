...
export class Client extends AbstractClient {
     ...
     * @public
     */
    CreateContractByUpload(req: any, cb: any): void {
     ...
     * @public
     */
    CreateSeal(req: any, cb: any): void {
     ...
     * @public
     */
    DownloadContract(req: any, cb: any): void {
     ...
     * @public
     */
    CreatePersonalAccount(req: any, cb: any): void {
     ...
     * @public
     */
    SignContractByKeyword(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteSeal(req: any, cb: any): void {
     ...
     * @public
     */
    CreateEnterpriseAccount(req: any, cb: any): void {
...
用户在企业电子合同平台输入收到的验证码后，由企业电子合同平台调用该接口向腾讯云提交确认受托签署合同验证码命令。验证码验证正确时，本次合同签署的授权成功。
     ...
     * @public
     */
    CheckVcode(req: any, cb: any): void {
     ...
     * @public
     */
    SignContractByCoordinate(req: any, cb: any): void {
