...
export class Client extends AbstractClient {
     ...
     * @public
     */
    CreateVpcPeerConnection(req: any, cb: any): void {
     ...
     * @public
     */
    AsyncRegisterIps(req: any, cb: any): void {
     ...
     * @public
     */
    UnbindEipsFromNatGateway(req: any, cb: any): void {
     ...
     * @public
     */
    BindEipsToNatGateway(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyVpcPeerConnection(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSubnetAvailableIps(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRoutePolicies(req: any, cb: any): void {
...
2) 每次调用最多能支持传入10台物理机。
     ...
     * @public
     */
    DeleteHostedInterface(req: any, cb: any): void {
     ...
     * @public
     */
    DeregisterIps(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyRoutePolicy(req: any, cb: any): void {
     ...
     * @public
     */
    CreateInterfaces(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteRoutePolicy(req: any, cb: any): void {
     ...
     * @public
     */
    BindIpsToNatGateway(req: any, cb: any): void {
     ...
     * @public
     */
    UnbindIpsFromNatGateway(req: any, cb: any): void {
...
删除子网前，请清理该子网下所有资源，包括物理机、负载均衡、黑石数据库、弹性IP、NAT网关等资源
     ...
     * @public
     */
    DescribeNatSubnets(req: any, cb: any): void {
     ...
     * @public
     */
    RejectVpcPeerConnection(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSubnetByDevice(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyRouteTable(req: any, cb: any): void {
     ...
     * @public
     */
    ModifySubnetDHCPRelay(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeVpcView(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteVirtualIp(req: any, cb: any): void {
     ...
     * @public
     */
    CreateDockerSubnetWithVlan(req: any, cb: any): void {
     ...
     * @public
     */
    UpgradeNatGateway(req: any, cb: any): void {
     ...
     * @public
     */
    CreateRoutePolicies(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeVpcResource(req: any, cb: any): void {
     ...
     * @public
     */
    UnbindSubnetsFromNatGateway(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteHostedInterfaces(req: any, cb: any): void {
     ...
     * @public
     */
    AcceptVpcPeerConnection(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeVpcQuota(req: any, cb: any): void {
     ...
     * @public
     */
    BindSubnetsToNatGateway(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteInterfaces(req: any, cb: any): void {
...
3) 每次调用最多能支持传入10台托管机器。
     ...
     * @public
     */
    CreateHostedInterface(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSubnetByHostedDevice(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeVpcPeerConnections(req: any, cb: any): void {
...
本接口不传参数时，返回默认排序下的前20条VPC信息。
     ...
     * @public
     */
    DeleteVpcPeerConnection(req: any, cb: any): void {
     ...
     * @public
     */
    CreateVirtualSubnetWithVlan(req: any, cb: any): void {
