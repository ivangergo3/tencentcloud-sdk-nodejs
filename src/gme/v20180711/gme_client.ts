...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DescribeFilterResult(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAppStatistics(req: any, cb: any): void {
...
<p style="color:red">如果在提交语音检测任务时未设置 Callback 字段，则需要通过本接口获取检测结果</p>
     ...
     * @public
     */
    DescribeScanResultList(req: any, cb: any): void {
...
Type表示过滤类型，1：政治，2：色情，3：谩骂
     ...
     * @public
     */
    VoiceFilter(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeFilterResultList(req: any, cb: any): void {
...
<pre><code>{
     ...
     * @public
     */
    ModifyAppStatus(req: any, cb: any): void {
