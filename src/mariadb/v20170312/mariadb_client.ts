...
注意：注意：相同用户名，不同Host是不同的账号。
     ...
     * @public
     */
    DescribeRenewalPrice(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSaleInfo(req: any, cb: any): void {
...
注意：相同用户名，不同Host是不同的账号。
     ...
     * @public
     */
    DescribeBackupTime(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBResourceUsageDetails(req: any, cb: any): void {
...
注意：相同用户名，不同Host是不同的账号。
     ...
     * @public
     */
    ModifyDBParameters(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSqlLogs(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeFlow(req: any, cb: any): void {
...
注意：相同用户名，不同Host是不同的账号。
     ...
     * @public
     */
    GrantAccountPrivileges(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBParameters(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBPerformanceDetails(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBLogFiles(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBInstanceSpecs(req: any, cb: any): void {
...
如果不指定任何筛选条件，则默认返回20条实例记录，单次请求最多支持返回100条实例记录。
     ...
     * @public
     */
    DescribeUpgradePrice(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyBackupTime(req: any, cb: any): void {
     ...
     * @public
     */
    CreateTmpInstances(req: any, cb: any): void {
...
注意：相同用户名，不同Host是不同的账号，Readonly属性相同的账号之间才能复制权限。
     ...
     * @public
     */
    CopyAccountPrivileges(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePrice(req: any, cb: any): void {
     ...
     * @public
     */
    CloneAccount(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBPerformance(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLogFileRetentionPeriod(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBResourceUsage(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyLogFileRetentionPeriod(req: any, cb: any): void {
