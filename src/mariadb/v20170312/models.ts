...
class DescribeDBResourceUsageDetailsResponse extends AbstractModel {
    ...
    Master: ResourceUsageMonitorSet | null
    
    Slave1: ResourceUsageMonitorSet | null
    
    Slave2: ResourceUsageMonitorSet | null
...
class ResourceUsageMonitorSet extends AbstractModel {
    ...
    BinlogDiskAvailable: MonitorData | null
    
    CpuUsageRate: MonitorData | null
    
    MemAvailable: MonitorData | null
    
    DataDiskAvailable: MonitorData | null
...
class PerformanceMonitorSet extends AbstractModel {
    ...
    UpdateTotal: MonitorData | null
    
    DiskIops: MonitorData | null
    
    ConnActive: MonitorData | null
    
    MemHitRate: MonitorData | null
    
    SlaveDelay: MonitorData | null
    
    SelectTotal: MonitorData | null
    
    LongQuery: MonitorData | null
    
    DeleteTotal: MonitorData | null
    
    InsertTotal: MonitorData | null
    
    IsMasterSwitched: MonitorData | null
...
class ZoneChooseInfo extends AbstractModel {
    ...
    MasterZone: ZonesInfo | null
    
    SlaveZones: Array<ZonesInfo> | null
...
class DBBackupTimeConfig extends AbstractModel {
    ...
    StartBackupTime: string | null
    
    EndBackupTime: string | null
...
class DescribeDBInstancesRequest extends AbstractModel {
    ...
    OriginSerialIds: Array<string> | null
    
    IsFilterExcluster: boolean | null
    
    ExclusterType: number | null
    
    ExclusterIds: Array<string> | null
...
class DescribeSaleInfoResponse extends AbstractModel {
    ...
    RegionList: Array<RegionInfo> | null
...
class ModifyDBParametersRequest extends AbstractModel {
    ...
    Params: Array<DBParamValue> | null
...
class ModifyDBParametersResponse extends AbstractModel {
    ...
    Result: Array<ParamModifyResult> | null
...
class CopyAccountPrivilegesRequest extends AbstractModel {
    ...
    DstUserName: string | null
    
    DstHost: string | null
    
    SrcReadOnly: string | null
    
    DstReadOnly: string | null
...
class DBInstance extends AbstractModel {
    ...
    TdsqlVersion: string | null
    
    Memory: number | null
    
    Storage: number | null
    
    UniqueVpcId: string | null
    
    UniqueSubnetId: string | null
    
    OriginSerialId: string | null
    ...
    IsAuditSupported: number | null
    
    Machine: string | null
    
    IsEncryptSupported: number | null
...
class DescribeBackupTimeResponse extends AbstractModel {
    ...
    Items: Array<DBBackupTimeConfig> | null
...
class SlowLogData extends AbstractModel {
    ...
    LockTimeAvg: string | null
    
    LockTimeMax: string | null
    
    LockTimeMin: string | null
    
    LockTimeSum: string | null
    
    QueryCount: string | null
    
    QueryTimeAvg: string | null
    
    QueryTimeMax: string | null
    
    QueryTimeMin: string | null
    
    QueryTimeSum: string | null
    
    RowsExaminedSum: string | null
    
    RowsSentSum: string | null
...
class DescribeDBLogFilesResponse extends AbstractModel {
    ...
    Files: Array<LogFileInfo> | null
    
    VpcPrefix: string | null
...
class DescribeSqlLogsResponse extends AbstractModel {
    ...
    SqlItems: Array<SqlLogItem> | null
...
class InstanceSpec extends AbstractModel {
    ...
    SpecInfos: Array<SpecConfigInfo> | null
...
class RegionInfo extends AbstractModel {
    ...
    ZoneList: Array<ZonesInfo> | null
    
    AvailableChoice: Array<ZoneChooseInfo> | null
...
class DescribeDBInstancesResponse extends AbstractModel {
    ...
    Instances: Array<DBInstance> | null
...
class DescribeDBPerformanceDetailsResponse extends AbstractModel {
    ...
    Master: PerformanceMonitorSet | null
    
    Slave1: PerformanceMonitorSet | null
    
    Slave2: PerformanceMonitorSet | null
...
class SqlLogItem extends AbstractModel {
    ...
    SelectRowNum: number | null
    
    AffectRowNum: number | null
...
class DescribeDBSlowLogsResponse extends AbstractModel {
    ...
    Data: Array<SlowLogData> | null
    
    LockTimeSum: number | null
    
    QueryCount: number | null
    
    Total: number | null
    
    QueryTimeSum: number | null
