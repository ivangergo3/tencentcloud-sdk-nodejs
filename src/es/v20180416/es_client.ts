...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DescribeInstanceOperations(req: any, cb: any): void {
     ...
     * @public
     */
    UpdatePlugins(req: any, cb: any): void {
     ...
     * @public
     */
    UpgradeLicense(req: any, cb: any): void {
...
以上参数组合只能传递一种，多传或少传均会导致请求失败
     ...
     * @public
     */
    UpdateInstance(req: any, cb: any): void {
     ...
     * @public
     */
    RestartInstance(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeInstanceLogs(req: any, cb: any): void {
