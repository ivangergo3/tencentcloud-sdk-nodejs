...
export class Client extends AbstractClient {
     ...
     * @public
     */
    EnhanceTaDegree(req: any, cb: any): void {
     ...
     * @public
     */
    RecognizeTargetAudience(req: any, cb: any): void {
     ...
     * @public
     */
    RecognizeCustomizedAudience(req: any, cb: any): void {
     ...
     * @public
     */
    DetectFraudKOL(req: any, cb: any): void {
     ...
     * @public
     */
    RecognizePreciseTargetAudience(req: any, cb: any): void {
     ...
     * @public
     */
    SendTrafficSecuritySmsMessage(req: any, cb: any): void {
