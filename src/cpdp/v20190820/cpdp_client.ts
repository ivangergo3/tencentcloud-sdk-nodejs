...
export class Client extends AbstractClient {
     ...
     * @public
     */
    QueryMemberTransaction(req: any, cb: any): void {
     ...
     * @public
     */
    QuerySinglePay(req: any, cb: any): void {
     ...
     * @public
     */
    QueryPayerInfo(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeOrderStatus(req: any, cb: any): void {
     ...
     * @public
     */
    QueryAnchorContractInfo(req: any, cb: any): void {
...
来账鉴权：该接口发起成功后，银行以短信通知客户查看，客户查看后，需通过待绑定的账户往市场的监管账户转入短信上指定的金额。银行检索到该笔指定金额的来账是源自待绑定账户，则绑定成功。平安银行的账户，即BankType送1时，大小额行号和超级网银号都不用送。
     ...
     * @public
     */
    BindRelateAcctSmallAmount(req: any, cb: any): void {
     ...
     * @public
     */
    ApplyWithdrawal(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAgentTaxPaymentInfo(req: any, cb: any): void {
...
查询标志为“全部会员”的情况下，返回市场下的全部的有效的绑定账户信息。查询标志为“单个会员的证件信息”的情况下，返回市场下的指定的会员的留存在电商见证宝系统的证件信息。
     ...
     * @public
     */
    QueryMemberBind(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyMntMbrBindRelateAcctBankCode(req: any, cb: any): void {
     ...
     * @public
     */
    CreateSinglePay(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeChargeDetail(req: any, cb: any): void {
     ...
     * @public
     */
    RegisterBillSupportWithdraw(req: any, cb: any): void {
...
平台需保存银行返回的子账户账号，后续交易接口都会用到。会员属性字段为预留扩展字段，当前必须送默认值。
     ...
     * @public
     */
    CreateCustAcctId(req: any, cb: any): void {
     ...
     * @public
     */
    WithdrawCashMembership(req: any, cb: any): void {
     ...
     * @public
     */
    CloseOrder(req: any, cb: any): void {
     ...
     * @public
     */
    QueryExchangeRate(req: any, cb: any): void {
     ...
     * @public
     */
    QueryMerchantInfoForManagement(req: any, cb: any): void {
     ...
     * @public
     */
    ReviseMbrProperty(req: any, cb: any): void {
     ...
     * @public
     */
    QueryBalance(req: any, cb: any): void {
     ...
     * @public
     */
    RevokeRechargeByThirdPay(req: any, cb: any): void {
     ...
     * @public
     */
    QueryAgentTaxPaymentBatch(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAgentTaxPaymentInfo(req: any, cb: any): void {
...
大小额联行号：单笔转账可超过5万，需具体到支行，不能实时知道对方是否收款成功。金额超过5万的，在工作日的8点30-17点间才会成功。
     ...
     * @public
     */
    BindRelateAcctUnionPay(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAgentTaxPaymentInfos(req: any, cb: any): void {
     ...
     * @public
     */
    UnbindRelateAcct(req: any, cb: any): void {
     ...
     * @public
     */
    QueryApplicationMaterial(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAgentTaxPaymentInfos(req: any, cb: any): void {
     ...
     * @public
     */
    QueryCommonTransferRecharge(req: any, cb: any): void {
     ...
     * @public
     */
    DownloadBill(req: any, cb: any): void {
     ...
     * @public
     */
    QueryAcctBinding(req: any, cb: any): void {
     ...
     * @public
     */
    QueryOrder(req: any, cb: any): void {
     ...
     * @public
     */
    CreateInvoice(req: any, cb: any): void {
     ...
     * @public
     */
    ApplyReWithdrawal(req: any, cb: any): void {
     ...
     * @public
     */
    ApplyPayerInfo(req: any, cb: any): void {
     ...
     * @public
     */
    QueryMerchantBalance(req: any, cb: any): void {
     ...
     * @public
     */
    QueryTrade(req: any, cb: any): void {
     ...
     * @public
     */
    RefundMemberTransaction(req: any, cb: any): void {
     ...
     * @public
     */
    ApplyTrade(req: any, cb: any): void {
     ...
     * @public
     */
    QueryBankClear(req: any, cb: any): void {
     ...
     * @public
     */
    QuerySingleTransactionStatus(req: any, cb: any): void {
     ...
     * @public
     */
    QueryAgentStatements(req: any, cb: any): void {
     ...
     * @public
     */
    BindRelateAccReUnionPay(req: any, cb: any): void {
     ...
     * @public
     */
    CreateRedInvoice(req: any, cb: any): void {
     ...
     * @public
     */
    MigrateOrderRefundQuery(req: any, cb: any): void {
     ...
     * @public
     */
    CheckAmount(req: any, cb: any): void {
     ...
     * @public
     */
    RevResigterBillSupportWithdraw(req: any, cb: any): void {
     ...
     * @public
     */
    RevokeMemberRechargeThirdPay(req: any, cb: any): void {
     ...
     * @public
     */
    QueryBankTransactionDetails(req: any, cb: any): void {
     ...
     * @public
     */
    ApplyApplicationMaterial(req: any, cb: any): void {
     ...
     * @public
     */
    ApplyOutwardOrder(req: any, cb: any): void {
     ...
     * @public
     */
    QueryCustAcctIdBalance(req: any, cb: any): void {
     ...
     * @public
     */
    QuerySmallAmountTransfer(req: any, cb: any): void {
     ...
     * @public
     */
    MigrateOrderRefund(req: any, cb: any): void {
     ...
     * @public
     */
    RechargeByThirdPay(req: any, cb: any): void {
     ...
     * @public
     */
    RechargeMemberThirdPay(req: any, cb: any): void {
     ...
     * @public
     */
    QueryInvoice(req: any, cb: any): void {
     ...
     * @public
     */
    CreateMerchant(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAcct(req: any, cb: any): void {
     ...
     * @public
     */
    UnifiedOrder(req: any, cb: any): void {
     ...
     * @public
     */
    RegisterBill(req: any, cb: any): void {
     ...
     * @public
     */
    QueryAcctInfo(req: any, cb: any): void {
     ...
     * @public
     */
    ExecuteMemberTransaction(req: any, cb: any): void {
     ...
     * @public
     */
    QueryOutwardOrder(req: any, cb: any): void {
     ...
     * @public
     */
    UnBindAcct(req: any, cb: any): void {
     ...
     * @public
     */
    QueryBankWithdrawCashDetails(req: any, cb: any): void {
     ...
     * @public
     */
    QueryAcctInfoList(req: any, cb: any): void {
     ...
     * @public
     */
    QueryReconciliationDocument(req: any, cb: any): void {
     ...
     * @public
     */
    QueryRefund(req: any, cb: any): void {
