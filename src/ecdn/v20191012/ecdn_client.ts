...
export class Client extends AbstractClient {
     ...
     * @public
     */
    AddEcdnDomain(req: any, cb: any): void {
     ...
     * @public
     */
    StartEcdnDomain(req: any, cb: any): void {
...
注意：如果需要更新复杂类型的配置项，必须传递整个对象的所有属性，未传递的属性将使用默认值。建议通过查询接口获取配置属性后，直接修改后传递给本接口。Https配置由于证书的特殊性，更新时不用传递证书和密钥字段。
     ...
     * @public
     */
    DescribeEcdnDomainLogs(req: any, cb: any): void {
     ...
     * @public
     */
    StopEcdnDomain(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteEcdnDomain(req: any, cb: any): void {
...
+ 状态码 5xx 汇总及各 5 开头状态码明细（单位为 个）
     ...
     * @public
     */
    DescribeEcdnStatistics(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeEcdnDomainStatistics(req: any, cb: any): void {
