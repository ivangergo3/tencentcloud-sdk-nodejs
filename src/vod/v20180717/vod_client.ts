...
export class Client extends AbstractClient {
     ...
     * @public
     */
    CreateSnapshotByTimeOffsetTemplate(req: any, cb: any): void {
...
* 上传流程请参考 [服务端上传综述](/document/product/266/9759)。
     ...
     * @public
     */
    ApplyUpload(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAnimatedGraphicsTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAIAnalysisTemplates(req: any, cb: any): void {
...
* 若该接口有事件返回，调用方必须在<font color="red">30秒</font>内调用 [确认事件通知](https://cloud.tencent.com/document/product/266/33434) 接口，确认事件通知已经处理，否则该事件通知在<font color="red">30秒</font>后会再次被拉取到。
     ...
     * @public
     */
    PullEvents(req: any, cb: any): void {
...
如使用事件通知，事件通知的类型为 [任务流状态变更](https://cloud.tencent.com/document/product/266/9636)。
     ...
     * @public
     */
    ProcessMediaByProcedure(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteTranscodeTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTaskDetail(req: any, cb: any): void {
...
2. 查询时间跨度不超过90天。
     ...
     * @public
     */
    DescribeReviewDetails(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeWordSamples(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeStorageData(req: any, cb: any): void {
...
注意：模板 ID 10000 以下的为系统预置模板，不允许修改。
     ...
     * @public
     */
    ModifyAIAnalysisTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteProcedureTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAdaptiveDynamicStreamingTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAdaptiveDynamicStreamingTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSampleSnapshotTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteSnapshotByTimeOffsetTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyClass(req: any, cb: any): void {
...
* 只能查询到最近三天（72 小时）内的任务。
     ...
     * @public
     */
    ResetProcedureTemplate(req: any, cb: any): void {
   ...
   4.  流量为查询时间粒度内的总流量，带宽为查询时间粒度内的峰值带宽。
     ...
     * @public
     */
    DescribeCDNUsageData(req: any, cb: any): void {
     ...
     * @public
     */
    CreateTranscodeTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyImageSpriteTemplate(req: any, cb: any): void {
...
* 否则，请先执行[删除媒体](/document/product/266/31764)及子分类，再删除该分类；
     ...
     * @public
     */
    DeleteClass(req: any, cb: any): void {
     ...
     * @public
     */
    ExecuteFunction(req: any, cb: any): void {
   ...
   2. 查询时间跨度不超过90天。
     ...
     * @public
     */
    DescribeMediaProcessUsageData(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSnapshotByTimeOffsetTemplates(req: any, cb: any): void {
...
如使用事件通知，事件通知的类型为 [视频合成完成](https://cloud.tencent.com/document/product/266/43000)。
     ...
     * @public
     */
    ComposeMedia(req: any, cb: any): void {
     ...
     * @public
     */
    CreateContentReviewTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    CreateSampleSnapshotTemplate(req: any, cb: any): void {
...
注意：模板 ID 为 10000 以下的为系统预置模板，不允许删除。
     ...
     * @public
     */
    DeleteAIAnalysisTemplate(req: any, cb: any): void {
...
2. 可以指定回包只返回部分信息。
     ...
     * @public
     */
    DescribeMediaInfos(req: any, cb: any): void {
...
剪辑不固化的优势在于其剪辑操作十分“轻量化”，不会产生额外的存储开销。但其不足之处在于生命周期与原始录制视频相同，且无法进一步进行转码等视频处理。
     ...
     * @public
     */
    LiveRealTimeClip(req: any, cb: any): void {
     ...
     * @public
     */
    PullUpload(req: any, cb: any): void {
     ...
     * @public
     */
    ModifySampleSnapshotTemplate(req: any, cb: any): void {
...
*注：系统预置播放器配置不允许删除。*
     ...
     * @public
     */
    DeleteSuperPlayerConfig(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeProcedureTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTranscodeTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    ParseStreamingManifest(req: any, cb: any): void {
     ...
     * @public
     */
    CreateProcedureTemplate(req: any, cb: any): void {
...
3. 单次请求最多指定20个 URL。
     ...
     * @public
     */
    PushUrlCache(req: any, cb: any): void {
...
* 可单独删除指定 ID 的视频文件下的转码，或者微信发布文件；
     ...
     * @public
     */
    DeleteMedia(req: any, cb: any): void {
     ...
     * @public
     */
    CreateSuperPlayerConfig(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyPersonSample(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteContentReviewTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAIAnalysisTemplate(req: any, cb: any): void {
...
* 更多参考事件通知的[可靠回调](https://cloud.tencent.com/document/product/266/33779#.E5.8F.AF.E9.9D.A0.E5.9B.9E.E8.B0.83)。
     ...
     * @public
     */
    ConfirmEvents(req: any, cb: any): void {
...
如使用事件通知，事件通知的类型为 [任务流状态变更](https://cloud.tencent.com/document/product/266/9636)。
     ...
     * @public
     */
    ProcessMediaByUrl(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyTranscodeTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeContentReviewTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyWatermarkTemplate(req: any, cb: any): void {
   ...
   4. 小时粒度查询跨度不超过10天。
     ...
     * @public
     */
    DescribeStorageDetails(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteWordSamples(req: any, cb: any): void {
     ...
     * @public
     */
    ModifySubAppIdInfo(req: any, cb: any): void {
     ...
     * @public
     */
    CreateImageSpriteTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePersonSamples(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAIRecognitionTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    CreateSubAppId(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAnimatedGraphicsTemplates(req: any, cb: any): void {
  ...
  禁播/解禁操作全网生效时间约 5~10 分钟。
     ...
     * @public
     */
    ForbidMediaDistribution(req: any, cb: any): void {
     ...
     * @public
     */
    ModifySnapshotByTimeOffsetTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    ModifySuperPlayerConfig(req: any, cb: any): void {
...
* 每个分类的子类数量不可超过 500 个。
     ...
     * @public
     */
    CreateClass(req: any, cb: any): void {
     ...
     * @public
     */
    CreateWordSamples(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAdaptiveDynamicStreamingTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyWordSample(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeImageSpriteTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAllClass(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeWatermarkTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    CreateWatermarkTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAIRecognitionTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAIRecognitionTemplate(req: any, cb: any): void {
 ...
 FailedOperation。
     ...
     * @public
     */
    DescribeSubAppIds(req: any, cb: any): void {
     ...
     * @public
     */
    CommitUpload(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAIRecognitionTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAdaptiveDynamicStreamingTemplate(req: any, cb: any): void {
...
- <b>最大支持返回5000条搜索结果，超出部分不再支持查询。如果搜索结果量太大，建议使用更精细的筛选条件来减少搜索结果。</b>
     ...
     * @public
     */
    SearchMedia(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteWatermarkTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DeletePersonSample(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAnimatedGraphicsTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAnimatedGraphicsTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteSampleSnapshotTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    WeChatMiniProgramPublish(req: any, cb: any): void {
...
注意：裁剪出来的视频与原始视频共用 ts，仅生成新的 m3u8。原始视频删除后，该裁剪视频也会被删除。
     ...
     * @public
     */
    SimpleHlsClip(req: any, cb: any): void {
     ...
     * @public
     */
    CreatePersonSample(req: any, cb: any): void {
     ...
     * @public
     */
    ModifySubAppIdStatus(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyContentReviewTemplate(req: any, cb: any): void {
...
如使用事件通知，事件通知的类型为 [任务流状态变更](https://cloud.tencent.com/document/product/266/9636)。
     ...
     * @public
     */
    ProcessMedia(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSuperPlayerConfigs(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyMediaInfo(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteImageSpriteTemplate(req: any, cb: any): void {
