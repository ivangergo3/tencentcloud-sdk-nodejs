...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DescribeDict(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeEntity(req: any, cb: any): void {
     ...
     * @public
     */
    SearchWordItems(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteWordItems(req: any, cb: any): void {
     ...
     * @public
     */
    UpdateDict(req: any, cb: any): void {
     ...
     * @public
     */
    DependencyParsing(req: any, cb: any): void {
...
https://ai.tencent.com/ailab/nlp/zh/embedding.html
     ...
     * @public
     */
    WordEmbedding(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDicts(req: any, cb: any): void {
     ...
     * @public
     */
    CreateDict(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRelation(req: any, cb: any): void {
...
更多垂直领域的分类体系即将推出，敬请期待。
     ...
     * @public
     */
    TextClassification(req: any, cb: any): void {
     ...
     * @public
     */
    WordSimilarity(req: any, cb: any): void {
...
该句向量服务由腾讯云自然语言处理团队联合微信智言团队共同打造，基于千亿级大规模互联网语料并采用Bert等领先的深度神经网络模型训练而成，在腾讯内部诸多业务的NLP任务上实测效果显著。
     ...
     * @public
     */
    SentenceEmbedding(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeWordItems(req: any, cb: any): void {
...
此功能是基于千亿级大规模互联网语料和LSTM、BERT等深度神经网络模型进行训练，并持续迭代更新，以保证效果不断提升，是搜索引擎、语音识别、内容审核等功能更好运行的基础之一。 
     ...
     * @public
     */
    TextCorrection(req: any, cb: any): void {
     ...
     * @public
     */
    CreateWordItems(req: any, cb: any): void {
...
鉴于句子相似度是一个应用非常广泛的功能，腾讯云自然语言处理团队在Bert等领先的深度神经网络模型的基础上，专门针对文本相似任务进行了优化，并持续迭代更新。基于句子相似度，可以轻松实现诸如文本去重、相似推荐等功能。
     ...
     * @public
     */
    TextSimilarity(req: any, cb: any): void {
...
该功能基于千亿级大规模互联网语料和LSTM、BERT等深度神经网络模型进行训练，并持续迭代更新，以保证效果不断提升。
     ...
     * @public
     */
    SentimentAnalysis(req: any, cb: any): void {
...
所有的功能均基于千亿级大规模互联网语料进行持续迭代更新，以保证效果不断提升，用户无需担心新词发现、歧义消除、调用性能等问题。目前词法分析已经在泛互联网、金融、政务等不同垂直领域提供业务支持，并取得良好的效果。
     ...
     * @public
     */
    LexicalAnalysis(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTriple(req: any, cb: any): void {
     ...
     * @public
     */
    KeywordsExtraction(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteDict(req: any, cb: any): void {
     ...
     * @public
     */
    SimilarWords(req: any, cb: any): void {
     ...
     * @public
     */
    AutoSummarization(req: any, cb: any): void {
