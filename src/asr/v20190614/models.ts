...
class GetAsrVocabResponse extends AbstractModel {
    ...
    WordWeights: Array<HotWord> | null
...
class CreateRecTaskRequest extends AbstractModel {
    ...
    EngineModelType: string | null
    
    ChannelNum: number | null
    
    ResTextFormat: number | null
    ...
    FilterDirty: number | null
    
    FilterModal: number | null
    
    ConvertNumMode: number | null
    
    Extra: string | null
    
    SpeakerDiarization: number | null
    
    SpeakerNumber: number | null
    
    FilterPunc: number | null
...
class SentenceDetail extends AbstractModel {
    ...
    Words: Array<SentenceWords> | null
...
class TaskStatus extends AbstractModel {
    ...
    ResultDetail: Array<SentenceDetail> | null
...
class SentenceRecognitionRequest extends AbstractModel {
    ...
    EngSerViceType: string | null
    
    SourceType: number | null
    
    VoiceFormat: string | null
    
    UsrAudioKey: string | null
