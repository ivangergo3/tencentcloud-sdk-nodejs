...
export class Client extends AbstractClient {
     ...
     * @public
     */
    GetAsrVocabList(req: any, cb: any): void {
...
<br>• 支持回调或轮询的方式获取结果，结果获取请参考[ 录音文件识别结果查询](https://cloud.tencent.com/document/product/1093/37822)。
     ...
     * @public
     */
    CreateRecTask(req: any, cb: any): void {
     ...
     * @public
     */
    GetAsrVocab(req: any, cb: any): void {
...
<br>• 当采用轮询方式时，需要主动提交任务ID来轮询识别结果，共有任务成功、等待、执行中和失败四种结果，具体信息请参见下文说明。
     ...
     * @public
     */
    SetVocabState(req: any, cb: any): void {
     ...
     * @public
     */
    UpdateAsrVocab(req: any, cb: any): void {
...
<br>•   热词权重取值范围为[1,10]之间的整数，权重越大代表该词被识别出来的概率越大。
     ...
     * @public
     */
    CreateAsrVocab(req: any, cb: any): void {
     ...
     * @public
     */
    DownloadAsrVocab(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAsrVocab(req: any, cb: any): void {
...
<br>•   所有请求参数放在POST请求的body中，编码类型采用x-www-form-urlencoded，参数进行urlencode编码后传输。
     ...
     * @public
     */
    SentenceRecognition(req: any, cb: any): void {
