...
API 网关使用的最大单元为服务，每个服务中可创建多个 API 接口。每个服务有一个默认域名供客户调用，用户也可绑定自定义域名到此服务中。
     ...
     * @public
     */
    DescribeUsagePlansStatus(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteUsagePlan(req: any, cb: any): void {
...
如果当前环境没有发布，不允许进行此操作。
     ...
     * @public
     */
    DemoteServiceUsagePlan(req: any, cb: any): void {
...
当用户创建了多个密钥对时，可使用本接口查询一个或多个 API 密钥信息，本接口不会显示密钥 Key。
     ...
     * @public
     */
    DescribeApiKeysStatus(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyApiEnvironmentStrategy(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyUsagePlan(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLogSearch(req: any, cb: any): void {
...
在 API 网关中，一个使用计划可绑定多个密钥对，可使用本接口查询使用计划绑定的密钥列表。
     ...
     * @public
     */
    DescribeUsagePlanSecretIds(req: any, cb: any): void {
...
API 网关可绑定自定义域名到服务，用于服务调用。此接口用于查询用户绑定在服务的自定义域名列表。
     ...
     * @public
     */
    DescribeServiceSubDomains(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyIPStrategy(req: any, cb: any): void {
     ...
     * @public
     */
    UnBindIPStrategy(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeIPStrategyApisStatus(req: any, cb: any): void {
...
用户发布服务到某个环境后，此服务中的 API 方可被调用者进行调用，当用户需要将此服务从发布环境中下线时，可调用此 API。下线后的服务不可被调用。
     ...
     * @public
     */
    UnReleaseService(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyApiIncrement(req: any, cb: any): void {
...
用户在创建好服务后需要发布到某个环境中才能进行使用，本接口用于查询一个服务某个环境的发布记录。
     ...
     * @public
     */
    DescribeServiceEnvironmentReleaseHistory(req: any, cb: any): void {
...
服务若需要鉴权限流生效，则需要绑定使用计划到此服务中，本接口用于查询绑定到一个服务及其中 API 的所有使用计划。
     ...
     * @public
     */
    DescribeApiUsagePlan(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeIPStrategysStatus(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeServiceEnvironmentList(req: any, cb: any): void {
...
服务若需要鉴权限流生效，则需要绑定使用计划到此服务中，本接口用于查询绑定到一个服务的所有使用计划。
     ...
     * @public
     */
    DescribeServiceUsagePlan(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyServiceEnvironmentStrategy(req: any, cb: any): void {
...
用户在使用 API 网关时，需要创建使用计划并将其绑定到服务的环境中使用。
     ...
     * @public
     */
    CreateUsagePlan(req: any, cb: any): void {
     ...
     * @public
     */
    UpdateApiKey(req: any, cb: any): void {
...
API 网关可绑定自定义域名到服务，并且可以对自定义域名的路径进行映射，可自定义不同的路径映射到服务中的三个环境，本接口用于查询绑定服务的自定义域名的路径映射列表。
     ...
     * @public
     */
    DescribeServiceSubDomainMappings(req: any, cb: any): void {
...
目前支持绑定使用计划到API，但是同一个服务不能同时存在绑定到服务的使用计划和绑定到API的使用计划，所以对已经绑定过服务级别使用计划的环境，请先使用 服务级别使用计划降级 接口进行降级操作。
     ...
     * @public
     */
    BindEnvironment(req: any, cb: any): void {
     ...
     * @public
     */
    UnBindSecretIds(req: any, cb: any): void {
     ...
     * @public
     */
    BindIPStrategy(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeServicesStatus(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeIPStrategy(req: any, cb: any): void {
...
用户在绑定了某个使用计划到环境后，可使用本接口查询这个使用计划绑定的所有服务的环境。
     ...
     * @public
     */
    DescribeUsagePlanEnvironments(req: any, cb: any): void {
     ...
     * @public
     */
    EnableApiKey(req: any, cb: any): void {
     ...
     * @public
     */
    CreateIPStrategy(req: any, cb: any): void {
...
用户在发布服务时，常有多个版本发布，可使用本接口查询已发布的版本。
     ...
     * @public
     */
    DescribeServiceReleaseVersion(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeApisStatus(req: any, cb: any): void {
     ...
     * @public
     */
    CreateApiKey(req: any, cb: any): void {
     ...
     * @public
     */
    ModifySubDomain(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteIPStrategy(req: any, cb: any): void {
...
API 网关的服务创建后，需要发布到某个环境方生效后，使用者才能进行调用，此接口用于发布服务到环境，如 release 环境。
     ...
     * @public
     */
    ReleaseService(req: any, cb: any): void {
     ...
     * @public
     */
    DisableApiKey(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyService(req: any, cb: any): void {
     ...
     * @public
     */
    UnBindEnvironment(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeApiEnvironmentStrategy(req: any, cb: any): void {
...
将密钥绑定到某个使用计划，并将此使用计划绑定到某个服务发布的环境上，调用者方可使用此密钥调用这个服务中的 API，可使用本接口为使用计划绑定密钥。
     ...
     * @public
     */
    BindSecretIds(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeServiceEnvironmentStrategy(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeService(req: any, cb: any): void {
...
当用户使用自定义域名，并使用了自定义映射时，可使用此接口。但需注意，若删除了所有环境的映射时，调用此 API 均会返回失败。
     ...
     * @public
     */
    DeleteServiceSubDomainMapping(req: any, cb: any): void {
...
用户在创建密钥后，可用此接口查询一个 API 密钥的详情，该接口会显示密钥 Key。
     ...
     * @public
     */
    DescribeApiKey(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeUsagePlan(req: any, cb: any): void {
...
用户使用 API 网关绑定了自定义域名到服务中后，若想要解绑此自定义域名，可使用此接口。
     ...
     * @public
     */
    UnBindSubDomain(req: any, cb: any): void {
...
API 网关中每个服务都会提供一个默认的域名供用户调用，但当用户想使用自己的已有域名时，也可以将自定义域名绑定到此服务，在做好备案、与默认域名的 CNAME 后，可直接调用自定义域名。
     ...
     * @public
     */
    BindSubDomain(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeApi(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteApiKey(req: any, cb: any): void {
     ...
     * @public
     */
    GenerateApiDocument(req: any, cb: any): void {
