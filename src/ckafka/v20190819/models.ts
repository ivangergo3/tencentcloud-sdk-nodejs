...
class TopicDetail extends AbstractModel {
    ...
    IpWhiteListCount: number | null
    
    ForwardCosBucket: string | null
    
    ForwardStatus: number | null
    
    ForwardInterval: number | null
...
class ConsumerGroup extends AbstractModel {
    ...
    SubscribedInfo: Array<SubscribedInfo> | null
...
class Assignment extends AbstractModel {
    ...
    Topics: Array<GroupInfoTopics> | null
...
class DescribeConsumerGroupResponse extends AbstractModel {
    ...
    Result: ConsumerGroupResponse | null
...
class DescribeInstancesDetailResponse extends AbstractModel {
    ...
    Result: InstanceDetailResponse | null
...
class GroupResponse extends AbstractModel {
    ...
    GroupList: Array<DescribeGroup> | null
...
class DescribeTopicAttributesResponse extends AbstractModel {
    ...
    Result: TopicAttributesResponse | null
...
class ModifyInstanceAttributesConfig extends AbstractModel {
    ...
    AutoCreateTopicEnable: boolean | null
    
    DefaultNumPartitions: number | null
...
class CreateUserResponse extends AbstractModel {
    ...
    Result: JgwOperateResponse | null
...
class GroupOffsetTopic extends AbstractModel {
    ...
    Partitions: Array<GroupOffsetPartition> | null
...
class ConsumerGroupResponse extends AbstractModel {
    ...
    TopicList: Array<ConsumerGroupTopic> | null
    
    GroupList: Array<ConsumerGroup> | null
    
    TotalPartition: number | null
    
    PartitionListForMonitor: Array<Partition> | null
    
    TotalTopic: number | null
    
    TopicListForMonitor: Array<ConsumerGroupTopic> | null
    
    GroupListForMonitor: Array<Group> | null
...
class DescribeGroupInfoResponse extends AbstractModel {
    ...
    Result: Array<GroupInfoResponse> | null
...
class DescribeInstanceAttributesResponse extends AbstractModel {
    ...
    Result: InstanceAttributesResponse | null
...
class TopicDetailResponse extends AbstractModel {
    ...
    TopicList: Array<TopicDetail> | null
...
class ModifyInstanceAttributesRequest extends AbstractModel {
    ...
    MsgRetentionTime: number | null
    
    InstanceName: string | null
    
    Config: ModifyInstanceAttributesConfig | null
...
class InstanceAttributesResponse extends AbstractModel {
    ...
    HealthyMessage: string | null
    
    CreateTime: number | null
    
    MsgRetentionTime: number | null
    
    Config: InstanceConfigDO | null
    
    RemainderPartitions: number | null
    
    RemainderTopics: number | null
    
    CreatedPartitions: number | null
    
    CreatedTopics: number | null
...
class GroupOffsetResponse extends AbstractModel {
    ...
    TopicList: Array<GroupOffsetTopic> | null
...
class InstanceDetailResponse extends AbstractModel {
    ...
    InstanceList: Array<InstanceDetail> | null
...
class GroupInfoResponse extends AbstractModel {
    ...
    Members: Array<GroupInfoMember> | null
...
class TopicAttributesResponse extends AbstractModel {
    ...
    Partitions: Array<TopicPartitionDO> | null
...
class InstanceResponse extends AbstractModel {
    ...
    InstanceList: Array<Instance> | null
...
class DescribeGroupOffsetsResponse extends AbstractModel {
    ...
    Result: GroupOffsetResponse | null
...
class DescribeTopicDetailResponse extends AbstractModel {
    ...
    Result: TopicDetailResponse | null
...
class SubscribedInfo extends AbstractModel {
    ...
    Partition: Array<number> | null
    
    PartitionOffset: Array<PartitionOffset> | null
