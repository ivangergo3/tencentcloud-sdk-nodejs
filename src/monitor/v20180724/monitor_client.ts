...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DescribeProductEventList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAccidentEventList(req: any, cb: any): void {
     ...
     * @public
     */
    UnBindingPolicyObject(req: any, cb: any): void {
     ...
     * @public
     */
    BindingPolicyObject(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAlarmReceivers(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBindingPolicyObjectList(req: any, cb: any): void {
     ...
     * @public
     */
    SendCustomAlarmMsg(req: any, cb: any): void {
     ...
     * @public
     */
    DeletePolicyGroup(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBaseMetrics(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePolicyGroupInfo(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeProductList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePolicyGroupList(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBasicAlarmList(req: any, cb: any): void {
...
若您需要调用的指标、对象较多，可能存在因限频出现拉取失败的情况，建议尽量将请求按时间维度均摊。
     ...
     * @public
     */
    GetMonitorData(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyPolicyGroup(req: any, cb: any): void {
     ...
     * @public
     */
    CreatePolicyGroup(req: any, cb: any): void {
     ...
     * @public
     */
    UnBindingAllPolicyObject(req: any, cb: any): void {
...
同一 IP 指标对的数据需按分钟先后顺序上报。
     ...
     * @public
     */
    PutMonitorData(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePolicyConditionList(req: any, cb: any): void {
