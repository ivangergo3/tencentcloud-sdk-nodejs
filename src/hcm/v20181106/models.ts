...
class EvaluationRequest extends AbstractModel {
    ...
    HcmAppid: string | null
    
    Url: string | null
    
    SupportHorizontalImage: boolean | null
    
    RejectNonArithmeticImage: boolean | null
    
    IsAsync: number | null
    
    EnableDispRelatedVertical: boolean | null
    
    EnableDispMidresult: boolean | null
    
    EnablePdfRecognize: boolean | null
