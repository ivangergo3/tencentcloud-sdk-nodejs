...
**结果查询方式：**图像任务直接返回结果，点播及直播任务通过DescribeAITaskResult查询结果。
     ...
     * @public
     */
    SubmitOpenClassTask(req: any, cb: any): void {
     ...
     * @public
     */
    SubmitCheckAttendanceTaskPlus(req: any, cb: any): void {
     ...
     * @public
     */
    CreateLibrary(req: any, cb: any): void {
     ...
     * @public
     */
    SubmitAudioTask(req: any, cb: any): void {
     ...
     * @public
     */
    CreateFace(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyPerson(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeImageTaskStatistic(req: any, cb: any): void {
     ...
     * @public
     */
    AIAssistant(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyLibrary(req: any, cb: any): void {
...
接口获取生成结果。
     ...
     * @public
     */
    SubmitDoubleVideoHighlights(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePersons(req: any, cb: any): void {
     ...
     * @public
     */
    SubmitConversationTask(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeHighlightResult(req: any, cb: any): void {
...
**结果查询方式：**图像任务直接返回结果，点播及直播任务通过DescribeAITaskResult查询结果。
     ...
     * @public
     */
    SubmitTraditionalClassTask(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAITaskResult(req: any, cb: any): void {
     ...
     * @public
     */
    DeletePerson(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeLibraries(req: any, cb: any): void {
     ...
     * @public
     */
    SubmitHighlights(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeVocabLib(req: any, cb: any): void {
     ...
     * @public
     */
    CreateVocab(req: any, cb: any): void {
...
**结果查询方式：**图像任务直接返回结果，点播及直播任务通过DescribeAITaskResult查询结果。
     ...
     * @public
     */
    SubmitOneByOneClassTask(req: any, cb: any): void {
...
**结果查询方式：**图像任务直接返回结果，点播及直播任务通过DescribeAITaskResult查询结果。
     ...
     * @public
     */
    SubmitPartialBodyClassTask(req: any, cb: any): void {
...
#####子结构PersonInfo
 ...
 | image_url | string | 识别到人脸的事件抓图的下载地址，不长期保存，需要请及时下载 | 
     ...
     * @public
     */
    SubmitCheckAttendanceTask(req: any, cb: any): void {
     ...
     * @public
     */
    CreatePerson(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeConversationTask(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteLibrary(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeImageTask(req: any, cb: any): void {
     ...
     * @public
     */
    SubmitImageTask(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAttendanceResult(req: any, cb: any): void {
     ...
     * @public
     */
    SubmitImageTaskPlus(req: any, cb: any): void {
     ...
     * @public
     */
    CreateVocabLib(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteVocab(req: any, cb: any): void {
...
**结果查询方式：**图像任务直接返回结果，点播及直播任务通过DescribeAITaskResult查询结果。
     ...
     * @public
     */
    SubmitFullBodyClassTask(req: any, cb: any): void {
     ...
     * @public
     */
    CheckFacePhoto(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeVocab(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteVocabLib(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePerson(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteFace(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAudioTask(req: any, cb: any): void {
     ...
     * @public
     */
    TransmitAudioStream(req: any, cb: any): void {
