...
注意：注意：相同用户名，不同Host是不同的账号。
     ...
     * @public
     */
    DescribeDatabaseObjects(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeShardSpec(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDCDBUpgradePrice(req: any, cb: any): void {
...
注意：相同用户名，不同Host是不同的账号。
     ...
     * @public
     */
    DescribeDCDBPrice(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDCDBSaleInfo(req: any, cb: any): void {
     ...
     * @public
     */
    InitDCDBInstances(req: any, cb: any): void {
...
注意：相同用户名，不同Host是不同的账号。
     ...
     * @public
     */
    RenewDCDBInstance(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBSyncMode(req: any, cb: any): void {
     ...
     * @public
     */
    UpgradeDCDBInstance(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyDBSyncMode(req: any, cb: any): void {
...
如果不指定任何筛选条件，则默认返回10条实例记录，单次请求最多支持返回100条实例记录。
     ...
     * @public
     */
    DescribeDCDBInstances(req: any, cb: any): void {
...
注意：相同用户名，不同Host是不同的账号，Readonly属性相同的账号之间才能复制权限。
     ...
     * @public
     */
    DescribeDCDBShards(req: any, cb: any): void {
     ...
     * @public
     */
    CreateDCDBInstance(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDatabaseTable(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDCDBRenewalPrice(req: any, cb: any): void {
