...
class DescribeDbauditInstanceTypeResponse extends AbstractModel {
    ...
    DbauditTypesSet: Array<DbauditTypesInfo> | null
...
class DescribeDbauditInstancesResponse extends AbstractModel {
    ...
    CdsAuditInstanceSet: Array<CdsAuditInstance> | null
...
class DbauditTypesInfo extends AbstractModel {
    ...
    InstanceVersionName: string | null
    
    InstanceVersionKey: string | null
    
    Qps: number | null
    
    MaxInstances: number | null
    
    InsertSpeed: number | null
    
    OnlineStorageCapacity: number | null
    
    ArchivingStorageCapacity: number | null
