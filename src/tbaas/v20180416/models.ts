...
class GetBlockTransactionListForUserResponse extends AbstractModel {
    ...
    TransactionList: Array<TransactionItem> | null
...
class DeployDynamicContractHandlerRequest extends AbstractModel {
    ...
    ByteCodeBin: string | null
    
    ConstructorParams: Array<string> | null
...
class GetClusterSummaryResponse extends AbstractModel {
    ...
    MyChannelCount: number | null
    
    JoinChannelCount: number | null
    
    TotalPeerCount: number | null
    
    MyPeerCount: number | null
    
    OrderCount: number | null
    
    TotalGroupCount: number | null
    
    MyGroupCount: number | null
    
    TotalChaincodeCount: number | null
    
    RecentChaincodeCount: number | null
    
    MyChaincodeCount: number | null
    
    TotalCertCount: number | null
    
    TlsCertCount: number | null
    
    PeerCertCount: number | null
    
    ClientCertCount: number | null
...
class GetInvokeTxResponse extends AbstractModel {
    ...
    TxValidationCode: number | null
    
    TxValidationMsg: string | null
...
class GetTransactionDetailForUserResponse extends AbstractModel {
    ...
    EndorserOrgList: Array<EndorserGroup> | null
...
class EndorserGroup extends AbstractModel {
    ...
    EndorserGroupName: string | null
    
    EndorserPeerList: Array<string> | null
