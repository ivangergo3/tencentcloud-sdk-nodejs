...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DescribeIpStatus(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeMapInfo(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteCdnDomain(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePurgeTasks(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePayType(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDomainsConfig(req: any, cb: any): void {
     ...
     * @public
     */
    AddCdnDomain(req: any, cb: any): void {
...
+ 日活跃用户数：根据日志中客户端 IP，按天粒度去重统计
     ...
     * @public
     */
    DescribeIpVisit(req: any, cb: any): void {
...
+ 状态码 5xx 汇总及各 5 开头状态码明细（单位为 个）
     ...
     * @public
     */
    DescribeCdnData(req: any, cb: any): void {
     ...
     * @public
     */
    DisableCaches(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDomains(req: any, cb: any): void {
     ...
     * @public
     */
    ManageClsTopicDomains(req: any, cb: any): void {
     ...
     * @public
     */
    StartCdnDomain(req: any, cb: any): void {
...
注意：停止加速服务后，访问至加速节点的请求将会直接返回 404。为避免对您的业务造成影响，请在停止加速服务前将解析切走。
     ...
     * @public
     */
    StopCdnDomain(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePurgeQuota(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeImageConfig(req: any, cb: any): void {
     ...
     * @public
     */
    SearchClsLog(req: any, cb: any): void {
...
注意：仅支持 90 天内数据查询
     ...
     * @public
     */
    ListTopData(req: any, cb: any): void {
...
+ 回源状态码 5xx 汇总及各 5 开头回源状态码明细（单位为 个）
     ...
     * @public
     */
    DescribeOriginData(req: any, cb: any): void {
...
（注意：此接口请求频率限制以 CDN 侧限制为准：200次/10分钟）
     ...
     * @public
     */
    DescribeCdnIp(req: any, cb: any): void {
...
默认情况下境内、境外加速区域每日目录刷新额度为各 100 条，每次最多可提交 20 条。
     ...
     * @public
     */
    PurgePathCache(req: any, cb: any): void {
...
对应内容分发网络控制台【图片鉴黄】页面。
     ...
     * @public
     */
    DescribeUrlViolations(req: any, cb: any): void {
...
默认情况下境内、境外加速区域每日 URL 刷新额度各为 10000 条，每次最多可提交 1000 条。
     ...
     * @public
     */
    PurgeUrlsCache(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTrafficPackages(req: any, cb: any): void {
...
注意：如果需要更新复杂类型的配置项，必须传递整个对象的所有属性，未传递的属性将使用默认值，建议通过查询接口获取配置属性后，直接修改后传递给本接口。Https配置由于证书的特殊性，更新时不用传递证书和密钥字段。
     ...
     * @public
     */
    UpdateDomainConfig(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeCdnDomainLogs(req: any, cb: any): void {
...
接口灰度中，暂未全量开放，敬请期待。
     ...
     * @public
     */
    DescribePushTasks(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeCertDomains(req: any, cb: any): void {
     ...
     * @public
     */
    CreateClsLogTopic(req: any, cb: any): void {
...
接口灰度中，暂未全量开放，敬请期待。
     ...
     * @public
     */
    PushUrlsCache(req: any, cb: any): void {
     ...
     * @public
     */
    UpdateImageConfig(req: any, cb: any): void {
     ...
     * @public
     */
    DisableClsLogTopic(req: any, cb: any): void {
     ...
     * @public
     */
    ListClsTopicDomains(req: any, cb: any): void {
     ...
     * @public
     */
    ListClsLogTopics(req: any, cb: any): void {
     ...
     * @public
     */
    GetDisableRecords(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteClsLogTopic(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBillingData(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePushQuota(req: any, cb: any): void {
     ...
     * @public
     */
    EnableClsLogTopic(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeReportData(req: any, cb: any): void {
     ...
     * @public
     */
    UpdatePayType(req: any, cb: any): void {
     ...
     * @public
     */
    EnableCaches(req: any, cb: any): void {
