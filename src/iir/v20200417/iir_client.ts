...
const RecognizeProductResponse = models.RecognizeProductResponse;
const Location = models.Location;
const RecognizeProductRequest = models.RecognizeProductRequest;
...
注意：本文档为公测版本，仅适用于功能体验和测试，正式业务接入请等待正式版。正式版的输入、输出可能会与公测版存在少量差异。
     ...
     * @public
     */
    RecognizeProduct(req: any, cb: any): void {
