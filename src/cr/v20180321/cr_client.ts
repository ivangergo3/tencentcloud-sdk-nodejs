...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DownloadReport(req: any, cb: any): void {
     ...
     * @public
     */
    UploadFile(req: any, cb: any): void {
     ...
     * @public
     */
    UploadDataJson(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRecords(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeCreditResult(req: any, cb: any): void {
     ...
     * @public
     */
    DownloadDialogueText(req: any, cb: any): void {
     ...
     * @public
     */
    UploadDataFile(req: any, cb: any): void {
     ...
     * @public
     */
    QueryInstantData(req: any, cb: any): void {
...
<p>注意：录音清单中的录音下载链接仅次日20:00之前有效，请及时下载。</p>
     ...
     * @public
     */
    DownloadRecordList(req: any, cb: any): void {
     ...
     * @public
     */
    ApplyBlackList(req: any, cb: any): void {
     ...
     * @public
     */
    ApplyCreditAudit(req: any, cb: any): void {
