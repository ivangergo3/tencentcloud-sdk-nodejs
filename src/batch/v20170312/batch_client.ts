...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DescribeComputeEnv(req: any, cb: any): void {
     ...
     * @public
     */
    CreateTaskTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    CreateCpmComputeEnv(req: any, cb: any): void {
...
对于状态为CREATED、CREATION_FAILED、RUNNING和ABNORMAL的节点，允许销毁处理。
     ...
     * @public
     */
    TerminateComputeNode(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeJobs(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAvailableCvmInstanceTypes(req: any, cb: any): void {
...
此接口会将加入到计算环境中的实例重设UserData和重装操作系统。
     ...
     * @public
     */
    CreateComputeEnv(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteComputeEnv(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTaskLogs(req: any, cb: any): void {
...
终止作业是一个异步过程。整个终止过程的耗时和任务总数成正比。终止的效果相当于所含的所有任务实例进行TerminateTaskInstance操作。具体效果和用法可参考TerminateTaskInstance。
     ...
     * @public
     */
    TerminateJob(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeCvmZoneInstanceConfigInfos(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeJob(req: any, cb: any): void {
     ...
     * @public
     */
    TerminateComputeNodes(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTaskTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeInstanceCategories(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteTaskTemplates(req: any, cb: any): void {
...
对于状态为“FAILED_INTERRUPTED”的任务实例，终止操作实际成功之后，相关资源和配额才会释放。
     ...
     * @public
     */
    TerminateTaskInstance(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyComputeEnv(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeJobSubmitInfo(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeComputeEnvCreateInfo(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeComputeEnvActivities(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeComputeEnvCreateInfos(req: any, cb: any): void {
...
待删除的作业必须处于完结状态，且其内部包含的所有任务实例也必须处于完结状态，否则会禁止操作。完结状态，是指处于 SUCCEED 或 FAILED 状态。
     ...
     * @public
     */
    DescribeCpmOsInfo(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeComputeEnvs(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyTaskTemplate(req: any, cb: any): void {
