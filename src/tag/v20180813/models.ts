...
class ModifyResourceTagsRequest extends AbstractModel {
    ...
    ReplaceTags: Array<Tag> | null
    
    DeleteTags: Array<TagKeyObject> | null
...
class TagResource extends AbstractModel {
    ...
    TagKeyMd5: string | null
    
    TagValueMd5: string | null
