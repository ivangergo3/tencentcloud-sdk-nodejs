...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DescribeDBInstanceGTID(req: any, cb: any): void {
     ...
     * @public
     */
    CreateRoInstanceIp(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAuditPolicy(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDataBackupOverview(req: any, cb: any): void {
     ...
     * @public
     */
    BalanceRoGroupLoad(req: any, cb: any): void {
     ...
     * @public
     */
    IsolateDBInstance(req: any, cb: any): void {
...
2、实例状态必须为正常，并且没有其他异步任务在执行中。
     ...
     * @public
     */
    RestartDBInstances(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyInstanceTag(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTimeWindow(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBackupOverview(req: any, cb: any): void {
...
注意，实例下线后，相关资源和数据将无法找回，请谨慎操作。
     ...
     * @public
     */
    OfflineIsolatedInstances(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAuditLogFile(req: any, cb: any): void {
     ...
     * @public
     */
    OpenDBInstanceGTID(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRollbackTaskDetail(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyDBInstanceSecurityGroups(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBackupConfig(req: any, cb: any): void {
     ...
     * @public
     */
    CloseWanService(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDefaultParams(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAuditPolicies(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTagsOfInstanceIds(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeErrorLogData(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTables(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAccountPrivileges(req: any, cb: any): void {
     ...
     * @public
     */
    ReleaseIsolatedDBInstances(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAuditConfig(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyTimeWindow(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteDeployGroups(req: any, cb: any): void {
     ...
     * @public
     */
    SwitchForUpgrade(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteParamTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBackups(req: any, cb: any): void {
     ...
     * @public
     */
    CreateParamTemplate(req: any, cb: any): void {
...
5. 当入参指定 Port，ParamList 或 Password 时，该实例会进行初始化操作；
     ...
     * @public
     */
    CreateDBInstanceHour(req: any, cb: any): void {
     ...
     * @public
     */
    AddTimeWindow(req: any, cb: any): void {
     ...
     * @public
     */
    CreateBackup(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyDBInstanceVipVport(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBInstanceConfig(req: any, cb: any): void {
...
新版本支持(CreateBackup)创建逻辑备份的时候，直接发起指定库表备份，用户直接下载该备份文件即可。
     ...
     * @public
     */
    DescribeBackupTables(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAuditPolicy(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeProjectSecurityGroups(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSlowLogs(req: any, cb: any): void {
     ...
     * @public
     */
    InquiryPriceUpgradeInstances(req: any, cb: any): void {
...
5. 当入参指定 Port，ParamList 或 Password 时，该实例会进行初始化操作；
     ...
     * @public
     */
    CreateDBInstance(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyParamTemplate(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeInstanceParams(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDeployGroupList(req: any, cb: any): void {
     ...
     * @public
     */
    StopDBImportJob(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAccounts(req: any, cb: any): void {
     ...
     * @public
     */
    UpgradeDBInstanceEngineVersion(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAuditLogFiles(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeInstanceParamRecords(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAuditRule(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBackupSummaries(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeParamTemplateInfo(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBinlogBackupOverview(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAccounts(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBInstanceInfo(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRollbackRangeTime(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeParamTemplates(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteBackup(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRoMinScale(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAuditConfig(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyInstanceParam(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAsyncRequestInfo(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBZoneConfig(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBInstanceRebootTime(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyRoGroupInfo(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAuditRule(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBInstanceCharset(req: any, cb: any): void {
...
注意，修改账号权限时，需要传入该账号下的全量权限信息。用户可以先通过 [查询云数据库账户的权限信息
     ...
     * @public
     */
    ModifyAccountPrivileges(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBImportRecords(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBSwitchRecords(req: any, cb: any): void {
...
注意，用户进行数据导入任务的文件，必须提前上传到腾讯云。用户须在控制台进行文件导入。
     ...
     * @public
     */
    CreateDBImportJob(req: any, cb: any): void {
     ...
     * @public
     */
    VerifyRootAccount(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAccountPassword(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeUploadedFiles(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAccountDescription(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSlowLogData(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAuditLogFile(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyBackupConfig(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyDBInstanceProject(req: any, cb: any): void {
...
新版本支持(CreateBackup)创建逻辑备份的时候，直接发起指定库表备份，用户直接下载该备份文件即可。
     ...
     * @public
     */
    DescribeBackupDatabases(req: any, cb: any): void {
...
注意：对某个地域进行询价，请使用对应地域的接入点，接入点信息请参照 <a href="https://cloud.tencent.com/document/api/236/15832">服务地址</a> 文档。例如：对广州地域进行询价，请把请求发到：cdb.ap-guangzhou.tencentcloudapi.com。同理对上海地域询价，把请求发到：cdb.ap-shanghai.tencentcloudapi.com。
     ...
     * @public
     */
    DescribeDBPrice(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAutoRenewFlag(req: any, cb: any): void {
     ...
     * @public
     */
    RenewDBInstance(req: any, cb: any): void {
     ...
     * @public
     */
    StartBatchRollback(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDeviceMonitorInfo(req: any, cb: any): void {
...
注意，实例开通外网访问之前，需要先将实例进行 [实例初始化](https://cloud.tencent.com/document/api/236/15873) 操作。
     ...
     * @public
     */
    OpenWanService(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAuditRule(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAuditRules(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSupportedPrivileges(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBinlogs(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDBSecurityGroups(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRoGroups(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyNameOrDescByDpId(req: any, cb: any): void {
     ...
     * @public
     */
    CreateDeployGroup(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteTimeWindow(req: any, cb: any): void {
