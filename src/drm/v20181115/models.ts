...
class DescribeFairPlayPemResponse extends AbstractModel {
    ...
    FairPlayPems: Array<FairPlayPemDigestInfo> | null
...
class PlaybackPolicy extends AbstractModel {
    ...
    LicenseDurationSeconds: number | null
...
class AddFairPlayPemRequest extends AbstractModel {
    ...
    PemDecryptKey: string | null
    
    BailorId: number | null
...
class StartEncryptionRequest extends AbstractModel {
    ...
    SourceObject: DrmSourceObject | null
    
    OutputObjects: Array<DrmOutputObject> | null
