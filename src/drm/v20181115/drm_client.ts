...
export class Client extends AbstractClient {
     ...
     * @public
     */
    StartEncryption(req: any, cb: any): void {
...
如需使用fairplay方案，请务必先设置私钥。
     ...
     * @public
     */
    AddFairPlayPem(req: any, cb: any): void {
     ...
     * @public
     */
    CreateEncryptKeys(req: any, cb: any): void {
...
开发者需要转发终端设备发出的许可证请求信息。
     ...
     * @public
     */
    CreateLicense(req: any, cb: any): void {
...
如需使用fairplay方案，请务必先设置私钥。
     ...
     * @public
     */
    ModifyFairPlayPem(req: any, cb: any): void {
...
如果加密使用的ContentID没有关联的密钥信息，后台会自动生成新的密钥返回
     ...
     * @public
     */
    DescribeAllKeys(req: any, cb: any): void {
...
由于缓存，删除操作需要约半小时生效
     ...
     * @public
     */
    DeleteFairPlayPem(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeFairPlayPem(req: any, cb: any): void {
