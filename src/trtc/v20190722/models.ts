...
class DescribeAbnormalEventResponse extends AbstractModel {
    ...
    AbnormalExperienceList: Array<AbnormalExperience> | null
...
class LayoutParams extends AbstractModel {
    ...
    MainVideoUserId: string | null
    
    MainVideoStreamType: number | null
    
    SmallVideoLayoutParams: SmallVideoLayoutParams | null
...
class OutputParams extends AbstractModel {
    ...
    PureAudioStream: number | null
    
    RecordId: string | null
    
    RecordAudioOnly: number | null
...
class EventMessage extends AbstractModel {
    ...
    ParamOne: number | null
    
    ParamTwo: number | null
...
class CreateTroubleInfoRequest extends AbstractModel {
    ...
    TroubleUserId: string | null
    
    TroubleType: number | null
    
    TroubleTime: number | null
    
    TroubleMsg: string | null
...
class EventList extends AbstractModel {
    ...
    Content: Array<EventMessage> | null
...
class AbnormalExperience extends AbstractModel {
    ...
    AbnormalEventList: Array<AbnormalEvent> | null
...
class DescribeHistoryScaleResponse extends AbstractModel {
    ...
    ScaleList: Array<ScaleInfomation> | null
