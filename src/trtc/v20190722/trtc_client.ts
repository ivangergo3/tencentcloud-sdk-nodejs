...
export class Client extends AbstractClient {
     ...
     * @public
     */
    RemoveUser(req: any, cb: any): void {
     ...
     * @public
     */
    CreateTroubleInfo(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeHistoryScale(req: any, cb: any): void {
...
- 画中画模板：适用于混合大小两路视频画面和其他用户混音，或者混合一路大画面和其他用户混音的场景。小画面悬浮于大画面之上，可以指定大小画面的用户以及小画面的显示位置。
     ...
     * @public
     */
    StartMCUMixTranscode(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRealtimeScale(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRealtimeNetwork(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRoomInformation(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDetailEvent(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeCallDetail(req: any, cb: any): void {
     ...
     * @public
     */
    StopMCUMixTranscode(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAbnormalEvent(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRealtimeQuality(req: any, cb: any): void {
     ...
     * @public
     */
    DismissRoom(req: any, cb: any): void {
