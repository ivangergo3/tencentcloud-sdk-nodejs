...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    DetectProductBeta(req: any, cb: any): void {
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    RecognizeCar(req: any, cb: any): void {
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    DetectLabel(req: any, cb: any): void {
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    AssessQuality(req: any, cb: any): void {
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    DetectDisgust(req: any, cb: any): void {
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    DetectMisbehavior(req: any, cb: any): void {
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    DetectProduct(req: any, cb: any): void {
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    EnhanceImage(req: any, cb: any): void {
...
- 公共参数中的签名方式必须指定为V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    DetectCelebrity(req: any, cb: any): void {
