...
class DetectProductBetaResponse extends AbstractModel {
    ...
    RegionDetected: Array<RegionDetected> | null
...
class AssessQualityResponse extends AbstractModel {
    ...
    LongImage: boolean | null
    
    BlackAndWhite: boolean | null
    
    SmallImage: boolean | null
    
    BigImage: boolean | null
    
    PureImage: boolean | null
...
class DetectLabelResponse extends AbstractModel {
    ...
    Labels: Array<DetectLabelItem> | null
    
    CameraLabels: Array<DetectLabelItem> | null
    
    AlbumLabels: Array<DetectLabelItem> | null
    
    NewsLabels: Array<DetectLabelItem> | null
...
class Threshold extends AbstractModel {
    ...
    FalseRate1Percent: number | null
    
    FalseRate5Permil: number | null
    
    FalseRate1Permil: number | null
...
class RecognizeCarResponse extends AbstractModel {
    ...
    CarCoords: Array<Coord> | null
    
    CarTags: Array<CarTagItem> | null
