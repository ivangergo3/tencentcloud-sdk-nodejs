...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DescribeVpcResourceDashboard(req: any, cb: any): void {
        const resp = new DescribeVpcResourceDashboardResponse();
     ...
     * @public
     */
    DescribeCcnRegionBandwidthLimits(req: any, cb: any): void {
        const resp = new DescribeCcnRegionBandwidthLimitsResponse();
     ...
     * @public
     */
    DescribeCustomerGateways(req: any, cb: any): void {
...
单个请求中只能替换单个方向的一条规则, 必须要指定索引（PolicyIndex）。
     ...
     * @public
     */
    ReplaceSecurityGroupPolicy(req: any, cb: any): void {
        const resp = new ReplaceSecurityGroupPolicyResponse();
     ...
     * @public
     */
    CreateFlowLog(req: any, cb: any): void {
        const resp = new CreateFlowLogResponse();
     ...
     * @public
     */
    ModifyNatGatewayAttribute(req: any, cb: any): void {
        const resp = new ModifyNatGatewayAttributeResponse();
     ...
     * @public
     */
    DescribeTaskResult(req: any, cb: any): void {
...
* 新建的网络ACL的入站和出站规则默认都是全部拒绝，在创建后通常您需要再调用ModifyNetworkAclEntries将网络ACL的规则设置为需要的规则。
     ...
     * @public
     */
    CreateNetworkAcl(req: any, cb: any): void {
        const resp = new CreateNetworkAclResponse();
     ...
     * @public
     */
    DescribeServiceTemplateGroups(req: any, cb: any): void {
        const resp = new DescribeServiceTemplateGroupsResponse();
     ...
     * @public
     */
    DescribeRouteTables(req: any, cb: any): void {
     ...
     * @public
     */
    CreateBandwidthPackage(req: any, cb: any): void {
        const resp = new CreateBandwidthPackageResponse();
     ...
     * @public
     */
    DeleteFlowLog(req: any, cb: any): void {
        const resp = new DeleteFlowLogResponse();
...
* 创建路由表同时可以绑定标签, 应答里的标签列表代表添加成功的标签。
     ...
     * @public
     */
    CreateRouteTable(req: any, cb: any): void {
        const resp = new CreateRouteTableResponse();
...
* 每个VPC只能申请一个IPv6网段
     ...
     * @public
     */
    AssignIpv6CidrBlock(req: any, cb: any): void {
        const resp = new AssignIpv6CidrBlockResponse();
     ...
     * @public
     */
    DeleteNetworkAcl(req: any, cb: any): void {
        const resp = new DeleteNetworkAclResponse();
     ...
     * @public
     */
    DescribeNatGatewayDestinationIpPortTranslationNatRules(req: any, cb: any): void {
        const resp = new DescribeNatGatewayDestinationIpPortTranslationNatRulesResponse();
     ...
     * @public
     */
    ModifyFlowLogAttribute(req: any, cb: any): void {
        const resp = new ModifyFlowLogAttributeResponse();
     ...
     * @public
     */
    DisassociateNetworkInterfaceSecurityGroups(req: any, cb: any): void {
        const resp = new DisassociateNetworkInterfaceSecurityGroupsResponse();
...
* 每个弹性公网IP支持调整两次，次数超出则无法调整。
     ...
     * @public
     */
    ModifyAddressInternetChargeType(req: any, cb: any): void {
        const resp = new ModifyAddressInternetChargeTypeResponse();
     ...
     * @public
     */
    DescribeCcnAttachedInstances(req: any, cb: any): void {
        const resp = new DescribeCcnAttachedInstancesResponse();
...
注意: 调用本接口是先删除当前路由表中所有路由策略, 再保存新提交的路由策略内容, 会引起网络中断。
     ...
     * @public
     */
    ResetRoutes(req: any, cb: any): void {
        const resp = new ResetRoutesResponse();
     ...
     * @public
     */
    DescribeNetworkInterfaceLimit(req: any, cb: any): void {
        const resp = new DescribeNetworkInterfaceLimitResponse();
     ...
     * @public
     */
    DescribeNetDetects(req: any, cb: any): void {
        const resp = new DescribeNetDetectsResponse();
     ...
     * @public
     */
    ModifyCcnRegionBandwidthLimitsType(req: any, cb: any): void {
        const resp = new ModifyCcnRegionBandwidthLimitsTypeResponse();
...
* 如果网关有流量，但调用本接口没有返回数据，请在控制台对应网关详情页确认是否开启网关流量监控。
     ...
     * @public
     */
    DescribeGatewayFlowMonitorDetail(req: any, cb: any): void {
        const resp = new DescribeGatewayFlowMonitorDetailResponse();
     ...
     * @public
     */
    EnableGatewayFlowMonitor(req: any, cb: any): void {
        const resp = new EnableGatewayFlowMonitorResponse();
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询`QueryTask`接口。
     ...
     * @public
     */
    UnassignIpv6Addresses(req: any, cb: any): void {
        const resp = new UnassignIpv6AddressesResponse();
     ...
     * @public
     */
    AssociateDirectConnectGatewayNatGateway(req: any, cb: any): void {
        const resp = new AssociateDirectConnectGatewayNatGatewayResponse();
     ...
     * @public
     */
    DeleteVpnConnection(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAddressTemplateGroupAttribute(req: any, cb: any): void {
        const resp = new ModifyAddressTemplateGroupAttributeResponse();
     ...
     * @public
     */
    DescribeCustomerGatewayVendors(req: any, cb: any): void {
        const resp = new DescribeCustomerGatewayVendorsResponse();
...
* 如果参数为空，返回当前用户一定数量（Limit所指定的数量，默认为20）的 EIP。
     ...
     * @public
     */
    DescribeAddresses(req: any, cb: any): void {
...
解关联网络实例后，相应的路由策略会一并删除。
     ...
     * @public
     */
    DetachCcnInstances(req: any, cb: any): void {
        const resp = new DetachCcnInstancesResponse();
     ...
     * @public
     */
    AssociateNatGatewayAddress(req: any, cb: any): void {
        const resp = new AssociateNatGatewayAddressResponse();
     ...
     * @public
     */
    ModifyPrivateIpAddressesAttribute(req: any, cb: any): void {
        const resp = new ModifyPrivateIpAddressesAttributeResponse();
     ...
     * @public
     */
    CreateDirectConnectGatewayCcnRoutes(req: any, cb: any): void {
        const resp = new CreateDirectConnectGatewayCcnRoutesResponse();
     ...
     * @public
     */
    RemoveBandwidthPackageResources(req: any, cb: any): void {
        const resp = new RemoveBandwidthPackageResourcesResponse();
     ...
     * @public
     */
    InquiryPriceRenewVpnGateway(req: any, cb: any): void {
        const resp = new InquiryPriceRenewVpnGatewayResponse();
...
* 在弹性网卡上申请一个到多个辅助内网IP，接口会在弹性网卡所在子网网段内返回指定数量的辅助内网IP。
     ...
     * @public
     */
    AssignPrivateIpAddresses(req: any, cb: any): void {
...
* 创建弹性网卡同时可以绑定标签, 应答里的标签列表代表添加成功的标签。
     ...
     * @public
     */
    CreateAndAttachNetworkInterface(req: any, cb: any): void {
        const resp = new CreateAndAttachNetworkInterfaceResponse();
     ...
     * @public
     */
    DescribeNatGateways(req: any, cb: any): void {
...
* 创建子网同时可以绑定标签, 应答里的标签列表代表添加成功的标签。
     ...
     * @public
     */
    CreateSubnets(req: any, cb: any): void {
        const resp = new CreateSubnetsResponse();
     ...
     * @public
     */
    SetCcnRegionBandwidthLimits(req: any, cb: any): void {
        const resp = new SetCcnRegionBandwidthLimitsResponse();
...
* 一个子网只能关联一个路由表。
     ...
     * @public
     */
    ReplaceRouteTableAssociation(req: any, cb: any): void {
        const resp = new ReplaceRouteTableAssociationResponse();
     ...
     * @public
     */
    DescribeTemplateLimits(req: any, cb: any): void {
        const resp = new DescribeTemplateLimitsResponse();
     ...
     * @public
     */
    CheckNetDetectState(req: any, cb: any): void {
        const resp = new CheckNetDetectStateResponse();
     ...
     * @public
     */
    DescribeDhcpIps(req: any, cb: any): void {
        const resp = new DescribeDhcpIpsResponse();
     ...
     * @public
     */
    InquiryPriceResetVpnGatewayInternetMaxBandwidth(req: any, cb: any): void {
        const resp = new InquiryPriceResetVpnGatewayInternetMaxBandwidthResponse();
     ...
     * @public
     */
    DeleteDirectConnectGatewayCcnRoutes(req: any, cb: any): void {
        const resp = new DeleteDirectConnectGatewayCcnRoutesResponse();
     ...
     * @public
     */
    RejectAttachCcnInstances(req: any, cb: any): void {
        const resp = new RejectAttachCcnInstancesResponse();
     ...
     * @public
     */
    MigrateNetworkInterface(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyAddressesBandwidth(req: any, cb: any): void {
     ...
     * @public
     */
    CreateNatGatewayDestinationIpPortTranslationNatRule(req: any, cb: any): void {
        const resp = new CreateNatGatewayDestinationIpPortTranslationNatRuleResponse();
...
* 创建子网同时可以绑定标签, 应答里的标签列表代表添加成功的标签。
     ...
     * @public
     */
    CreateSubnet(req: any, cb: any): void {
     ...
     * @public
     */
    AllocateIp6AddressesBandwidth(req: any, cb: any): void {
        const resp = new AllocateIp6AddressesBandwidthResponse();
     ...
     * @public
     */
    DeleteDhcpIp(req: any, cb: any): void {
        const resp = new DeleteDhcpIpResponse();
     ...
     * @public
     */
    ModifyAddressTemplateAttribute(req: any, cb: any): void {
        const resp = new ModifyAddressTemplateAttributeResponse();
     ...
     * @public
     */
    AcceptAttachCcnInstances(req: any, cb: any): void {
        const resp = new AcceptAttachCcnInstancesResponse();
     ...
     * @public
     */
    DeleteServiceTemplateGroup(req: any, cb: any): void {
        const resp = new DeleteServiceTemplateGroupResponse();
     ...
     * @public
     */
    DescribeGatewayFlowQos(req: any, cb: any): void {
        const resp = new DescribeGatewayFlowQosResponse();
     ...
     * @public
     */
    DisassociateDirectConnectGatewayNatGateway(req: any, cb: any): void {
        const resp = new DisassociateDirectConnectGatewayNatGatewayResponse();
...
2. 支持过滤查询
     ...
     * @public
     */
    DescribeIp6Translators(req: any, cb: any): void {
        const resp = new DescribeIp6TranslatorsResponse();
     ...
     * @public
     */
    ResetAttachCcnInstances(req: any, cb: any): void {
        const resp = new ResetAttachCcnInstancesResponse();
...
* SecurityGroupPolicySet.Version 用于指定要操作的安全组的版本。传入 Version 版本号若不等于当前安全组的最新版本，将返回失败；若不传 Version 则直接删除指定PolicyIndex的规则。
     ...
     * @public
     */
    DeleteSecurityGroupPolicies(req: any, cb: any): void {
        const resp = new DeleteSecurityGroupPoliciesResponse();
...
* 创建VPC同时可以绑定标签, 应答里的标签列表代表添加成功的标签。
     ...
     * @public
     */
    ModifyIp6Rule(req: any, cb: any): void {
        const resp = new ModifyIp6RuleResponse();
     ...
     * @public
     */
    AddBandwidthPackageResources(req: any, cb: any): void {
        const resp = new AddBandwidthPackageResourcesResponse();
...
* 每个子网只能分配一个IPv6网段。
     ...
     * @public
     */
    AssignIpv6SubnetCidrBlock(req: any, cb: any): void {
        const resp = new AssignIpv6SubnetCidrBlockResponse();
     ...
     * @public
     */
    DescribeVpnGatewayCcnRoutes(req: any, cb: any): void {
        const resp = new DescribeVpnGatewayCcnRoutesResponse();
...
* 一个腾讯云账户在每个地域能申请的 EIP 最大配额有所限制，可参见 [EIP 产品简介](https://cloud.tencent.com/document/product/213/5733)，上述配额可通过 DescribeAddressQuota 接口获取。
     ...
     * @public
     */
    AllocateAddresses(req: any, cb: any): void {
...
* 检测辅助CIDR是否与当前VPC的对等连接，对端VPC下的主CIDR或辅助CIDR存在重叠。
     ...
     * @public
     */
    CheckAssistantCidr(req: any, cb: any): void {
        const resp = new CheckAssistantCidrResponse();
...
只能查询已使用的`IPv6`信息，当查询未使用的IP时，本接口不会报错，但不会出现在返回结果里。
     ...
     * @public
     */
    DescribeVpcIpv6Addresses(req: any, cb: any): void {
        const resp = new DescribeVpcIpv6AddressesResponse();
     ...
     * @public
     */
    DescribeIp6Addresses(req: any, cb: any): void {
        const resp = new DescribeIp6AddressesResponse();
     ...
     * @public
     */
    RenewVpnGateway(req: any, cb: any): void {
        const resp = new RenewVpnGatewayResponse();
     ...
     * @public
     */
    DescribeVpcs(req: any, cb: any): void {
...
每个云联网能够关联的网络实例个数是有限的，详请参考产品文档。如果需要扩充请联系在线客服。
     ...
     * @public
     */
    AttachCcnInstances(req: any, cb: any): void {
        const resp = new AttachCcnInstancesResponse();
...
* 只有状态为 UNBIND 的 EIP 才能够被绑定。
     ...
     * @public
     */
    AssociateAddress(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteCustomerGateway(req: any, cb: any): void {
...
* 删除子网前，请清理该子网下所有资源，包括云服务器、负载均衡、云数据、noSql、弹性网卡等资源。
     ...
     * @public
     */
    DeleteSubnet(req: any, cb: any): void {
...
* 私有网络和基础网络的区别详见vpc产品文档-<a href="https://cloud.tencent.com/document/product/215/30720">私有网络与基础网络</a>。
     ...
     * @public
     */
    AttachClassicLinkVpc(req: any, cb: any): void {
        const resp = new AttachClassicLinkVpcResponse();
     ...
     * @public
     */
    DisassociateNatGatewayAddress(req: any, cb: any): void {
        const resp = new DisassociateNatGatewayAddressResponse();
     ...
     * @public
     */
    DescribeFlowLogs(req: any, cb: any): void {
        const resp = new DescribeFlowLogsResponse();
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询`QueryTask`接口
     ...
     * @public
     */
    DeleteDirectConnectGateway(req: any, cb: any): void {
        const resp = new DeleteDirectConnectGatewayResponse();
     ...
     * @public
     */
    DescribeDirectConnectGatewayCcnRoutes(req: any, cb: any): void {
        const resp = new DescribeDirectConnectGatewayCcnRoutesResponse();
...
* 创建弹性网卡同时可以绑定标签, 应答里的标签列表代表添加成功的标签。
     ...
     * @public
     */
    CreateNetworkInterface(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteBandwidthPackage(req: any, cb: any): void {
        const resp = new DeleteBandwidthPackageResponse();
...
<li>在 SecurityGroupPolicySet 参数中：<ul>
     ...
     * @public
     */
    ModifySecurityGroupPolicies(req: any, cb: any): void {
        const resp = new ModifySecurityGroupPoliciesResponse();
     ...
     * @public
     */
    DescribeNetDetectStates(req: any, cb: any): void {
        const resp = new DescribeNetDetectStatesResponse();
     ...
     * @public
     */
    DescribeCcns(req: any, cb: any): void {
        const resp = new DescribeCcnsResponse();
...
2.  如果IPV6转换实例建立有转换规则，会一并删除。
     ...
     * @public
     */
    DeleteIp6Translators(req: any, cb: any): void {
        const resp = new DeleteIp6TranslatorsResponse();
...
* 删除云联网是不可逆的操作，请谨慎处理。
     ...
     * @public
     */
    DeleteCcn(req: any, cb: any): void {
        const resp = new DeleteCcnResponse();
...
* 若仅传入入站规则，则仅重置原有的入站规则，并导入传入的规则，不影响原有的出站规则（若仅传入出站规则，处理方式类似入站方向）。
     ...
     * @public
     */
    ModifyNetworkAclEntries(req: any, cb: any): void {
        const resp = new ModifyNetworkAclEntriesResponse();
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询`QueryTask`接口
     ...
     * @public
     */
    HaVipDisassociateAddressIp(req: any, cb: any): void {
        const resp = new HaVipDisassociateAddressIpResponse();
     ...
     * @public
     */
    ModifyVpnGatewayCcnRoutes(req: any, cb: any): void {
        const resp = new ModifyVpnGatewayCcnRoutesResponse();
     ...
     * @public
     */
    DetachNetworkInterface(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyServiceTemplateGroupAttribute(req: any, cb: any): void {
        const resp = new ModifyServiceTemplateGroupAttributeResponse();
     ...
     * @public
     */
    DeleteAssistantCidr(req: any, cb: any): void {
        const resp = new DeleteAssistantCidrResponse();
     ...
     * @public
     */
    ModifyDhcpIpAttribute(req: any, cb: any): void {
        const resp = new ModifyDhcpIpAttributeResponse();
...
* 删除指定弹性网卡，弹性网卡必须先和子机解绑才能删除。删除之后弹性网卡上所有内网IP都将被退还。
     ...
     * @public
     */
    DeleteNetworkInterface(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeVpnConnections(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeFlowLog(req: any, cb: any): void {
        const resp = new DescribeFlowLogResponse();
     ...
     * @public
     */
    ModifyGatewayFlowQos(req: any, cb: any): void {
        const resp = new ModifyGatewayFlowQosResponse();
...
删除 NAT 网关后，系统会自动删除路由表中包含此 NAT 网关的路由项，同时也会解绑弹性公网IP（EIP）。
     ...
     * @public
     */
    DeleteNatGateway(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRouteConflicts(req: any, cb: any): void {
        const resp = new DescribeRouteConflictsResponse();
     ...
     * @public
     */
    DisableRoutes(req: any, cb: any): void {
        const resp = new DisableRoutesResponse();
...
* 创建安全组同时可以绑定标签, 应答里的标签列表代表添加成功的标签。
     ...
     * @public
     */
    CreateDefaultSecurityGroup(req: any, cb: any): void {
        const resp = new CreateDefaultSecurityGroupResponse();
...
3. 一个完整的转换规则包括vip6:vport6:protocol:vip:vport，其中vip6:vport6:protocol必须是唯一。
     ...
     * @public
     */
    AddIp6Rules(req: any, cb: any): void {
        const resp = new AddIp6RulesResponse();
     ...
     * @public
     */
    AssociateDhcpIpWithAddressIp(req: any, cb: any): void {
        const resp = new AssociateDhcpIpWithAddressIpResponse();
     ...
     * @public
     */
    DeleteServiceTemplate(req: any, cb: any): void {
        const resp = new DeleteServiceTemplateResponse();
...
* 退还弹性网卡上的辅助内网IP，接口自动解关联弹性公网 IP。不能退还弹性网卡的主内网IP。
     ...
     * @public
     */
    UnassignPrivateIpAddresses(req: any, cb: any): void {
        const resp = new UnassignPrivateIpAddressesResponse();
     ...
     * @public
     */
    DeleteAddressTemplateGroup(req: any, cb: any): void {
        const resp = new DeleteAddressTemplateGroupResponse();
     ...
     * @public
     */
    DescribeCcnRoutes(req: any, cb: any): void {
        const resp = new DescribeCcnRoutesResponse();
     ...
     * @public
     */
    DescribeBandwidthPackageQuota(req: any, cb: any): void {
        const resp = new DescribeBandwidthPackageQuotaResponse();
...
2. 同一个账户在一个地域最多允许创建10个转换实例
     ...
     * @public
     */
    CreateIp6Translators(req: any, cb: any): void {
        const resp = new CreateIp6TranslatorsResponse();
     ...
     * @public
     */
    CreateAssistantCidr(req: any, cb: any): void {
        const resp = new CreateAssistantCidrResponse();
...
您也可以通过 Force 参数，强制返回默认VPC
     ...
     * @public
     */
    CreateDefaultVpc(req: any, cb: any): void {
        const resp = new CreateDefaultVpcResponse();
...
* 弹性网卡绑定的云主机必须是私有网络的，而且云主机所在可用区必须和弹性网卡子网的可用区相同。
     ...
     * @public
     */
    AttachNetworkInterface(req: any, cb: any): void {
     ...
     * @public
     */
    ReplaceDirectConnectGatewayCcnRoutes(req: any, cb: any): void {
        const resp = new ReplaceDirectConnectGatewayCcnRoutesResponse();
     ...
     * @public
     */
    GetCcnRegionBandwidthLimits(req: any, cb: any): void {
        const resp = new GetCcnRegionBandwidthLimitsResponse();
     ...
     * @public
     */
    CreateNatGateway(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteNetDetect(req: any, cb: any): void {
        const resp = new DeleteNetDetectResponse();
     ...
     * @public
     */
    ModifySecurityGroupAttribute(req: any, cb: any): void {
        const resp = new ModifySecurityGroupAttributeResponse();
     ...
     * @public
     */
    DeleteAddressTemplate(req: any, cb: any): void {
        const resp = new DeleteAddressTemplateResponse();
     ...
     * @public
     */
    ModifyAssistantCidr(req: any, cb: any): void {
        const resp = new ModifyAssistantCidrResponse();
     ...
     * @public
     */
    DeleteVpnGateway(req: any, cb: any): void {
     ...
     * @public
     */
    CreateServiceTemplate(req: any, cb: any): void {
        const resp = new CreateServiceTemplateResponse();
     ...
     * @public
     */
    DeleteRoutes(req: any, cb: any): void {
        const resp = new DeleteRoutesResponse();
     ...
     * @public
     */
    ModifyDirectConnectGatewayAttribute(req: any, cb: any): void {
        const resp = new ModifyDirectConnectGatewayAttributeResponse();
     ...
     * @public
     */
    ModifyNetworkInterfaceAttribute(req: any, cb: any): void {
        const resp = new ModifyNetworkInterfaceAttributeResponse();
     ...
     * @public
     */
    ModifySubnetAttribute(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeNetworkInterfaces(req: any, cb: any): void {
     ...
     * @public
     */
    DisableCcnRoutes(req: any, cb: any): void {
        const resp = new DisableCcnRoutesResponse();
     ...
     * @public
     */
    InquiryPriceCreateVpnGateway(req: any, cb: any): void {
        const resp = new InquiryPriceCreateVpnGatewayResponse();
     ...
     * @public
     */
    ResetVpnConnection(req: any, cb: any): void {
     ...
     * @public
     */
    CreateCustomerGateway(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAddressTemplateGroup(req: any, cb: any): void {
        const resp = new CreateAddressTemplateGroupResponse();
     ...
     * @public
     */
    CreateAddressTemplate(req: any, cb: any): void {
        const resp = new CreateAddressTemplateResponse();
...
* 创建安全组同时可以绑定标签, 应答里的标签列表代表添加成功的标签。
     ...
     * @public
     */
    CreateSecurityGroup(req: any, cb: any): void {
     ...
     * @public
     */
    AssociateNetworkAclSubnets(req: any, cb: any): void {
        const resp = new AssociateNetworkAclSubnetsResponse();
     ...
     * @public
     */
    DescribeVpnGateways(req: any, cb: any): void {
     ...
     * @public
     */
    DownloadCustomerGatewayConfiguration(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeVpcInstances(req: any, cb: any): void {
        const resp = new DescribeVpcInstancesResponse();
     ...
     * @public
     */
    DeleteRouteTable(req: any, cb: any): void {
        const resp = new DeleteRouteTableResponse();
     ...
     * @public
     */
    DescribeSecurityGroupLimits(req: any, cb: any): void {
        const resp = new DescribeSecurityGroupLimitsResponse();
...
* EIP 如果被封堵，则不能进行解绑定操作。
     ...
     * @public
     */
    DisassociateAddress(req: any, cb: any): void {
...
只能查询已使用的IP信息，当查询未使用的IP时，本接口不会报错，但不会出现在返回结果里。
     ...
     * @public
     */
    DescribeVpcPrivateIpAddresses(req: any, cb: any): void {
        const resp = new DescribeVpcPrivateIpAddressesResponse();
     ...
     * @public
     */
    ModifyIpv6AddressesAttribute(req: any, cb: any): void {
        const resp = new ModifyIpv6AddressesAttributeResponse();
     ...
     * @public
     */
    DescribeDirectConnectGateways(req: any, cb: any): void {
        const resp = new DescribeDirectConnectGatewaysResponse();
     ...
     * @public
     */
    ModifyIp6Translator(req: any, cb: any): void {
        const resp = new ModifyIp6TranslatorResponse();
     ...
     * @public
     */
    DescribeAccountAttributes(req: any, cb: any): void {
        const resp = new DescribeAccountAttributesResponse();
...
* 在弹性网卡上申请一个到多个辅助`IPv6`地址，接口会在弹性网卡所在子网段内返回指定数量的辅助`IPv6`地址。
     ...
     * @public
     */
    AssignIpv6Addresses(req: any, cb: any): void {
        const resp = new AssignIpv6AddressesResponse();
...
* 迁移前后的弹性网卡必须在同一个子网内。
     ...
     * @public
     */
    MigratePrivateIpAddress(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeServiceTemplates(req: any, cb: any): void {
        const resp = new DescribeServiceTemplatesResponse();
...
网段如果还有IP占用且未回收，则网段无法释放。
     ...
     * @public
     */
    UnassignIpv6CidrBlock(req: any, cb: any): void {
        const resp = new UnassignIpv6CidrBlockResponse();
     ...
     * @public
     */
    ModifyNatGatewayDestinationIpPortTranslationNatRule(req: any, cb: any): void {
        const resp = new ModifyNatGatewayDestinationIpPortTranslationNatRuleResponse();
...
* vpc-max-assistant_cidrs（每个VPC可分配的辅助CIDR数）
     ...
     * @public
     */
    DescribeVpcLimits(req: any, cb: any): void {
        const resp = new DescribeVpcLimitsResponse();
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询`QueryTask`接口
     ...
     * @public
     */
    HaVipAssociateAddressIp(req: any, cb: any): void {
        const resp = new HaVipAssociateAddressIpResponse();
...
2. 支持批量删除同一个转换实例下的多个转换规则
     ...
     * @public
     */
    RemoveIp6Rules(req: any, cb: any): void {
        const resp = new RemoveIp6RulesResponse();
     ...
     * @public
     */
    CheckDefaultSubnet(req: any, cb: any): void {
        const resp = new CheckDefaultSubnetResponse();
     ...
     * @public
     */
    DescribeHaVips(req: any, cb: any): void {
        const resp = new DescribeHaVipsResponse();
     ...
     * @public
     */
    AssociateNetworkInterfaceSecurityGroups(req: any, cb: any): void {
        const resp = new AssociateNetworkInterfaceSecurityGroupsResponse();
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询`QueryTask`接口
     ...
     * @public
     */
    DeleteHaVip(req: any, cb: any): void {
        const resp = new DeleteHaVipResponse();
     ...
     * @public
     */
    ModifyBandwidthPackageAttribute(req: any, cb: any): void {
        const resp = new ModifyBandwidthPackageAttributeResponse();
     ...
     * @public
     */
    DescribeAddressQuota(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyVpnGatewayAttribute(req: any, cb: any): void {
     ...
     * @public
     */
    ResetVpnGatewayInternetMaxBandwidth(req: any, cb: any): void {
        const resp = new ResetVpnGatewayInternetMaxBandwidthResponse();
...
* 删除私有网络是不可逆的操作，请谨慎处理。
     ...
     * @public
     */
    DescribeSubnets(req: any, cb: any): void {
...
每个账号能创建的云联网实例个数是有限的，详请参考产品文档。如果需要扩充请联系在线客服。
     ...
     * @public
     */
    CreateCcn(req: any, cb: any): void {
        const resp = new CreateCcnResponse();
     ...
     * @public
     */
    ModifyCustomerGatewayAttribute(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeNetworkAcls(req: any, cb: any): void {
        const resp = new DescribeNetworkAclsResponse();
     ...
     * @public
     */
    ModifyVpnConnectionAttribute(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSecurityGroups(req: any, cb: any): void {
        const resp = new DescribeSecurityGroupsResponse();
     ...
     * @public
     */
    CreateVpnGateway(req: any, cb: any): void {
        const resp = new CreateVpnGatewayResponse();
     ...
     * @public
     */
    DescribeSecurityGroupPolicies(req: any, cb: any): void {
        const resp = new DescribeSecurityGroupPoliciesResponse();
     ...
     * @public
     */
    DescribeAssistantCidr(req: any, cb: any): void {
        const resp = new DescribeAssistantCidrResponse();
     ...
     * @public
     */
    CreateDirectConnectGateway(req: any, cb: any): void {
        const resp = new CreateDirectConnectGatewayResponse();
     ...
     * @public
     */
    DescribeClassicLinkInstances(req: any, cb: any): void {
        const resp = new DescribeClassicLinkInstancesResponse();
...
* 平台对用户每地域每日解绑 EIP 重新分配普通公网 IP 次数有所限制（可参见 [EIP 产品简介](/document/product/213/1941)）。上述配额可通过 [DescribeAddressQuota](https://cloud.tencent.com/document/api/213/1378) 接口获取。
     ...
     * @public
     */
    TransformAddress(req: any, cb: any): void {
        const resp = new TransformAddressResponse();
...
本接口会校验启用后，是否与已有路由冲突，如果冲突，则无法启用，失败处理。路由冲突时，需要先禁用与之冲突的路由，才能启用该路由。
     ...
     * @public
     */
    EnableRoutes(req: any, cb: any): void {
        const resp = new EnableRoutesResponse();
     ...
     * @public
     */
    DisassociateDhcpIpWithAddressIp(req: any, cb: any): void {
        const resp = new DisassociateDhcpIpWithAddressIpResponse();
     ...
     * @public
     */
    CreateHaVip(req: any, cb: any): void {
        const resp = new CreateHaVipResponse();
     ...
     * @public
     */
    ModifyServiceTemplateAttribute(req: any, cb: any): void {
        const resp = new ModifyServiceTemplateAttributeResponse();
...
* 删除的安全组无法再找回，请谨慎调用。
     ...
     * @public
     */
    DeleteSecurityGroup(req: any, cb: any): void {
        const resp = new DeleteSecurityGroupResponse();
     ...
     * @public
     */
    DisassociateNetworkAclSubnets(req: any, cb: any): void {
        const resp = new DisassociateNetworkAclSubnetsResponse();
...
本接口会校验启用后，是否与已有路由冲突，如果冲突，则无法启用，失败处理。路由冲突时，需要先禁用与之冲突的路由，才能启用该路由。
     ...
     * @public
     */
    EnableCcnRoutes(req: any, cb: any): void {
        const resp = new EnableCcnRoutesResponse();
     ...
     * @public
     */
    ModifyRouteTableAttribute(req: any, cb: any): void {
        const resp = new ModifyRouteTableAttributeResponse();
     ...
     * @public
     */
    ModifyNetDetect(req: any, cb: any): void {
        const resp = new ModifyNetDetectResponse();
     ...
     * @public
     */
    DisableGatewayFlowMonitor(req: any, cb: any): void {
        const resp = new DisableGatewayFlowMonitorResponse();
     ...
     * @public
     */
    DeleteNatGatewayDestinationIpPortTranslationNatRule(req: any, cb: any): void {
        const resp = new DeleteNatGatewayDestinationIpPortTranslationNatRuleResponse();
...
* 向指定路由表批量新增路由策略。
     ...
     * @public
     */
    CreateRoutes(req: any, cb: any): void {
        const resp = new CreateRoutesResponse();
     ...
     * @public
     */
    CreateNetDetect(req: any, cb: any): void {
        const resp = new CreateNetDetectResponse();
     ...
     * @public
     */
    ModifyHaVipAttribute(req: any, cb: any): void {
        const resp = new ModifyHaVipAttributeResponse();
...
* 只有状态为 UNBIND 的 EIP 才能进行释放操作。
     ...
     * @public
     */
    ReleaseAddresses(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBandwidthPackages(req: any, cb: any): void {
        const resp = new DescribeBandwidthPackagesResponse();
     ...
     * @public
     */
    CreateServiceTemplateGroup(req: any, cb: any): void {
        const resp = new CreateServiceTemplateGroupResponse();
     ...
     * @public
     */
    ReleaseIp6AddressesBandwidth(req: any, cb: any): void {
        const resp = new ReleaseIp6AddressesBandwidthResponse();
     ...
     * @public
     */
    CreateDhcpIp(req: any, cb: any): void {
        const resp = new CreateDhcpIpResponse();
     ...
     * @public
     */
    ReplaceRoutes(req: any, cb: any): void {
        const resp = new ReplaceRoutesResponse();
     ...
     * @public
     */
    ModifyCcnAttribute(req: any, cb: any): void {
        const resp = new ModifyCcnAttributeResponse();
     ...
     * @public
     */
    DescribeSecurityGroupReferences(req: any, cb: any): void {
        const resp = new DescribeSecurityGroupReferencesResponse();
     ...
     * @public
     */
    DescribeSecurityGroupAssociationStatistics(req: any, cb: any): void {
        const resp = new DescribeSecurityGroupAssociationStatisticsResponse();
...
子网段如果还有IP占用且未回收，则子网段无法释放。
     ...
     * @public
     */
    UnassignIpv6SubnetCidrBlock(req: any, cb: any): void {
        const resp = new UnassignIpv6SubnetCidrBlockResponse();
     ...
     * @public
     */
    ModifyIp6AddressesBandwidth(req: any, cb: any): void {
        const resp = new ModifyIp6AddressesBandwidthResponse();
     ...
     * @public
     */
    DescribeAddressTemplates(req: any, cb: any): void {
        const resp = new DescribeAddressTemplatesResponse();
     ...
     * @public
     */
    CreateVpnConnection(req: any, cb: any): void {
        const resp = new CreateVpnConnectionResponse();
     ...
     * @public
     */
    ModifyAddressAttribute(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAddressTemplateGroups(req: any, cb: any): void {
        const resp = new DescribeAddressTemplateGroupsResponse();
     ...
     * @public
     */
    DetachClassicLinkVpc(req: any, cb: any): void {
        const resp = new DetachClassicLinkVpcResponse();
     ...
     * @public
     */
    DescribeIp6TranslatorQuota(req: any, cb: any): void {
        const resp = new DescribeIp6TranslatorQuotaResponse();
...
<li>一次请求中只能创建单个方向的规则, 如果需要指定索引（PolicyIndex）参数, 多条规则的索引必须一致。</li>
     ...
     * @public
     */
    CreateSecurityGroupPolicies(req: any, cb: any): void {
        const resp = new CreateSecurityGroupPoliciesResponse();
     ...
     * @public
     */
    ModifyNetworkAclAttribute(req: any, cb: any): void {
        const resp = new ModifyNetworkAclAttributeResponse();
     ...
     * @public
     */
    ResetNatGatewayConnection(req: any, cb: any): void {
        const resp = new ResetNatGatewayConnectionResponse();
     ...
     * @public
     */
    ModifyVpcAttribute(req: any, cb: any): void {
...
* 一次请求中只能创建单个方向的规则, 如果需要指定索引（PolicyIndex）参数, 多条规则的索引必须一致。
     ...
     * @public
     */
    CreateSecurityGroupWithPolicies(req: any, cb: any): void {
        const resp = new CreateSecurityGroupWithPoliciesResponse();
