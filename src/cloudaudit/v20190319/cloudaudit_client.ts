...
export class Client extends AbstractClient {
     ...
     * @public
     */
    StartLogging(req: any, cb: any): void {
     ...
     * @public
     */
    GetAttributeKey(req: any, cb: any): void {
     ...
     * @public
     */
    ListCmqEnableRegion(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAudit(req: any, cb: any): void {
     ...
     * @public
     */
    StopLogging(req: any, cb: any): void {
     ...
     * @public
     */
    InquireAuditCredit(req: any, cb: any): void {
...
4、如果IsEnableKmsEncry的值是1的话，KmsRegion和KeyId属于必填项
     ...
     * @public
     */
    UpdateAudit(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeAudit(req: any, cb: any): void {
...
4、如果IsEnableKmsEncry的值是1的话，KmsRegion和KeyId属于必填项
     ...
     * @public
     */
    CreateAudit(req: any, cb: any): void {
     ...
     * @public
     */
    ListCosEnableRegion(req: any, cb: any): void {
     ...
     * @public
     */
    LookUpEvents(req: any, cb: any): void {
     ...
     * @public
     */
    ListAudits(req: any, cb: any): void {
