...
* 支持批量操作，当传入多个云服务器实例ID，返回结果会分别列出每个云服务器挂载的云硬盘数量。
     ...
     * @public
     */
    DescribeInstancesDiskNum(req: any, cb: any): void {
...
* 只支持预付费模式的云硬盘扩容询价。
     ...
     * @public
     */
    InquiryPriceResizeDisk(req: any, cb: any): void {
...
* 如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的定期快照策略表。
     ...
     * @public
     */
    DescribeAutoSnapshotPolicies(req: any, cb: any): void {
...
* 本接口为异步接口，当挂载云盘的请求成功返回时，表示后台已发起挂载云盘的操作，可通过接口[DescribeDisks](/document/product/362/16315)来查询对应云盘的状态，如果云盘的状态由“ATTACHING”变为“ATTACHED”，则为挂载成功。
     ...
     * @public
     */
    AttachDisks(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyDisksRenewFlag(req: any, cb: any): void {
...
* 修改保留天数时必须保证不与是否永久保留属性冲突，否则整个操作失败，以特定的错误码返回。
     ...
     * @public
     */
    ModifyAutoSnapshotPolicyAttribute(req: any, cb: any): void {
...
* 支持查询创建多块云硬盘的价格，此时返回结果为总价格。
     ...
     * @public
     */
    InquiryPriceCreateDisks(req: any, cb: any): void {
...
可根据云盘ID过滤。云盘ID形如：disk-a1kmcp13。
     ...
     * @public
     */
    DescribeDiskOperationLogs(req: any, cb: any): void {
...
*  支持批量操作。如果多个定期快照策略存在无法删除的，则操作不执行，以特定错误码返回。
     ...
     * @public
     */
    DeleteAutoSnapshotPolicies(req: any, cb: any): void {
...
* 如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的云硬盘列表。
     ...
     * @public
     */
    DescribeDisks(req: any, cb: any): void {
...
* 本接口为异步接口，当创建请求下发成功后会返回一个新建的云盘ID列表，此时云盘的创建并未立即完成。可以通过调用[DescribeDisks](/document/product/362/16315)接口根据DiskId查询对应云盘，如果能查到云盘，且状态为'UNATTACHED'或'ATTACHED'，则表示创建成功。
     ...
     * @public
     */
    CreateDisks(req: any, cb: any): void {
...
* 支持批量操作，如果传入多个云盘ID，则所有云盘修改为同一属性。如果存在不允许操作的云盘，则操作不执行，以特定错误码返回。
     ...
     * @public
     */
    ModifyDiskAttributes(req: any, cb: any): void {
...
* 支持批量操作。如果多个快照存在无法删除的快照，则操作不执行，以返回特定的错误码返回。
     ...
     * @public
     */
    DeleteSnapshots(req: any, cb: any): void {
...
* “快照名称”仅为方便用户自己管理之用，腾讯云并不以此名称作为提交工单或是进行快照管理操作的依据。
     ...
     * @public
     */
    ModifySnapshotAttribute(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDiskAssociatedAutoSnapshotPolicy(req: any, cb: any): void {
...
* 当已绑定定期快照策略的云硬盘处于未使用状态（即弹性云盘未挂载或非弹性云盘的主机处于关机状态）将不会创建定期快照。
     ...
     * @public
     */
    BindAutoSnapshotPolicy(req: any, cb: any): void {
...
*  如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的快照列表。
     ...
     * @public
     */
    DescribeSnapshots(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSnapshotSharePermission(req: any, cb: any): void {
...
* 每个地域可创建的快照有数量和容量的限制，具体请见腾讯云控制台快照页面提示，如果快照超配额，定期快照创建会失败。
     ...
     * @public
     */
    CreateAutoSnapshotPolicy(req: any, cb: any): void {
...
默认接口请求频率限制：10次/秒。
     ...
     * @public
     */
    ModifyDisksChargeType(req: any, cb: any): void {
...
* 支持批量操作，每次请求批量云硬盘的上限为50。如果批量云盘存在不允许操作的，请求会以特定错误码返回。
     ...
     * @public
     */
    TerminateDisks(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDiskConfigQuota(req: any, cb: any): void {
...
* 如果传入的云盘未绑定到当前定期快照策略，接口将自动跳过，仅解绑与当前定期快照策略绑定的云盘。
     ...
     * @public
     */
    UnbindAutoSnapshotPolicy(req: any, cb: any): void {
...
* 如果是弹性云盘，则云盘必须处于未挂载状态，云硬盘挂载状态可以通过[DescribeDisks](/document/product/362/16315)接口查询，见Attached字段解释；如果是随实例一起购买的非弹性云盘，则实例必须处于关机状态，实例状态可以通过[DescribeInstancesStatus](/document/product/213/15738)接口查询。
     ...
     * @public
     */
    ApplySnapshot(req: any, cb: any): void {
...
可根据快照ID过滤。快照ID形如：snap-a1kmcp13。
     ...
     * @public
     */
    DescribeSnapshotOperationLogs(req: any, cb: any): void {
...
* 仅支持分享数据盘快照。
     ...
     * @public
     */
    ModifySnapshotsSharePermission(req: any, cb: any): void {
...
* 可创建快照数量限制见[产品使用限制](https://cloud.tencent.com/doc/product/362/5145)。
     ...
     * @public
     */
    CreateSnapshot(req: any, cb: any): void {
     ...
     * @public
     */
    GetSnapOverview(req: any, cb: any): void {
...
* 本接口为异步接口，接口成功返回时，云盘并未立即扩容到指定大小，可通过接口[DescribeDisks](/document/product/362/16315)来查询对应云盘的状态，如果云盘的状态为“EXPANDING”，表示正在扩容中。 
     ...
     * @public
     */
    ResizeDisk(req: any, cb: any): void {
...
* 本接口为异步接口，当请求成功返回时，云盘并未立即从主机解挂载，可通过接口[DescribeDisks](/document/product/362/16315)来查询对应云盘的状态，如果云盘的状态由“ATTACHED”变为“UNATTACHED”，则为解挂载成功。
     ...
     * @public
     */
    DetachDisks(req: any, cb: any): void {
...
* 支持为多块云盘指定不同的续费时长，此时返回的价格为多块云盘续费的总价格。
     ...
     * @public
     */
    InquiryPriceRenewDisks(req: any, cb: any): void {
