...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DeletePersonFromGroup(req: any, cb: any): void {
...
- 公共参数中的签名方式请使用V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    SearchFacesReturnsByGroup(req: any, cb: any): void {
...
只保留最近1年的数据。
     ...
     * @public
     */
    GetCheckSimilarPersonJobIdList(req: any, cb: any): void {
     ...
     * @public
     */
    GetPersonBaseInfo(req: any, cb: any): void {
...
- 公共参数中的签名方式请使用V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    DetectLiveFace(req: any, cb: any): void {
...
- 公共参数中的签名方式请使用V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    GetPersonListNum(req: any, cb: any): void {
     ...
     * @public
     */
    GetPersonGroupInfo(req: any, cb: any): void {
...
- 公共参数中的签名方式请使用V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    AnalyzeFace(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyPersonBaseInfo(req: any, cb: any): void {
...
- 公共参数中的签名方式请使用V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    SearchFaces(req: any, cb: any): void {
...
- 注：若该人员创建时算法模型版本为2.0，复制到非2.0算法模型版本的Group中时，复制操作将会失败。
     ...
     * @public
     */
    CopyPerson(req: any, cb: any): void {
...
- 查重的人员库状态为腾讯云开始进行查重任务的那一刻，即您可以理解为当您发起查重请求后，若您的查重任务需要排队，在排队期间您对人员库的增删操作均会会影响查重的结果。腾讯云将以开始进行查重任务的那一刻人员库的状态进行查重。查重任务开始后，您对人员库的任何操作均不影响查重任务的进行。但建议查重任务开始后，请不要对人员库中人员和人脸进行增删操作。
     ...
     * @public
     */
    CheckSimilarPerson(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyGroup(req: any, cb: any): void {
...
注：此处QPS限制为10。
     ...
     * @public
     */
    UpgradeGroupFaceModelVersion(req: any, cb: any): void {
     ...
     * @public
     */
    GetSimilarPersonResult(req: any, cb: any): void {
...
注：给客户我会写10s内生效，我们实际上越快越好。待讨论。
     ...
     * @public
     */
    RevertGroupFaceModelVersion(req: any, cb: any): void {
...
- 公共参数中的签名方式请使用V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    GetUpgradeGroupFaceModelVersionJobList(req: any, cb: any): void {
     ...
     * @public
     */
    GetGroupInfo(req: any, cb: any): void {
...
- 公共参数中的签名方式请使用V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    DetectFace(req: any, cb: any): void {
     ...
     * @public
     */
    GetPersonList(req: any, cb: any): void {
...
- 仅支持算法模型版本（FaceModelVersion）为3.0的人员库。
     ...
     * @public
     */
    VerifyPerson(req: any, cb: any): void {
     ...
     * @public
     */
    GetUpgradeGroupFaceModelVersionResult(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyPersonGroupInfo(req: any, cb: any): void {
...
- 公共参数中的签名方式请使用V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    VerifyFace(req: any, cb: any): void {
...
- 仅支持算法模型版本（FaceModelVersion）为3.0的人员库。
     ...
     * @public
     */
    SearchPersons(req: any, cb: any): void {
...
- 公共参数中的签名方式请使用V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     ...
     * @public
     */
    CompareFace(req: any, cb: any): void {
...
- 仅支持算法模型版本（FaceModelVersion）为3.0的人员库。
     ...
     * @public
     */
    SearchPersonsReturnsByGroup(req: any, cb: any): void {
     ...
     * @public
     */
    GetGroupList(req: any, cb: any): void {
...
若预估时间超过5小时，则无法使用人员查重功能。
     ...
     * @public
     */
    EstimateCheckSimilarPersonCostTime(req: any, cb: any): void {
