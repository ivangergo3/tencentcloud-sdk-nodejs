...
export class Client extends AbstractClient {
     ...
     * @public
     */
    ResetInstancesMaxBandwidth(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeModule(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBaseOverview(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyModuleName(req: any, cb: any): void {
...
只有状态为 UNBIND 的 EIP 才能进行释放操作。
     ...
     * @public
     */
    ModifyModuleConfig(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeInstanceTypeConfig(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDefaultSubnet(req: any, cb: any): void {
...
只有状态为 UNBIND 的 EIP 才能够被绑定。
     ...
     * @public
     */
    CreateModule(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyModuleNetwork(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeInstancesDeniedActions(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePeakNetworkOverview(req: any, cb: any): void {
...
支持强制关闭，强制关机的效果等同于关闭物理计算机的电源开关，强制关机可能会导致数据丢失或文件系统损坏，请仅在服务器不能正常关机时使用。
     ...
     * @public
     */
    DescribeNode(req: any, cb: any): void {
     ...
     * @public
     */
    ImportCustomImage(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeModuleDetail(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeCustomImageTask(req: any, cb: any): void {
     ...
     * @public
     */
    ResetInstances(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyModuleImage(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePeakBaseOverview(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyDefaultSubnet(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteModule(req: any, cb: any): void {
...
迁移前后的弹性网卡必须在同一个子网内。
     ...
     * @public
     */
    DescribeImage(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyModuleIpDirect(req: any, cb: any): void {
...
退还弹性网卡上的辅助内网IP，接口自动解关联弹性公网 IP。不能退还弹性网卡的主内网IP。
     ...
     * @public
     */
    RemovePrivateIpAddresses(req: any, cb: any): void {
