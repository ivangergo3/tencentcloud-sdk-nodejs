...
提示：对于一般开发者，我们建议优先使用SDK接入简化开发。SDK使用介绍请直接查看 5. 开发者资源 部分。
     ...
     * @public
     */
    TextTranslate(req: any, cb: any): void {
...
提示：对于一般开发者，我们建议优先使用SDK接入简化开发。SDK使用介绍请直接查看 5. 开发者资源 部分。
     ...
     * @public
     */
    ImageTranslate(req: any, cb: any): void {
...
提示：对于一般开发者，我们建议优先使用SDK接入简化开发。SDK使用介绍请直接查看 5. 开发者资源部分。
     ...
     * @public
     */
    SpeechTranslate(req: any, cb: any): void {
     ...
     * @public
     */
    TextTranslateBatch(req: any, cb: any): void {
...
提示：对于一般开发者，我们建议优先使用SDK接入简化开发。SDK使用介绍请直接查看 5. 开发者资源 部分。
     ...
     * @public
     */
    LanguageDetect(req: any, cb: any): void {
