...
删除文本样本库，暂时只支持单个删除。
     ...
     * @public
     */
    DeleteTextSample(req: any, cb: any): void {
...
通过该接口可以将文本新增到样本库。
     ...
     * @public
     */
    CreateTextSample(req: any, cb: any): void {
...
通过该接口可以将图片新增到样本库。
     ...
     * @public
     */
    CreateFileSample(req: any, cb: any): void {
...
支持批量查询文本样本库。
     ...
     * @public
     */
    DescribeTextSample(req: any, cb: any): void {
     ...
     * @public
     */
    ManualReview(req: any, cb: any): void {
...
查询图片样本库，支持批量查询。
     ...
     * @public
     */
    DescribeFileSample(req: any, cb: any): void {
     ...
     * @public
     */
    TextModeration(req: any, cb: any): void {
     ...
     * @public
     */
    ImageModeration(req: any, cb: any): void {
...
删除图片样本库，支持批量删除，一次提交不超过20个。
     ...
     * @public
     */
    DeleteFileSample(req: any, cb: any): void {
