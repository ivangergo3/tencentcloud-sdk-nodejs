...
class DescribeRegistrationStatusResponse extends AbstractModel {
    ...
    Data: Array<RegisteredStatus> | null
...
class CreateDevicesResponse extends AbstractModel {
    ...
    Data: Array<DeviceCertificate> | null
