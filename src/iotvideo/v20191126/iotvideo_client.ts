...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DescribeOtaVersions(req: any, cb: any): void {
     ...
     * @public
     */
    DisableOtaVersion(req: any, cb: any): void {
     ...
     * @public
     */
    CreateGencode(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeIotDataType(req: any, cb: any): void {
     ...
     * @public
     */
    DisableDevice(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteTraceIds(req: any, cb: any): void {
     ...
     * @public
     */
    RunOtaVersion(req: any, cb: any): void {
     ...
     * @public
     */
    RunTestOtaVersion(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeProduct(req: any, cb: any): void {
...
若设备网络出现异常时,消息发送可能超时,超时等待最长时间为3秒.waitresp非0情况下,会导致本接口阻塞3秒。
     ...
     * @public
     */
    SendOnlineMsg(req: any, cb: any): void {
     ...
     * @public
     */
    RunIotModel(req: any, cb: any): void {
...
注意:
  ...
  3.value的内容必须与实际物模型的定义一致
     ...
     * @public
     */
    ModifyDeviceAction(req: any, cb: any): void {
     ...
     * @public
     */
    CreateIotDataType(req: any, cb: any): void {
...
注意：腾讯云不会对设备私钥进行保存，请自行保管好您的设备私钥。
     ...
     * @public
     */
    CreateDevices(req: any, cb: any): void {
...
该接口实现了物模型草稿箱的功能，保存用户最后一次编辑的物模型数据。
     ...
     * @public
     */
    CreateIotModel(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteIotDataType(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeMessageQueue(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeIotModel(req: any, cb: any): void {
     ...
     * @public
     */
    CreateTraceIds(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBindUsr(req: any, cb: any): void {
     ...
     * @public
     */
    CreateAppUsr(req: any, cb: any): void {
     ...
     * @public
     */
    CreateBinding(req: any, cb: any): void {
...
当终端用户与设备有强绑定关系时，可以不用调用此接口
     ...
     * @public
     */
    CreateDevToken(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteOtaVersion(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteAppUsr(req: any, cb: any): void {
     ...
     * @public
     */
    ModifyProduct(req: any, cb: any): void {
...
设备日志最长保留时长为15天,超期自动清除。
     ...
     * @public
     */
    DescribeLogs(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeIotModels(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTraceStatus(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRegistrationStatus(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRunLog(req: any, cb: any): void {
     ...
     * @public
     */
    SetMessageQueue(req: any, cb: any): void {
     ...
     * @public
     */
    DisableDeviceStream(req: any, cb: any): void {
     ...
     * @public
     */
    CreateUploadPath(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeModelDataRet(req: any, cb: any): void {
     ...
     * @public
     */
    DescribePubVersions(req: any, cb: any): void {
     ...
     * @public
     */
    RunDeviceStream(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeBindDev(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeDeviceModel(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteBinding(req: any, cb: any): void {
     ...
     * @public
     */
    CreateStorage(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeTraceIds(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteMessageQueue(req: any, cb: any): void {
...
物模型写入数据时,不需要传入时标信息,平台以当前时标作为数据的时标更新物模型中的时标信息。
     ...
     * @public
     */
    ModifyDeviceProperty(req: any, cb: any): void {
     ...
     * @public
     */
    UploadOtaVersion(req: any, cb: any): void {
...
警告:使能UpgradeNow参数存在一定的风险性！建议仅在debug场景下使用!
     ...
     * @public
     */
    UpgradeDevice(req: any, cb: any): void {
     ...
     * @public
     */
    CreateUsrToken(req: any, cb: any): void {
