...
export class Client extends AbstractClient {
     ...
     * @public
     */
    InsuranceBillOCR(req: any, cb: any): void {
     ...
     * @public
     */
    VerifyBasicBizLicense(req: any, cb: any): void {
     ...
     * @public
     */
    VatInvoiceVerify(req: any, cb: any): void {
...
本接口目前为内测阶段，如需使用服务，请<a href="https://cloud.tencent.com/act/event/connect-service" target="_blank">联系商务</a>开通。
     ...
     * @public
     */
    QueryBarCode(req: any, cb: any): void {
     ...
     * @public
     */
    EnterpriseLicenseOCR(req: any, cb: any): void {
     ...
     * @public
     */
    BusinessCardOCR(req: any, cb: any): void {
...
<table style="width:650px">
     ...
     * @public
     */
    TollInvoiceOCR(req: any, cb: any): void {
...
本接口暂未完全对外开放，如需咨询，请[联系商务](https://cloud.tencent.com/about/connect)
     ...
     * @public
     */
    MLIDCardOCR(req: any, cb: any): void {
...
<table style="width:715px">
     ...
     * @public
     */
    GeneralAccurateOCR(req: any, cb: any): void {
     ...
     * @public
     */
    FlightInvoiceOCR(req: any, cb: any): void {
     ...
     * @public
     */
    MixedInvoiceDetect(req: any, cb: any): void {
     ...
     * @public
     */
    ShipInvoiceOCR(req: any, cb: any): void {
...
本接口暂未完全对外开放，如需咨询，请[联系商务](https://cloud.tencent.com/about/connect)
     ...
     * @public
     */
    MLIDPassportOCR(req: any, cb: any): void {
     ...
     * @public
     */
    VatRollInvoiceOCR(req: any, cb: any): void {
     ...
     * @public
     */
    QuotaInvoiceOCR(req: any, cb: any): void {
     ...
     * @public
     */
    GeneralFastOCR(req: any, cb: any): void {
     ...
     * @public
     */
    PropOwnerCertOCR(req: any, cb: any): void {
     ...
     * @public
     */
    BizLicenseOCR(req: any, cb: any): void {
     ...
     * @public
     */
    GeneralHandwritingOCR(req: any, cb: any): void {
     ...
     * @public
     */
    WaybillOCR(req: any, cb: any): void {
     ...
     * @public
     */
    InvoiceGeneralOCR(req: any, cb: any): void {
...
本接口暂未完全对外开放，如需咨询，请[联系商务](https://cloud.tencent.com/about/connect)
     ...
     * @public
     */
    HKIDCardOCR(req: any, cb: any): void {
     ...
     * @public
     */
    VatInvoiceOCR(req: any, cb: any): void {
...
您可以通过输入营业执照关键字段或传入营业执照图片提供所需的验证信息，接口返回真实的企业工商照面信息及核验结果，包括统一社会信用代码、组织机构代码、经营期限、法人姓名、经营状态、经营业务范围及方式、注册资金、注册币种、登记机关、开业日期、企业（机构）类型、注销日期、吊销日期、许可经营项目、一般经营项目、核准时间、省、地级市、区/县、住所所在行政区划代码、行业门类代码、行业门类名称、国民经济行业代码、国民经济行业名称、经营（业务）范围、要核验的工商注册号、工商注册号、要核验的企业名称、企业名称、要核验的注册住址、注册住址、核验结果共33个详细字段。
     ...
     * @public
     */
    VerifyBizLicense(req: any, cb: any): void {
     ...
     * @public
     */
    DutyPaidProofOCR(req: any, cb: any): void {
...
<table style="width:715px">
     ...
     * @public
     */
    GeneralBasicOCR(req: any, cb: any): void {
     ...
     * @public
     */
    OrgCodeCertOCR(req: any, cb: any): void {
     ...
     * @public
     */
    FinanBillSliceOCR(req: any, cb: any): void {
     ...
     * @public
     */
    BusInvoiceOCR(req: any, cb: any): void {
     ...
     * @public
     */
    RideHailingDriverLicenseOCR(req: any, cb: any): void {
     ...
     * @public
     */
    HmtResidentPermitOCR(req: any, cb: any): void {
     ...
     * @public
     */
    ArithmeticOCR(req: any, cb: any): void {
     ...
     * @public
     */
    LicensePlateOCR(req: any, cb: any): void {
     ...
     * @public
     */
    EstateCertOCR(req: any, cb: any): void {
     ...
     * @public
     */
    ClassifyDetectOCR(req: any, cb: any): void {
     ...
     * @public
     */
    TrainTicketOCR(req: any, cb: any): void {
     ...
     * @public
     */
    TextDetect(req: any, cb: any): void {
...
<table style="width:715px">
     ...
     * @public
     */
    GeneralEfficientOCR(req: any, cb: any): void {
     ...
     * @public
     */
    TaxiInvoiceOCR(req: any, cb: any): void {
     ...
     * @public
     */
    VehicleRegCertOCR(req: any, cb: any): void {
     ...
     * @public
     */
    InstitutionOCR(req: any, cb: any): void {
     ...
     * @public
     */
    EnglishOCR(req: any, cb: any): void {
     ...
     * @public
     */
    ResidenceBookletOCR(req: any, cb: any): void {
     ...
     * @public
     */
    BankCardOCR(req: any, cb: any): void {
     ...
     * @public
     */
    CarInvoiceOCR(req: any, cb: any): void {
...
另外，本接口还支持复印件、翻拍和PS告警功能。
     ...
     * @public
     */
    DriverLicenseOCR(req: any, cb: any): void {
     ...
     * @public
     */
    MainlandPermitOCR(req: any, cb: any): void {
     ...
     * @public
     */
    FormulaOCR(req: any, cb: any): void {
     ...
     * @public
     */
    PassportOCR(req: any, cb: any): void {
     ...
     * @public
     */
    FinanBillOCR(req: any, cb: any): void {
     ...
     * @public
     */
    MixedInvoiceOCR(req: any, cb: any): void {
     ...
     * @public
     */
    EduPaperOCR(req: any, cb: any): void {
     ...
     * @public
     */
    RideHailingTransportLicenseOCR(req: any, cb: any): void {
...
另外，本接口还支持复印件、翻拍和PS告警功能。
     ...
     * @public
     */
    VehicleLicenseOCR(req: any, cb: any): void {
