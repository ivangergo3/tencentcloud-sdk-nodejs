...
export class Client extends AbstractClient {
     ...
     * @public
     */
    DeleteSyncJob(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSyncJobs(req: any, cb: any): void {
     ...
     * @public
     */
    ActivateSubscribe(req: any, cb: any): void {
...
源实例和目标实例信息不允许修改，可以修改任务名、需要同步的库表。
     ...
     * @public
     */
    ModifySyncJob(req: any, cb: any): void {
...
创建同步任务后，可以通过 CreateSyncCheckJob 接口发起校验任务。校验成功后才可以通过 StartSyncJob 接口启动同步任务。
     ...
     * @public
     */
    CreateSyncJob(req: any, cb: any): void {
     ...
     * @public
     */
    ModifySubscribeObjects(req: any, cb: any): void {
     ...
     * @public
     */
    StartSyncJob(req: any, cb: any): void {
...
若未通过校验, 则能查询到校验失败的原因. 请按照报错, 通过'ModifyMigrateJob'修改迁移配置或是调整源/目标实例的相关参数.
     ...
     * @public
     */
    DescribeMigrateCheckJob(req: any, cb: any): void {
     ...
     * @public
     */
    SwitchDrToMaster(req: any, cb: any): void {
...
在迁移过程中允许调用该接口撤销迁移, 撤销迁移的任务会失败。通过DescribeMigrateJobs接口查询到任务状态为运行中（status=7）或准备完成（status=8）时，才能撤销数据迁移任务。
     ...
     * @public
     */
    StopMigrateJob(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeRegionConf(req: any, cb: any): void {
...
如果是金融区链路, 请使用域名: https://dts.ap-shenzhen-fsi.tencentcloudapi.com
     ...
     * @public
     */
    DescribeMigrateJobs(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSubscribes(req: any, cb: any): void {
...
如果 Status=finished 且 CheckFlag !=1 时表示校验失败。
     ...
     * @public
     */
    DescribeSyncCheckJob(req: any, cb: any): void {
...
如果是金融区链路, 请使用域名: dts.ap-shenzhen-fsi.tencentcloudapi.com
     ...
     * @public
     */
    CreateMigrateJob(req: any, cb: any): void {
     ...
     * @public
     */
    ModifySubscribeVipVport(req: any, cb: any): void {
...
校验成功后,迁移任务若有修改, 则必须重新创建校验并通过后, 才能开始迁移.
     ...
     * @public
     */
    CreateMigrateCheckJob(req: any, cb: any): void {
     ...
     * @public
     */
    ModifySubscribeConsumeTime(req: any, cb: any): void {
     ...
     * @public
     */
    ModifySubscribeName(req: any, cb: any): void {
...
校验成功后才能启动同步.
     ...
     * @public
     */
    CreateSyncCheckJob(req: any, cb: any): void {
     ...
     * @public
     */
    CreateSubscribe(req: any, cb: any): void {
     ...
     * @public
     */
    ResetSubscribe(req: any, cb: any): void {
...
调用此接口前，请务必先使用CreateMigrateCheckJob校验数据迁移任务，并通过DescribeMigrateJobs接口查询到任务状态为校验通过（status=4）时，才能启动数据迁移任务。
     ...
     * @public
     */
    StartMigrateJob(req: any, cb: any): void {
...
如果是金融区链路, 请使用域名: dts.ap-shenzhen-fsi.tencentcloudapi.com
     ...
     * @public
     */
    ModifyMigrateJob(req: any, cb: any): void {
     ...
     * @public
     */
    OfflineIsolatedSubscribe(req: any, cb: any): void {
     ...
     * @public
     */
    IsolateSubscribe(req: any, cb: any): void {
     ...
     * @public
     */
    DescribeSubscribeConf(req: any, cb: any): void {
     ...
     * @public
     */
    DeleteMigrateJob(req: any, cb: any): void {
...
通过DescribeMigrateJobs接口查询到任务的状态为准备完成（status=8）时，此时可以调用本接口完成迁移任务。
     ...
     * @public
     */
    CompleteMigrateJob(req: any, cb: any): void {
