...
class DescribeSyncJobsResponse extends AbstractModel {
    ...
    JobList: Array<SyncJobInfo> | null
...
class DescribeMigrateJobsResponse extends AbstractModel {
    ...
    JobList: Array<MigrateJobInfo> | null
...
class MigrateDetailInfo extends AbstractModel {
    ...
    CurrentStepProgress: string | null
    
    MasterSlaveDistance: number | null
    
    SecondsBehindMaster: number | null
    
    StepInfo: Array<MigrateStepDetailInfo> | null
...
class DescribeSubscribeConfResponse extends AbstractModel {
    ...
    SubscribeObjectType: number | null
    
    SubscribeObjects: Array<SubscribeObject> | null
...
class ConsistencyParams extends AbstractModel {
    ...
    SelectRowsPerTable: number | null
    
    TablesSelectAll: number | null
    
    TablesSelectCount: number | null
...
class ModifySubscribeObjectsRequest extends AbstractModel {
    ...
    Objects: Array<SubscribeObject> | null
...
class DescribeSubscribesResponse extends AbstractModel {
    ...
    Items: Array<SubscribeInfo> | null
...
class DescribeRegionConfResponse extends AbstractModel {
    ...
    Items: Array<SubscribeRegionConf> | null
...
class SyncDetailInfo extends AbstractModel {
    ...
    StepInfo: Array<SyncStepDetailInfo> | null
...
class SyncOption extends AbstractModel {
    ...
    SyncObject: number | null
    
    RunMode: number | null
    
    SyncType: number | null
    
    ConsistencyType: number | null
...
class MigrateJobInfo extends AbstractModel {
    ...
    Detail: MigrateDetailInfo | null
    
    ErrorInfo: Array<ErrorInfo> | null
...
class CreateSubscribeResponse extends AbstractModel {
    ...
    SubscribeIds: Array<string> | null
...
class MigrateOption extends AbstractModel {
    ...
    MigrateObject: number | null
    
    ConsistencyType: number | null
    
    IsOverrideRoot: number | null
    
    ExternParams: string | null
    
    ConsistencyParams: ConsistencyParams | null
...
class DescribeSyncCheckJobResponse extends AbstractModel {
    ...
    StepInfo: Array<SyncCheckStepInfo> | null
