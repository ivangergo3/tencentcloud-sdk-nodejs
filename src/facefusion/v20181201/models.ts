...
class PublicMaterialInfos extends AbstractModel {
    ...
    BlendParamPtu: number | null
    
    PositionParamPtu: number | null
    
    BlendParamYoutu: number | null
    
    PositionParamYoutu: number | null
    ...
    MaterialFaceList: Array<MaterialFaceList> | null
...
class FaceFusionRequest extends AbstractModel {
    ...
    PornDetect: number | null
    
    CelebrityIdentify: number | null
...
class FaceFusionResponse extends AbstractModel {
    ...
    ReviewResultSet: Array<FuseFaceReviewResult> | null
...
class DescribeMaterialListResponse extends AbstractModel {
    ...
    MaterialInfos: Array<PublicMaterialInfos> | null
...
class MergeInfo extends AbstractModel {
    ...
    InputImageFaceRect: FaceRect | null
    
    TemplateFaceID: string | null
...
class FuseFaceReviewResult extends AbstractModel {
    ...
    DetailSet: Array<FuseFaceReviewDetail> | null
...
class FuseFaceRequest extends AbstractModel {
    ...
    MergeInfos: Array<MergeInfo> | null
    
    FuseProfileDegree: number | null
    
    FuseFaceDegree: number | null
